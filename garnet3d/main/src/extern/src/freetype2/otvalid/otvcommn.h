...
#ifdef _MSC_VER
#define OTV_NEST1( x ) OTV_NEST1_( valid, x )
static void OTV_NEST1_(
    OTV_Validator valid,
    OTV_Validate_Func f0, const FT_String * n0 )
{
    valid->nesting_level          = 0;
    valid->func[0]                = f0;
    valid->debug_function_name[0] = n0;
}
#else
...
#ifdef _MSC_VER
#define OTV_NEST2( x, y ) OTV_NEST2_( valid, x, y )
static void OTV_NEST2_(
    OTV_Validator valid,
    OTV_Validate_Func f0, const FT_String * n0,
    OTV_Validate_Func f1, const FT_String * n1 )
{
    valid->nesting_level          = 0;
    valid->func[0]                = f0;
    valid->func[1]                = f1;
    valid->debug_function_name[0] = n0;
    valid->debug_function_name[1] = n1;
}
#else
...
#ifdef _MSC_VER
#define OTV_NEST3( x, y, z ) OTV_NEST3_( valid, x, y, z )
static void OTV_NEST3_(
    OTV_Validator valid,
    OTV_Validate_Func f0, const FT_String * n0,
    OTV_Validate_Func f1, const FT_String * n1,
    OTV_Validate_Func f2, const FT_String * n2 )
{
    valid->nesting_level          = 0;
    valid->func[0]                = f0;
    valid->func[1]                = f1;
    ...
    valid->debug_function_name[0] = n0;
    valid->debug_function_name[1] = n1;
    valid->debug_function_name[2] = n2;
}
#else
