...
public:
	...
	*/
    ...
    /**	All TinyXml classes can print themselves to a string.
    This is a formatted print, and will insert tabs and newlines.

    (For an unformatted stream, use the << operator.)
    */
    virtual void PrintToString( TiXmlString & str, int depth ) const = 0;
...
public:
	...
	*/
    ...
    TiXmlCData*    ToCData() const	        { return ( this && type == CDATA ) ? (TiXmlCData*) this : 0; } ///< Cast to a more defined type. Will return null not of the requested type.
...
public:
	...
	*/
    ...
    // Print to string
    virtual void PrintToString( TiXmlString & str, int depth ) const;
...
public:
	...
	virtual void Print( FILE* cfile, int depth ) const;
    // Print this Comment to a string
    virtual void PrintToString( TiXmlString & str, int depth ) const;
...
public:
	...
	virtual void Print( FILE* cfile, int depth ) const;
    // Print this test object to a string
    virtual void PrintToString( TiXmlString & str, int depth ) const;
...
public:
	...
	virtual void Print( FILE* cfile, int depth ) const;
    /// Print this declaration to a string
    virtual void PrintToString( TiXmlString & str, int depth ) const;
...
/** XML CDATA. Contained in an element.
*/
...
public:
	...
	virtual void Print( FILE* cfile, int depth ) const;
    /// Print this Unknown to a string
    virtual void PrintToString( TiXmlString & str, int depth ) const;
...
public:
	...
	*/
    ...
    virtual void PrintToString( TiXmlString & str, int depth = 0 ) const;
