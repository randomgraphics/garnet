    ...
    switch( format )
    {
        ...
        default:
            GN_ERROR(sLogger)( "Format %s is not a valid typeless depth buffer format.",
                d3d11::getDXGIFormatDesc( format ).name );
    ...
    SurfaceUpdateFlag   flag )
{
    ...
    else
    {
        ...
        const d3d11::DXGI_FORMAT_DESCRIPTION & fmtdesc = d3d11::getDXGIFormatDesc( mTextureFormat );
...
GN::gfx::D3D11Texture::getRTView( UInt32 face, UInt32 level, UInt32 slice )
{
...
GN::gfx::D3D11Texture::getDSView( UInt32 face, UInt32 level, UInt32 slice )
{
...
bool GN::gfx::D3D11Texture::createTexture()
{
    ...
    if( TextureUsage::DEPTH_RENDER_TARGET == desc.usage )
    {
        ...
        mTextureFormat = d3d11::getDXGIFormatDesc( (DXGI_FORMAT)colorFormat2DxgiFormat( desc.format ) ).typelessFormat;
    ...
    ID3D11Device & dev = getDeviceRef();
    if( D3D11_SRV_DIMENSION_TEXTURE1D == mDimension ||
        D3D11_SRV_DIMENSION_TEXTURE1DARRAY == mDimension )
    {
        ...
        mTexture = tex1d;
             ...
             D3D11_SRV_DIMENSION_TEXTURE2DARRAY == mDimension ||
