...
virtual void STDMETHODCALLTYPE OMSetBlendState(
    ...
    UINT SampleMask);
NullPtr<void (D3D11DeviceContextHook::*)(ID3D11BlendState *, UINT)> _OMSetBlendState_pre_ptr;
NullPtr<void (D3D11DeviceContextHook::*)(ID3D11BlendState *, UINT)> _OMSetBlendState_post_ptr;
// -----------------------------------------------------------------------------
...
NullPtr<void (D3D11DeviceContextHook::*)(ID3D11RenderTargetView *)> _ClearRenderTargetView_pre_ptr;
NullPtr<void (D3D11DeviceContextHook::*)(ID3D11RenderTargetView *)> _ClearRenderTargetView_post_ptr;
// -----------------------------------------------------------------------------
virtual void STDMETHODCALLTYPE ClearUnorderedAccessViewUint(
    ID3D11UnorderedAccessView * pUnorderedAccessView);
NullPtr<void (D3D11DeviceContextHook::*)(ID3D11UnorderedAccessView *)> _ClearUnorderedAccessViewUint_pre_ptr;
NullPtr<void (D3D11DeviceContextHook::*)(ID3D11UnorderedAccessView *)> _ClearUnorderedAccessViewUint_post_ptr;
// -----------------------------------------------------------------------------
virtual void STDMETHODCALLTYPE ClearUnorderedAccessViewFloat(
    ID3D11UnorderedAccessView * pUnorderedAccessView);
NullPtr<void (D3D11DeviceContextHook::*)(ID3D11UnorderedAccessView *)> _ClearUnorderedAccessViewFloat_pre_ptr;
NullPtr<void (D3D11DeviceContextHook::*)(ID3D11UnorderedAccessView *)> _ClearUnorderedAccessViewFloat_post_ptr;
// -----------------------------------------------------------------------------
...
virtual void STDMETHODCALLTYPE OMGetBlendState(
    ...
    UINT * pSampleMask);
NullPtr<void (D3D11DeviceContextHook::*)(ID3D11BlendState **, UINT *)> _OMGetBlendState_pre_ptr;
NullPtr<void (D3D11DeviceContextHook::*)(ID3D11BlendState **, UINT *)> _OMGetBlendState_post_ptr;
// -----------------------------------------------------------------------------
