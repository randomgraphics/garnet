...
DEFINE_INTERFACE_METHOD(virtual, HRESULT, STDMETHODCALLTYPE, SetMessageCountLimit, PARAMETER_LIST_1(
    DEFINE_METHOD_PARAMETER(_In_  UINT64, MessageCountLimit)))
// -----------------------------------------------------------------------------
...
DEFINE_INTERFACE_METHOD(virtual, HRESULT, STDMETHODCALLTYPE, GetMessage, PARAMETER_LIST_3(
    DEFINE_METHOD_PARAMETER(_In_  UINT64, MessageIndex),
    DEFINE_METHOD_PARAMETER(_Out_writes_bytes_opt_(*pMessageByteLength)  D3D11_MESSAGE *, pMessage),
    DEFINE_METHOD_PARAMETER(_Inout_  SIZE_T *, pMessageByteLength)))
// -----------------------------------------------------------------------------
...
DEFINE_INTERFACE_METHOD(virtual, HRESULT, STDMETHODCALLTYPE, AddStorageFilterEntries, PARAMETER_LIST_1(
    DEFINE_METHOD_PARAMETER(_In_  D3D11_INFO_QUEUE_FILTER *, pFilter)))
// -----------------------------------------------------------------------------
DEFINE_INTERFACE_METHOD(virtual, HRESULT, STDMETHODCALLTYPE, GetStorageFilter, PARAMETER_LIST_2(
    DEFINE_METHOD_PARAMETER(_Out_writes_bytes_opt_(*pFilterByteLength)  D3D11_INFO_QUEUE_FILTER *, pFilter),
    DEFINE_METHOD_PARAMETER(_Inout_  SIZE_T *, pFilterByteLength)))
// -----------------------------------------------------------------------------
...
DEFINE_INTERFACE_METHOD(virtual, HRESULT, STDMETHODCALLTYPE, AddMessage, PARAMETER_LIST_4(
    DEFINE_METHOD_PARAMETER(_In_  D3D11_MESSAGE_CATEGORY, Category),
    DEFINE_METHOD_PARAMETER(_In_  D3D11_MESSAGE_SEVERITY, Severity),
    DEFINE_METHOD_PARAMETER(_In_  D3D11_MESSAGE_ID, ID),
    DEFINE_METHOD_PARAMETER(_In_  LPCSTR, pDescription)))
// -----------------------------------------------------------------------------
...
DEFINE_INTERFACE_METHOD(virtual, HRESULT, STDMETHODCALLTYPE, SetBreakOnCategory, PARAMETER_LIST_2(
    DEFINE_METHOD_PARAMETER(_In_  D3D11_MESSAGE_CATEGORY, Category),
    DEFINE_METHOD_PARAMETER(_In_  BOOL, bEnable)))
// -----------------------------------------------------------------------------
...
DEFINE_INTERFACE_METHOD(virtual, void, STDMETHODCALLTYPE, SetMuteDebugOutput, PARAMETER_LIST_1(
    DEFINE_METHOD_PARAMETER(_In_  BOOL, bMute)))
// -----------------------------------------------------------------------------
