...
struct IDirect3DDevice9Vtbl
{
    ...
    HRESULT (STDMETHODCALLTYPE *CreateAdditionalSwapChain)(IDirect3DDevice9 * this_,  D3DPRESENT_PARAMETERS* pPresentationParameters,IDirect3DSwapChain9** ppSwapChain) ;
    ...
    HRESULT (STDMETHODCALLTYPE *Present)(IDirect3DDevice9 * this_,  CONST RECT* pSourceRect,CONST RECT* pDestRect,HWND hDestWindowOverride,CONST RGNDATA* pDirtyRegion) ;
    HRESULT (STDMETHODCALLTYPE *GetBackBuffer)(IDirect3DDevice9 * this_,  UINT iSwapChain,UINT iBackBuffer,D3DBACKBUFFER_TYPE Type,IDirect3DSurface9** ppBackBuffer) ;
    ...
    HRESULT (STDMETHODCALLTYPE *CreateTexture)(IDirect3DDevice9 * this_,  UINT Width,UINT Height,UINT Levels,DWORD Usage,D3DFORMAT Format,D3DPOOL Pool,IDirect3DTexture9** ppTexture,HANDLE* pSharedHandle) ;
    HRESULT (STDMETHODCALLTYPE *CreateVolumeTexture)(IDirect3DDevice9 * this_,  UINT Width,UINT Height,UINT Depth,UINT Levels,DWORD Usage,D3DFORMAT Format,D3DPOOL Pool,IDirect3DVolumeTexture9** ppVolumeTexture,HANDLE* pSharedHandle) ;
    HRESULT (STDMETHODCALLTYPE *CreateCubeTexture)(IDirect3DDevice9 * this_,  UINT EdgeLength,UINT Levels,DWORD Usage,D3DFORMAT Format,D3DPOOL Pool,IDirect3DCubeTexture9** ppCubeTexture,HANDLE* pSharedHandle) ;
    HRESULT (STDMETHODCALLTYPE *CreateVertexBuffer)(IDirect3DDevice9 * this_,  UINT Length,DWORD Usage,DWORD FVF,D3DPOOL Pool,IDirect3DVertexBuffer9** ppVertexBuffer,HANDLE* pSharedHandle) ;
    HRESULT (STDMETHODCALLTYPE *CreateIndexBuffer)(IDirect3DDevice9 * this_,  UINT Length,DWORD Usage,D3DFORMAT Format,D3DPOOL Pool,IDirect3DIndexBuffer9** ppIndexBuffer,HANDLE* pSharedHandle) ;
    HRESULT (STDMETHODCALLTYPE *CreateRenderTarget)(IDirect3DDevice9 * this_,  UINT Width,UINT Height,D3DFORMAT Format,D3DMULTISAMPLE_TYPE MultiSample,DWORD MultisampleQuality,BOOL Lockable,IDirect3DSurface9** ppSurface,HANDLE* pSharedHandle) ;
    HRESULT (STDMETHODCALLTYPE *CreateDepthStencilSurface)(IDirect3DDevice9 * this_,  UINT Width,UINT Height,D3DFORMAT Format,D3DMULTISAMPLE_TYPE MultiSample,DWORD MultisampleQuality,BOOL Discard,IDirect3DSurface9** ppSurface,HANDLE* pSharedHandle) ;
    HRESULT (STDMETHODCALLTYPE *UpdateSurface)(IDirect3DDevice9 * this_,  IDirect3DSurface9* pSourceSurface,CONST RECT* pSourceRect,IDirect3DSurface9* pDestinationSurface,CONST POINT* pDestPoint) ;
    ...
    HRESULT (STDMETHODCALLTYPE *StretchRect)(IDirect3DDevice9 * this_,  IDirect3DSurface9* pSourceSurface,CONST RECT* pSourceRect,IDirect3DSurface9* pDestSurface,CONST RECT* pDestRect,D3DTEXTUREFILTERTYPE Filter) ;
    HRESULT (STDMETHODCALLTYPE *ColorFill)(IDirect3DDevice9 * this_,  IDirect3DSurface9* pSurface,CONST RECT* pRect,D3DCOLOR color) ;
    HRESULT (STDMETHODCALLTYPE *CreateOffscreenPlainSurface)(IDirect3DDevice9 * this_,  UINT Width,UINT Height,D3DFORMAT Format,D3DPOOL Pool,IDirect3DSurface9** ppSurface,HANDLE* pSharedHandle) ;
    ...
    HRESULT (STDMETHODCALLTYPE *DrawIndexedPrimitive)(IDirect3DDevice9 * this_,  D3DPRIMITIVETYPE PrimitiveType,INT BaseVertexIndex,UINT MinVertexIndex,UINT NumVertices,UINT startIndex,UINT primCount) ;
    HRESULT (STDMETHODCALLTYPE *DrawPrimitiveUP)(IDirect3DDevice9 * this_,  D3DPRIMITIVETYPE PrimitiveType,UINT PrimitiveCount,CONST void* pVertexStreamZeroData,UINT VertexStreamZeroStride) ;
    HRESULT (STDMETHODCALLTYPE *DrawIndexedPrimitiveUP)(IDirect3DDevice9 * this_,  D3DPRIMITIVETYPE PrimitiveType,UINT MinVertexIndex,UINT NumVertices,UINT PrimitiveCount,CONST void* pIndexData,D3DFORMAT IndexDataFormat,CONST void* pVertexStreamZeroData,UINT VertexStreamZeroStride) ;
    HRESULT (STDMETHODCALLTYPE *ProcessVertices)(IDirect3DDevice9 * this_,  UINT SrcStartIndex,UINT DestIndex,UINT VertexCount,IDirect3DVertexBuffer9* pDestBuffer,IDirect3DVertexDeclaration9* pVertexDecl,DWORD Flags) ;
    HRESULT (STDMETHODCALLTYPE *CreateVertexDeclaration)(IDirect3DDevice9 * this_,  CONST D3DVERTEXELEMENT9* pVertexElements,IDirect3DVertexDeclaration9** ppDecl) ;
    ...
    HRESULT (STDMETHODCALLTYPE *SetStreamSource)(IDirect3DDevice9 * this_,  UINT StreamNumber,IDirect3DVertexBuffer9* pStreamData,UINT OffsetInBytes,UINT Stride) ;
    HRESULT (STDMETHODCALLTYPE *GetStreamSource)(IDirect3DDevice9 * this_,  UINT StreamNumber,IDirect3DVertexBuffer9** ppStreamData,UINT* pOffsetInBytes,UINT* pStride) ;
...
struct IDirect3DSwapChain9Vtbl
{
    ...
    HRESULT (STDMETHODCALLTYPE *Present)(IDirect3DSwapChain9 * this_,  CONST RECT* pSourceRect,CONST RECT* pDestRect,HWND hDestWindowOverride,CONST RGNDATA* pDirtyRegion,DWORD dwFlags) ;
...
struct IDirect3DDevice9ExVtbl
{
    ...
    HRESULT (STDMETHODCALLTYPE *CreateAdditionalSwapChain)(IDirect3DDevice9Ex * this_,  D3DPRESENT_PARAMETERS* pPresentationParameters,IDirect3DSwapChain9** ppSwapChain) ;
    ...
    HRESULT (STDMETHODCALLTYPE *Present)(IDirect3DDevice9Ex * this_,  CONST RECT* pSourceRect,CONST RECT* pDestRect,HWND hDestWindowOverride,CONST RGNDATA* pDirtyRegion) ;
    HRESULT (STDMETHODCALLTYPE *GetBackBuffer)(IDirect3DDevice9Ex * this_,  UINT iSwapChain,UINT iBackBuffer,D3DBACKBUFFER_TYPE Type,IDirect3DSurface9** ppBackBuffer) ;
    ...
    HRESULT (STDMETHODCALLTYPE *CreateTexture)(IDirect3DDevice9Ex * this_,  UINT Width,UINT Height,UINT Levels,DWORD Usage,D3DFORMAT Format,D3DPOOL Pool,IDirect3DTexture9** ppTexture,HANDLE* pSharedHandle) ;
    HRESULT (STDMETHODCALLTYPE *CreateVolumeTexture)(IDirect3DDevice9Ex * this_,  UINT Width,UINT Height,UINT Depth,UINT Levels,DWORD Usage,D3DFORMAT Format,D3DPOOL Pool,IDirect3DVolumeTexture9** ppVolumeTexture,HANDLE* pSharedHandle) ;
    HRESULT (STDMETHODCALLTYPE *CreateCubeTexture)(IDirect3DDevice9Ex * this_,  UINT EdgeLength,UINT Levels,DWORD Usage,D3DFORMAT Format,D3DPOOL Pool,IDirect3DCubeTexture9** ppCubeTexture,HANDLE* pSharedHandle) ;
    HRESULT (STDMETHODCALLTYPE *CreateVertexBuffer)(IDirect3DDevice9Ex * this_,  UINT Length,DWORD Usage,DWORD FVF,D3DPOOL Pool,IDirect3DVertexBuffer9** ppVertexBuffer,HANDLE* pSharedHandle) ;
    HRESULT (STDMETHODCALLTYPE *CreateIndexBuffer)(IDirect3DDevice9Ex * this_,  UINT Length,DWORD Usage,D3DFORMAT Format,D3DPOOL Pool,IDirect3DIndexBuffer9** ppIndexBuffer,HANDLE* pSharedHandle) ;
    HRESULT (STDMETHODCALLTYPE *CreateRenderTarget)(IDirect3DDevice9Ex * this_,  UINT Width,UINT Height,D3DFORMAT Format,D3DMULTISAMPLE_TYPE MultiSample,DWORD MultisampleQuality,BOOL Lockable,IDirect3DSurface9** ppSurface,HANDLE* pSharedHandle) ;
    HRESULT (STDMETHODCALLTYPE *CreateDepthStencilSurface)(IDirect3DDevice9Ex * this_,  UINT Width,UINT Height,D3DFORMAT Format,D3DMULTISAMPLE_TYPE MultiSample,DWORD MultisampleQuality,BOOL Discard,IDirect3DSurface9** ppSurface,HANDLE* pSharedHandle) ;
    HRESULT (STDMETHODCALLTYPE *UpdateSurface)(IDirect3DDevice9Ex * this_,  IDirect3DSurface9* pSourceSurface,CONST RECT* pSourceRect,IDirect3DSurface9* pDestinationSurface,CONST POINT* pDestPoint) ;
    ...
    HRESULT (STDMETHODCALLTYPE *StretchRect)(IDirect3DDevice9Ex * this_,  IDirect3DSurface9* pSourceSurface,CONST RECT* pSourceRect,IDirect3DSurface9* pDestSurface,CONST RECT* pDestRect,D3DTEXTUREFILTERTYPE Filter) ;
    HRESULT (STDMETHODCALLTYPE *ColorFill)(IDirect3DDevice9Ex * this_,  IDirect3DSurface9* pSurface,CONST RECT* pRect,D3DCOLOR color) ;
    HRESULT (STDMETHODCALLTYPE *CreateOffscreenPlainSurface)(IDirect3DDevice9Ex * this_,  UINT Width,UINT Height,D3DFORMAT Format,D3DPOOL Pool,IDirect3DSurface9** ppSurface,HANDLE* pSharedHandle) ;
    ...
    HRESULT (STDMETHODCALLTYPE *DrawIndexedPrimitive)(IDirect3DDevice9Ex * this_,  D3DPRIMITIVETYPE PrimitiveType,INT BaseVertexIndex,UINT MinVertexIndex,UINT NumVertices,UINT startIndex,UINT primCount) ;
    HRESULT (STDMETHODCALLTYPE *DrawPrimitiveUP)(IDirect3DDevice9Ex * this_,  D3DPRIMITIVETYPE PrimitiveType,UINT PrimitiveCount,CONST void* pVertexStreamZeroData,UINT VertexStreamZeroStride) ;
    HRESULT (STDMETHODCALLTYPE *DrawIndexedPrimitiveUP)(IDirect3DDevice9Ex * this_,  D3DPRIMITIVETYPE PrimitiveType,UINT MinVertexIndex,UINT NumVertices,UINT PrimitiveCount,CONST void* pIndexData,D3DFORMAT IndexDataFormat,CONST void* pVertexStreamZeroData,UINT VertexStreamZeroStride) ;
    HRESULT (STDMETHODCALLTYPE *ProcessVertices)(IDirect3DDevice9Ex * this_,  UINT SrcStartIndex,UINT DestIndex,UINT VertexCount,IDirect3DVertexBuffer9* pDestBuffer,IDirect3DVertexDeclaration9* pVertexDecl,DWORD Flags) ;
    HRESULT (STDMETHODCALLTYPE *CreateVertexDeclaration)(IDirect3DDevice9Ex * this_,  CONST D3DVERTEXELEMENT9* pVertexElements,IDirect3DVertexDeclaration9** ppDecl) ;
    ...
    HRESULT (STDMETHODCALLTYPE *SetStreamSource)(IDirect3DDevice9Ex * this_,  UINT StreamNumber,IDirect3DVertexBuffer9* pStreamData,UINT OffsetInBytes,UINT Stride) ;
    HRESULT (STDMETHODCALLTYPE *GetStreamSource)(IDirect3DDevice9Ex * this_,  UINT StreamNumber,IDirect3DVertexBuffer9** ppStreamData,UINT* pOffsetInBytes,UINT* pStride) ;
    ...
    HRESULT (STDMETHODCALLTYPE *ComposeRects)(IDirect3DDevice9Ex * this_,  IDirect3DSurface9* pSrc,IDirect3DSurface9* pDst,IDirect3DVertexBuffer9* pSrcRectDescs,UINT NumRects,IDirect3DVertexBuffer9* pDstRectDescs,D3DCOMPOSERECTSOP Operation,int Xoffset,int Yoffset) ;
    HRESULT (STDMETHODCALLTYPE *PresentEx)(IDirect3DDevice9Ex * this_,  CONST RECT* pSourceRect,CONST RECT* pDestRect,HWND hDestWindowOverride,CONST RGNDATA* pDirtyRegion,DWORD dwFlags) ;
    ...
    HRESULT (STDMETHODCALLTYPE *CreateRenderTargetEx)(IDirect3DDevice9Ex * this_,  UINT Width,UINT Height,D3DFORMAT Format,D3DMULTISAMPLE_TYPE MultiSample,DWORD MultisampleQuality,BOOL Lockable,IDirect3DSurface9** ppSurface,HANDLE* pSharedHandle,DWORD Usage) ;
    HRESULT (STDMETHODCALLTYPE *CreateOffscreenPlainSurfaceEx)(IDirect3DDevice9Ex * this_,  UINT Width,UINT Height,D3DFORMAT Format,D3DPOOL Pool,IDirect3DSurface9** ppSurface,HANDLE* pSharedHandle,DWORD Usage) ;
...
struct IDirect3DSwapChain9ExVtbl
{
    ...
    HRESULT (STDMETHODCALLTYPE *Present)(IDirect3DSwapChain9Ex * this_,  CONST RECT* pSourceRect,CONST RECT* pDestRect,HWND hDestWindowOverride,CONST RGNDATA* pDirtyRegion,DWORD dwFlags) ;
...
struct IDirect3DCryptoSession9Vtbl
{
    ...
    HRESULT (STDMETHODCALLTYPE *EncryptionBlt)(IDirect3DCryptoSession9 * this_,  IDirect3DSurface9* pSrcSurface,IDirect3DSurface9* pDstSurface,UINT DstSurfaceSize,VOID* pIV) ;
    HRESULT (STDMETHODCALLTYPE *DecryptionBlt)(IDirect3DCryptoSession9 * this_,  IDirect3DSurface9* pSrcSurface,IDirect3DSurface9* pDstSurface,UINT SrcSurfaceSize,D3DENCRYPTED_BLOCK_INFO* pEncryptedBlockInfo,VOID* pContentKey,VOID* pIV) ;
...
template <> inline void RealToHooked9<IDirect3D9>(IDirect3D9 * p)
{
...
{
    if (p) RealToHooked_General(**(IDirect3DDevice9Vtbl**)p, g_D3D9OriginVTables._IDirect3DDevice9, g_D3D9HookedVTables._IDirect3DDevice9, "IDirect3DDevice9");
}
template <> inline void RealToHooked9<IDirect3DDevice9>(IDirect3DDevice9 * p)
{
...
{
    if (p) RealToHooked_General(**(IDirect3DStateBlock9Vtbl**)p, g_D3D9OriginVTables._IDirect3DStateBlock9, g_D3D9HookedVTables._IDirect3DStateBlock9, "IDirect3DStateBlock9");
}
template <> inline void RealToHooked9<IDirect3DStateBlock9>(IDirect3DStateBlock9 * p)
{
...
{
    if (p) RealToHooked_General(**(IDirect3DSwapChain9Vtbl**)p, g_D3D9OriginVTables._IDirect3DSwapChain9, g_D3D9HookedVTables._IDirect3DSwapChain9, "IDirect3DSwapChain9");
}
template <> inline void RealToHooked9<IDirect3DSwapChain9>(IDirect3DSwapChain9 * p)
{
...
{
    if (p) RealToHooked_General(**(IDirect3DResource9Vtbl**)p, g_D3D9OriginVTables._IDirect3DResource9, g_D3D9HookedVTables._IDirect3DResource9, "IDirect3DResource9");
}
template <> inline void RealToHooked9<IDirect3DResource9>(IDirect3DResource9 * p)
{
...
{
    if (p) RealToHooked_General(**(IDirect3DVertexDeclaration9Vtbl**)p, g_D3D9OriginVTables._IDirect3DVertexDeclaration9, g_D3D9HookedVTables._IDirect3DVertexDeclaration9, "IDirect3DVertexDeclaration9");
}
template <> inline void RealToHooked9<IDirect3DVertexDeclaration9>(IDirect3DVertexDeclaration9 * p)
{
...
{
    if (p) RealToHooked_General(**(IDirect3DVertexShader9Vtbl**)p, g_D3D9OriginVTables._IDirect3DVertexShader9, g_D3D9HookedVTables._IDirect3DVertexShader9, "IDirect3DVertexShader9");
}
template <> inline void RealToHooked9<IDirect3DVertexShader9>(IDirect3DVertexShader9 * p)
{
...
{
    if (p) RealToHooked_General(**(IDirect3DPixelShader9Vtbl**)p, g_D3D9OriginVTables._IDirect3DPixelShader9, g_D3D9HookedVTables._IDirect3DPixelShader9, "IDirect3DPixelShader9");
}
template <> inline void RealToHooked9<IDirect3DPixelShader9>(IDirect3DPixelShader9 * p)
{
...
{
    if (p) RealToHooked_General(**(IDirect3DBaseTexture9Vtbl**)p, g_D3D9OriginVTables._IDirect3DBaseTexture9, g_D3D9HookedVTables._IDirect3DBaseTexture9, "IDirect3DBaseTexture9");
}
template <> inline void RealToHooked9<IDirect3DBaseTexture9>(IDirect3DBaseTexture9 * p)
{
...
{
    if (p) RealToHooked_General(**(IDirect3DTexture9Vtbl**)p, g_D3D9OriginVTables._IDirect3DTexture9, g_D3D9HookedVTables._IDirect3DTexture9, "IDirect3DTexture9");
}
template <> inline void RealToHooked9<IDirect3DTexture9>(IDirect3DTexture9 * p)
{
...
{
    if (p) RealToHooked_General(**(IDirect3DVolumeTexture9Vtbl**)p, g_D3D9OriginVTables._IDirect3DVolumeTexture9, g_D3D9HookedVTables._IDirect3DVolumeTexture9, "IDirect3DVolumeTexture9");
}
template <> inline void RealToHooked9<IDirect3DVolumeTexture9>(IDirect3DVolumeTexture9 * p)
{
...
{
    if (p) RealToHooked_General(**(IDirect3DCubeTexture9Vtbl**)p, g_D3D9OriginVTables._IDirect3DCubeTexture9, g_D3D9HookedVTables._IDirect3DCubeTexture9, "IDirect3DCubeTexture9");
}
template <> inline void RealToHooked9<IDirect3DCubeTexture9>(IDirect3DCubeTexture9 * p)
{
...
{
    if (p) RealToHooked_General(**(IDirect3DVertexBuffer9Vtbl**)p, g_D3D9OriginVTables._IDirect3DVertexBuffer9, g_D3D9HookedVTables._IDirect3DVertexBuffer9, "IDirect3DVertexBuffer9");
}
template <> inline void RealToHooked9<IDirect3DVertexBuffer9>(IDirect3DVertexBuffer9 * p)
{
...
{
    if (p) RealToHooked_General(**(IDirect3DIndexBuffer9Vtbl**)p, g_D3D9OriginVTables._IDirect3DIndexBuffer9, g_D3D9HookedVTables._IDirect3DIndexBuffer9, "IDirect3DIndexBuffer9");
}
template <> inline void RealToHooked9<IDirect3DIndexBuffer9>(IDirect3DIndexBuffer9 * p)
{
...
{
    if (p) RealToHooked_General(**(IDirect3DSurface9Vtbl**)p, g_D3D9OriginVTables._IDirect3DSurface9, g_D3D9HookedVTables._IDirect3DSurface9, "IDirect3DSurface9");
}
template <> inline void RealToHooked9<IDirect3DSurface9>(IDirect3DSurface9 * p)
{
...
{
    if (p) RealToHooked_General(**(IDirect3DVolume9Vtbl**)p, g_D3D9OriginVTables._IDirect3DVolume9, g_D3D9HookedVTables._IDirect3DVolume9, "IDirect3DVolume9");
}
template <> inline void RealToHooked9<IDirect3DVolume9>(IDirect3DVolume9 * p)
{
...
template <> inline void RealToHooked9<IDirect3DQuery9>(IDirect3DQuery9 * p)
{
...
template <> inline void RealToHooked9<IDirect3D9Ex>(IDirect3D9Ex * p)
{
...
{
    if (p) RealToHooked_General(**(IDirect3DDevice9ExVtbl**)p, g_D3D9OriginVTables._IDirect3DDevice9Ex, g_D3D9HookedVTables._IDirect3DDevice9Ex, "IDirect3DDevice9Ex");
}
template <> inline void RealToHooked9<IDirect3DDevice9Ex>(IDirect3DDevice9Ex * p)
{
...
{
    if (p) RealToHooked_General(**(IDirect3DSwapChain9ExVtbl**)p, g_D3D9OriginVTables._IDirect3DSwapChain9Ex, g_D3D9HookedVTables._IDirect3DSwapChain9Ex, "IDirect3DSwapChain9Ex");
}
template <> inline void RealToHooked9<IDirect3DSwapChain9Ex>(IDirect3DSwapChain9Ex * p)
{
...
{
    if (p) RealToHooked_General(**(IDirect3D9ExOverlayExtensionVtbl**)p, g_D3D9OriginVTables._IDirect3D9ExOverlayExtension, g_D3D9HookedVTables._IDirect3D9ExOverlayExtension, "IDirect3D9ExOverlayExtension");
}
template <> inline void RealToHooked9<IDirect3D9ExOverlayExtension>(IDirect3D9ExOverlayExtension * p)
{
...
{
    if (p) RealToHooked_General(**(IDirect3DDevice9VideoVtbl**)p, g_D3D9OriginVTables._IDirect3DDevice9Video, g_D3D9HookedVTables._IDirect3DDevice9Video, "IDirect3DDevice9Video");
}
template <> inline void RealToHooked9<IDirect3DDevice9Video>(IDirect3DDevice9Video * p)
{
...
{
    if (p) RealToHooked_General(**(IDirect3DAuthenticatedChannel9Vtbl**)p, g_D3D9OriginVTables._IDirect3DAuthenticatedChannel9, g_D3D9HookedVTables._IDirect3DAuthenticatedChannel9, "IDirect3DAuthenticatedChannel9");
}
template <> inline void RealToHooked9<IDirect3DAuthenticatedChannel9>(IDirect3DAuthenticatedChannel9 * p)
{
...
{
    if (p) RealToHooked_General(**(IDirect3DCryptoSession9Vtbl**)p, g_D3D9OriginVTables._IDirect3DCryptoSession9, g_D3D9HookedVTables._IDirect3DCryptoSession9, "IDirect3DCryptoSession9");
}
template <> inline void RealToHooked9<IDirect3DCryptoSession9>(IDirect3DCryptoSession9 * p)
{
