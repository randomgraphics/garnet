...
namespace GN { namespace gfx
{
    ...
    struct D3D11ShaderTypeTraits<ShaderStage::VS>
    {
        ...
        static const char * getLatestProfile( ID3D11Device & dev, GpuProgramLanguage lang )
        {
            ...
            switch( featureLevel )
            {
                case D3D_FEATURE_LEVEL_9_1  : return "vs_2_0";
                case D3D_FEATURE_LEVEL_9_2  : return "vs_2_0";
                case D3D_FEATURE_LEVEL_9_3  : return "vs_2_a";
        ...
        static ID3D11VertexShader * create(
            ID3D11Device & dev,
            const char   * source,
            size_t         len,
            uint32         flags,
        ...
        static void bindShader( ID3D11DeviceContext & cxt, ID3D11DeviceChild * shader )
        {
            cxt.VSSetShader( (ShaderClass*)shader, NULL, 0 );
        }
    ...
    struct D3D11ShaderTypeTraits<ShaderStage::PS>
    {
        ...
        static const char * getLatestProfile( ID3D11Device & dev, GpuProgramLanguage lang )
        {
            ...
            switch( featureLevel )
            {
                case D3D_FEATURE_LEVEL_9_1  : return "ps_2_0";
                case D3D_FEATURE_LEVEL_9_2  : return "ps_2_0";
                case D3D_FEATURE_LEVEL_9_3  : return "ps_2_a";
        ...
        static ID3D11PixelShader * create(
            ID3D11Device & dev,
            const char   * source,
            size_t         len,
            uint32         flags,
        ...
        static void bindShader( ID3D11DeviceContext & cxt, ID3D11DeviceChild * shader )
        {
            cxt.PSSetShader( (ShaderClass*)shader, NULL, 0 );
        }
    ...
    struct D3D11ShaderTypeTraits<ShaderStage::GS>
    {
        ...
        static ID3D11GeometryShader * create(
            ID3D11Device & dev,
            const char   * source,
            size_t         len,
            uint32         flags,
        ...
        static void bindShader( ID3D11DeviceContext & cxt, ID3D11DeviceChild * shader )
        {
            cxt.GSSetShader( (ShaderClass*)shader, NULL, 0 );
        }
    ...
    struct D3D11ShaderTypeTraits<ShaderStage::HS>
    {
        ...
        static ID3D11HullShader * create(
            ID3D11Device & dev,
            const char   * source,
            size_t         len,
            uint32         flags,
        ...
        static void bindShader( ID3D11DeviceContext & cxt, ID3D11DeviceChild * shader )
        {
            cxt.HSSetShader( (ShaderClass*)shader, NULL, 0 );
        }
    ...
    struct D3D11ShaderTypeTraits<ShaderStage::DS>
    {
        ...
        static ID3D11DomainShader * create(
            ID3D11Device & dev,
            const char   * source,
            size_t         len,
            uint32         flags,
        ...
        static void bindShader( ID3D11DeviceContext & cxt, ID3D11DeviceChild * shader )
        {
            cxt.DSSetShader( (ShaderClass*)shader, NULL, 0 );
        }
    ...
    {
        D3D11ShaderTypeTraits<0>::bindShader,
        D3D11ShaderTypeTraits<1>::bindShader,
        D3D11ShaderTypeTraits<2>::bindShader,
        D3D11ShaderTypeTraits<3>::bindShader,
        D3D11ShaderTypeTraits<4>::bindShader,
    };
    ...
    {
        D3D11ShaderTypeTraits<0>::bindConstBuffers,
        D3D11ShaderTypeTraits<1>::bindConstBuffers,
        D3D11ShaderTypeTraits<2>::bindConstBuffers,
        D3D11ShaderTypeTraits<3>::bindConstBuffers,
        D3D11ShaderTypeTraits<4>::bindConstBuffers,
    };
