...
//! constant color
//!
GNGFX_DEFINE_TSV( CONSTANT_COLOR     , D3DTA_CONSTANT           , GL_CONSTANT_ARB      , GL_SRC_COLOR           )

//!
//! constant alpha
//!
GNGFX_DEFINE_TSV( CONSTANT_ALPHA     , D3DTA_CONSTANT_ALPHA     , GL_CONSTANT_ARB      , GL_SRC_ALPHA           )

//!
//! 1.0 - constant color
//!
GNGFX_DEFINE_TSV( CONSTANT_INV_COLOR , D3DTA_CONSTANT_INV_COLOR , GL_CONSTANT_ARB      , GL_ONE_MINUS_SRC_COLOR )

//!
//! 1.0 - constant alpha
//!
GNGFX_DEFINE_TSV( CONSTANT_INV_ALPHA , D3DTA_CONSTANT_INV_ALPHA , GL_CONSTANT_ARB      , GL_ONE_MINUS_SRC_ALPHA )
