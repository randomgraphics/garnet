...
typedef struct {
   ...
   */
  JSAMPROW spare_row;
  JPEG_BOOL spare_full;		/* T if spare buffer is occupied */
...
start_pass_merged_upsample (j_decompress_ptr cinfo)
{
  ...
  upsample->spare_full = JPEG_FALSE;
...
jinit_merged_upsampler (j_decompress_ptr cinfo)
{
  ...
  upsample->pub.need_context_rows = JPEG_FALSE;
