...
#define PARAM_TEMPLS   GN_CONCATNATE( PARAM_TEMPLS_, GN_FUNCTOR_TEMPL_N)
...
#define PARAM_TYPES   GN_CONCATNATE( PARAM_TYPES_, GN_FUNCTOR_TEMPL_N)
...
#define PARAM_VALUES   GN_CONCATNATE( PARAM_VALUES_, GN_FUNCTOR_TEMPL_N)
...
#define PARAM_LIST   GN_CONCATNATE( PARAM_LIST_, GN_FUNCTOR_TEMPL_N)
...
#define PARAM_COMMA   GN_CONCATNATE( PARAM_COMMA_, GN_FUNCTOR_TEMPL_N)

#define CLOSUREBASE_NAME     GN_CONCATNATE(ClosureBase,GN_FUNCTOR_TEMPL_N)
#define FREECLOSURE_NAME     GN_CONCATNATE(FreeClosure,GN_FUNCTOR_TEMPL_N)
#define MEMCLOSURE_NAME      GN_CONCATNATE(MemClosure,GN_FUNCTOR_TEMPL_N)
#define CONSTCLOSURE_NAME    GN_CONCATNATE(ConstMemClosure,GN_FUNCTOR_TEMPL_N)
#define FUNCTOR_NAME         GN_CONCATNATE(Functor,GN_FUNCTOR_TEMPL_N)
