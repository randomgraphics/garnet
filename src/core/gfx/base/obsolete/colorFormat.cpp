...
GN_API const GN::gfx::ColorLayoutDesc GN::gfx::ALL_COLOR_LAYOUTS[] = {
...
//
// -----------------------------------------------------------------------------
GN_API bool GN::gfx::ColorFormat::sFromString(ColorFormat & result, const char * str) {
...
//
// -----------------------------------------------------------------------------
GN_API GN::gfx::ColorFormat GN::gfx::ColorFormat::sFromString(const char * str) {
    ColorFormat result;
    ...
    struct Local {
        static inline const char * layout2str(size_t layout) {
            static const char * LAYOUT_STRING[] = {"LAYOUT_UNKNOWN",     "LAYOUT_1",           "LAYOUT_4_4",
                                                   "LAYOUT_4_4_4_4",     "LAYOUT_5_5_5_1",     "LAYOUT_5_6_5",
                                                   "LAYOUT_8",           "LAYOUT_8_8",         "LAYOUT_8_8_8",
                                                   "LAYOUT_8_8_8_8",     "LAYOUT_10_11_11",    "LAYOUT_11_11_10",
                                                   "LAYOUT_10_10_10_2",  "LAYOUT_16",          "LAYOUT_16_16",
                                                   "LAYOUT_16_16_16_16", "LAYOUT_32",          "LAYOUT_32_32",
                                                   "LAYOUT_32_32_32",    "LAYOUT_32_32_32_32", "LAYOUT_24",
                                                   "LAYOUT_8_24",        "LAYOUT_24_8",        "LAYOUT_4_4_24",
                                                   "LAYOUT_32_8_24",     "LAYOUT_DXT1",        "LAYOUT_DXT3",
                                                   "LAYOUT_DXT3A",       "LAYOUT_DXT5",        "LAYOUT_DXT5A",
                                                   "LAYOUT_DXN",         "LAYOUT_CTX1",        "LAYOUT_DXT3A_AS_1_1_1_1",
        ...
        static inline const char * sign2str(size_t sign) {
            static const char * SIGN_STR[] = {
                "UNORM", "SNORM", "GNORM", "BNORM", "UINT", "SINT", "GINT", "BINT", "FLOAT",
            };
...
//
// -----------------------------------------------------------------------------
GN_API const char * GN::gfx::d3d9Format2Str(int d3d9fmt) {
    struct Item {
        int          fmt;
        const char * str;
    };
...
//
// -----------------------------------------------------------------------------
GN_API GN::gfx::ColorFormat GN::gfx::d3d9Format2ColorFormat(int d3d9fmt) {
    for (size_t i = 0; i < COLOR_FORMAT_CONVERT_TABLE_SIZE; ++i) {
        if (d3d9fmt == s_ColorFormatConvertTable[i].dx9fmt) return s_ColorFormatConvertTable[i].gnfmt;
    }
...
//
// -----------------------------------------------------------------------------
GN_API int GN::gfx::colorFormat2D3D9Format(ColorFormat clrfmt) {
    for (size_t i = 0; i < COLOR_FORMAT_CONVERT_TABLE_SIZE; ++i) {
        if (clrfmt == s_ColorFormatConvertTable[i].gnfmt) return s_ColorFormatConvertTable[i].dx9fmt;
    }
...
//
// -----------------------------------------------------------------------------
GN_API GN::gfx::ColorFormat GN::gfx::dxgiFormat2ColorFormat(int dxgifmt) {
    for (size_t i = 0; i < COLOR_FORMAT_CONVERT_TABLE_SIZE; ++i) {
        if (dxgifmt == (int) s_ColorFormatConvertTable[i].dxgifmt) return s_ColorFormatConvertTable[i].gnfmt;
    }
    return ColorFormat::UNKNOWN;
}
...
//
// -----------------------------------------------------------------------------
GN_API int GN::gfx::colorFormat2DxgiFormat(ColorFormat clrfmt) {
    for (size_t i = 0; i < COLOR_FORMAT_CONVERT_TABLE_SIZE; ++i) {
        if (clrfmt == s_ColorFormatConvertTable[i].gnfmt) return s_ColorFormatConvertTable[i].dxgifmt;
    }
