...
bool GN::gfx::SpriteRenderer::init(Gpu & gpu) {
    ...
    mPureWhiteTexture.attach(mGpu->create2DTexture(img::PixelFormat::RGBA8(), 2, 2));
    ...
    if (caps.shaderModels & ShaderModel::GLSL_1_10) {
        ...
        mVertexBinding[0].format    = img::PixelFormat::FLOAT3();
        ...
        mVertexBinding[1].format    = img::PixelFormat::RGBA8();
