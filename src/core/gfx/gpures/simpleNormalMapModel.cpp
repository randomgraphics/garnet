...
//
// -----------------------------------------------------------------------------
void GN::gfx::SimpleNormalMapModel::setTransform(const Matrix44f & proj, const Matrix44f & view, const Matrix44f & world) {
...
//
// -----------------------------------------------------------------------------
void GN::gfx::SimpleNormalMapModel::setLightPos(const Vector4f & pos) { mLightPos->uniform()->update(pos); }

//
//
// -----------------------------------------------------------------------------
void GN::gfx::SimpleNormalMapModel::setLightColor(const Vector4f & clr) { mLightColor->uniform()->update(clr); }

//
//
// -----------------------------------------------------------------------------
void GN::gfx::SimpleNormalMapModel::setAlbedoColor(const Vector4f & clr) { mAlbedoColor->uniform()->update(clr); }

//
//
// -----------------------------------------------------------------------------
void GN::gfx::SimpleNormalMapModel::setAlbedoTexture(const AutoRef<Texture> & tex) { mAlbedoTexture->setTexture(tex ? tex : mDefaultAlbedoTexture); }

//
//
// -----------------------------------------------------------------------------
void GN::gfx::SimpleNormalMapModel::setNormalTexture(const AutoRef<Texture> & tex) { mNormalTexture->setTexture(tex ? tex : mDefaultNormalTexture); }
