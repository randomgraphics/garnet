...
public:
    ...
    ///
    virtual bool bind(const RenderTargetDesc & oldRT, const RenderTargetDesc & newRT, bool skipDirtyCheck) = 0;
};
...
public:
    ...
    ///
    static bool usable() { return GLEW_EXT_framebuffer_object && GLEW_ARB_draw_buffers; };

    virtual bool init();
    virtual bool bind(const RenderTargetDesc & oldRT, const RenderTargetDesc & newRT, bool skipDirtyCheck);
