...
// -----------------------------------------------------------------------------
static inline bool sColorFormat2OGL(GLint & gl_internalformat, GLuint & gl_format, GLuint & gl_type, bool & gl_compressed, GN::gfx::img::PixelFormat clrfmt,
    ...
    if (img::PixelFormat::RGBA_32_32_32_32_FLOAT() == clrfmt) {
        ...
        gl_type           = GL_FLOAT;
        return true;
    } else if (img::PixelFormat::RGBA_16_16_16_16_UNORM() == clrfmt) {
        gl_internalformat = GL_RGBA16;
        gl_format         = GL_RGBA;
        gl_type           = GL_UNSIGNED_SHORT;
        return true;
    } else if (img::PixelFormat::RGBX_16_16_16_16_UNORM() == clrfmt) {
        gl_internalformat = GL_RGB16;
        gl_format         = GL_RGBA;
        gl_type           = GL_UNSIGNED_SHORT;
        return true;
    } else if (img::PixelFormat::RG_16_16_UNORM() == clrfmt) {
        gl_internalformat = GL_LUMINANCE_ALPHA;
        gl_format         = GL_RGBA;
        gl_type           = GL_UNSIGNED_SHORT;
        return true;
    } else if (img::PixelFormat::RGBA_8_8_8_8_UNORM() == clrfmt) {
        gl_internalformat = GL_RGBA8;
        gl_format         = GL_RGBA;
        gl_type           = GL_UNSIGNED_BYTE;
        return true;
    } else if (img::PixelFormat::BGRA_8_8_8_8_UNORM() == clrfmt) {
        gl_internalformat = GL_RGBA8;
        gl_format         = GL_BGRA_EXT;
        gl_type           = GL_UNSIGNED_BYTE;
        return true;
    } else if (img::PixelFormat::RGBX_8_8_8_8_UNORM() == clrfmt) {
        gl_internalformat = GL_RGB8;
        gl_format         = GL_RGBA;
        gl_type           = GL_UNSIGNED_BYTE;
        return true;
    } else if (img::PixelFormat::BGRX_8_8_8_8_UNORM() == clrfmt) {
        gl_internalformat = GL_RGB8;
        gl_format         = GL_BGRA_EXT;
        gl_type           = GL_UNSIGNED_BYTE;
        return true;
    } else if (img::PixelFormat::RGB_8_8_8_UNORM() == clrfmt) {
        gl_internalformat = GL_RGB8;
        gl_format         = GL_RGB;
        gl_type           = GL_UNSIGNED_BYTE;
        return true;
    } else if (img::PixelFormat::BGR_8_8_8_UNORM() == clrfmt) {
        gl_internalformat = GL_RGB8;
        gl_format         = GL_BGR_EXT;
        gl_type           = GL_UNSIGNED_BYTE;
        return true;
    } else if (img::PixelFormat::BGRA_5_5_5_1_UNORM() == clrfmt) {
        gl_internalformat = GL_RGB5_A1;
        gl_format         = GL_BGRA_EXT;
        gl_type           = GL_UNSIGNED_SHORT_5_5_5_1;
        return true;
    } else if (img::PixelFormat::BGR_5_6_5_UNORM() == clrfmt) {
        gl_internalformat = GL_RGB5;
        gl_format         = GL_BGR_EXT;
        gl_type           = GL_UNSIGNED_SHORT_5_6_5_REV;
        return true;
    } else if (img::PixelFormat::RG_8_8_SNORM() == clrfmt) {
        ...
        return true;
    } else if (img::PixelFormat::LA_16_16_UNORM() == clrfmt) {
        gl_internalformat = GL_LUMINANCE16_ALPHA16;
        gl_format         = GL_LUMINANCE_ALPHA;
        gl_type           = GL_UNSIGNED_SHORT;
        return true;
    } else if (img::PixelFormat::LA_8_8_UNORM() == clrfmt) {
        gl_internalformat = GL_LUMINANCE8_ALPHA8;
        gl_format         = GL_LUMINANCE_ALPHA;
        gl_type           = GL_UNSIGNED_BYTE;
        return true;
    } else if (img::PixelFormat::L_16_UNORM() == clrfmt) {
        gl_internalformat = GL_LUMINANCE16;
        gl_format         = GL_LUMINANCE;
        gl_type           = GL_UNSIGNED_SHORT;
        return true;
    } else if (img::PixelFormat::R_8_UNORM() == clrfmt) {
        gl_internalformat = 1;
        gl_format         = GL_RED;
        gl_type           = GL_UNSIGNED_BYTE;
        return true;

    } else if (img::PixelFormat::L_8_UNORM() == clrfmt) {
        gl_internalformat = GL_LUMINANCE8;
        gl_format         = GL_LUMINANCE;
        gl_type           = GL_UNSIGNED_BYTE;
        return true;
    } else if (img::PixelFormat::A_8_UNORM() == clrfmt) {
    ...
    } else if (img::PixelFormat::BC2_UNORM() == clrfmt) {
        if (GLEW_ARB_texture_compression && GLEW_EXT_texture_compression_s3tc) {
    ...
    } else if (img::PixelFormat::BC3_UNORM() == clrfmt) {
        if (GLEW_ARB_texture_compression && GLEW_EXT_texture_compression_s3tc) {
