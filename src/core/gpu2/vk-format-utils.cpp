...
constexpr gfx::img::PixelFormat VK_PF_MAPPING[] = {
    ...
    PF::D_16_UNORM(),                    // 124 eD16Unorm
    PF::RX_24_8_UNORM(),                 // 125 eX8D24UnormPack32
    PF::D_32_FLOAT(),                    // 126 eD32Sfloat
    PF::R_8_UINT(),                      // 127 eS8Uint
    PF::RG_16_UNORM_8_UINT(),            // 128 eD16UnormS8Uint
