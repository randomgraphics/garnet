...
#   define TSM_ASSERT_LESS_THAN(m,x,y) _TSM_ASSERT_LESS_THAN(__FILE__,__LINE__,m,x,y)
    ...
    // TS_ASSERT_LESS_EQUALS
#   define ___ETS_ASSERT_LESS_EQUALS(f,l,x,y,m) \
        CxxTest::doAssertLessThanEquals( (f), (l), #x, (x), #y, (y), (m) )
#   define ___TS_ASSERT_LESS_EQUALS(f,l,x,y,m) \
        { _TS_TRY { ___ETS_ASSERT_LESS_EQUALS(f,l,x,y,m); } __TS_CATCH(f,l) }

#   define _ETS_ASSERT_LESS_EQUALS(f,l,x,y) ___ETS_ASSERT_LESS_EQUALS(f,l,x,y,0)
#   define _TS_ASSERT_LESS_EQUALS(f,l,x,y) ___TS_ASSERT_LESS_EQUALS(f,l,x,y,0)

#   define ETS_ASSERT_LESS_EQUALS(x,y) _ETS_ASSERT_LESS_EQUALS(__FILE__,__LINE__,x,y)
#   define TS_ASSERT_LESS_EQUALS(x,y) _TS_ASSERT_LESS_EQUALS(__FILE__,__LINE__,x,y)

#   define _ETSM_ASSERT_LESS_EQUALS(f,l,m,x,y) ___ETS_ASSERT_LESS_EQUALS(f,l,x,y,TS_AS_STRING(m))
#   define _TSM_ASSERT_LESS_EQUALS(f,l,m,x,y) ___TS_ASSERT_LESS_EQUALS(f,l,x,y,TS_AS_STRING(m))

#   define ETSM_ASSERT_LESS_EQUALS(m,x,y) _ETSM_ASSERT_LESS_EQUALS(__FILE__,__LINE__,m,x,y)
#   define TSM_ASSERT_LESS_EQUALS(m,x,y) _TSM_ASSERT_LESS_EQUALS(__FILE__,__LINE__,m,x,y)
...
#   define TSM_ASSERT_THROWS_LESS_THAN(m,e,t,x,y) TSM_ASSERT_THROWS_ASSERT(m,e,t,TSM_ASSERT_LESS_THAN(m,x,y))
    ...
    // TS_ASSERT_THROWS_LESS_EQUALS
#   define TS_ASSERT_THROWS_LESS_EQUALS(e,t,x,y) TS_ASSERT_THROWS_ASSERT(e,t,TS_ASSERT_LESS_EQUALS(x,y))
#   define TSM_ASSERT_THROWS_LESS_EQUALS(m,e,t,x,y) TSM_ASSERT_THROWS_ASSERT(m,e,t,TSM_ASSERT_LESS_EQUALS(m,x,y))
...
#   define CXXTEST_COMPARISONS(CXXTEST_X, CXXTEST_Y, CXXTEST_T) \
    ...
    inline bool lessEquals( CXXTEST_X x, CXXTEST_Y y ) { return (((CXXTEST_T)x) <= ((CXXTEST_T)y)); } \
    inline bool lessEquals( CXXTEST_Y y, CXXTEST_X x ) { return (((CXXTEST_T)y) <= ((CXXTEST_T)x)); }
