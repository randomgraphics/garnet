...
#define DEFINE_MEMCLOSURE( CALL_CONVENSION, CONSTNESS )                                                                 \
        ...
        public:
            ...
            FTRCLOSURE_NAME( const X & x )
                : BaseType(FUNCTOR_FUNC), mFunc(x)
            {
            }
...
#define DEFINE_FTRPTRCLOSURE( DUMMY, CONSTNESS )                                                                        \
        ...
        public:                                                                                                         \
                                                                                                                        \
            FTRPTRCLOSURE_NAME(DUMMY,CONSTNESS)( CONSTNESS X * x )                                                      \
                : BaseType(FUNCTOR_FUNC), mFunctor(x)                                                                   \
            {                                                                                                           \
                GN_ASSERT(x);                                                                                           \
            }                                                                                                           \
                                                                                                                        \
...
#define MAKE_FREEDELEGATE( CALL_CONVENSION, DUMMY )       \
    template<typename R PARAM_COMMA PARAM_TEMPLS>         \
    inline DELEGATE_NAME<R PARAM_COMMA PARAM_TYPES>       \
...
#define MAKE_MEMDELEGATE( CALL_CONVENSION, CONSTNESS )                                \
    ...
    inline DELEGATE_NAME<R PARAM_COMMA PARAM_TYPES>                                   \
    makeDelegate( CONSTNESS Y * x, R( CALL_CONVENSION X::*f)(PARAM_TYPES) CONSTNESS ) \
    {                                                                                 \
