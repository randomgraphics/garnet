...
///
/// Implement static input data members (used by core module only)
///
#define GN_IMPLEMENT_INPUT_STATIC_MEMBERS() \
    GN_PUBLIC ::GN::Signal1<void,GN::input::KeyEvent> GN::input::Input::sSigKeyPress;  \
    GN_PUBLIC ::GN::Signal1<void,wchar_t>             GN::input::Input::sSigCharPress; \
    GN_PUBLIC ::GN::Signal2<void,GN::input::Axis,int> GN::input::Input::sSigAxisMove;
...
namespace GN
{
    ...
    namespace input
    {
        ...
        struct Input : public CrossDllSingleton<Input>, public NoCopy
        {
            ...
            ///
            GN_PUBLIC static Signal1<void,KeyEvent> sSigKeyPress;

            ///
            /// triggered when a valid unicode character was generated by user input
            ///
            GN_PUBLIC static Signal1<void,wchar_t> sSigCharPress;
            ...
            /// \note  参数2中返回的是相对位移
            ///
            GN_PUBLIC static Signal2<void,Axis,int> sSigAxisMove;
