...
// Compile time switches generated by build script.
#include "base/gnconfig.h"

//@{
/*!
    Hard-coded compile time switches
...
/// \def GN_BUILD_DEBUG              Enable debug code

/// \def GN_BUILD_PROFILE            Enable profile code

/// \def GN_BUILD_RETAIL             Enable retail code (which means, debug and prifle code should both be disabled)

/// \def GN_BUILD_STATIC             Enable static (non-dll) build.

/// \def GN_BUILD_ENABLE_GUARD       Enable function guard.
///                                  Note that disable this flag will also disable slow guard.

/// \def GN_BUILD_ENABLE_SLOW_GUARD  Enable function guards in time-critical code.
///                                  Note that this switch is ignored, if GN_BUILD_ENABLE_GUARD is off.

/// \def GN_BUILD_ENABLE_LOG         Enable runtime log.

/// \def GN_BUILD_ENABLE_ASSERT      Enable assert macro

/// \def GN_BUILD_LEFT_HAND          Enable left hand coordinate system. Right hand coordinate system will
///                                  be used if this switch is off.

/// \def GN_BUILD_ENABLE_PIX         Enable PIX tag (on Windows and Xbox platform)
