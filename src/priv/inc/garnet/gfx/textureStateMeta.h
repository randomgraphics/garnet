...
//! color argument 0
//!
GNGFX_DEFINE_TS( COLORARG0    , TEXTURE_COLOR  , TEXTURE_COLOR  , D3DTSS_COLORARG1 , GL_SOURCE0_RGB_ARB   , GL_OPERAND0_RGB_ARB   )

//!
//!  color argument 1
//!
GNGFX_DEFINE_TS( COLORARG1    , CURRENT_COLOR  , CURRENT_COLOR  , D3DTSS_COLORARG2 , GL_SOURCE1_RGB_ARB   , GL_OPERAND1_RGB_ARB   )
...
//! alpha argument 0
//!
GNGFX_DEFINE_TS( ALPHAARG0    , TEXTURE_ALPHA  , TEXTURE_ALPHA  , D3DTSS_ALPHAARG1 , GL_SOURCE0_ALPHA_ARB , GL_OPERAND0_ALPHA_ARB )

//!
//! alpha argument 1
//!
GNGFX_DEFINE_TS( ALPHAARG1    , CURRENT_ALPHA  , CURRENT_ALPHA  , D3DTSS_ALPHAARG2 , GL_SOURCE1_ALPHA_ARB , GL_OPERAND1_ALPHA_ARB )
