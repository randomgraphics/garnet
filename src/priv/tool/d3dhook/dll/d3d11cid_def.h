...
enum D3D11_CALL_ID
{
    ...
    // CID for IDXGIInfoQueue
    CID_IDXGIInfoQueue_BASE,
    CID_IDXGIInfoQueue_COUNT = 37,
    CID_IDXGIInfoQueue_SetMessageCountLimit = CID_IDXGIInfoQueue_BASE + 0,
    CID_IDXGIInfoQueue_ClearStoredMessages = CID_IDXGIInfoQueue_BASE + 1,
    CID_IDXGIInfoQueue_GetMessage = CID_IDXGIInfoQueue_BASE + 2,
    CID_IDXGIInfoQueue_GetNumStoredMessagesAllowedByRetrievalFilters = CID_IDXGIInfoQueue_BASE + 3,
    CID_IDXGIInfoQueue_GetNumStoredMessages = CID_IDXGIInfoQueue_BASE + 4,
    CID_IDXGIInfoQueue_GetNumMessagesDiscardedByMessageCountLimit = CID_IDXGIInfoQueue_BASE + 5,
    CID_IDXGIInfoQueue_GetMessageCountLimit = CID_IDXGIInfoQueue_BASE + 6,
    CID_IDXGIInfoQueue_GetNumMessagesAllowedByStorageFilter = CID_IDXGIInfoQueue_BASE + 7,
    CID_IDXGIInfoQueue_GetNumMessagesDeniedByStorageFilter = CID_IDXGIInfoQueue_BASE + 8,
    CID_IDXGIInfoQueue_AddStorageFilterEntries = CID_IDXGIInfoQueue_BASE + 9,
    CID_IDXGIInfoQueue_GetStorageFilter = CID_IDXGIInfoQueue_BASE + 10,
    CID_IDXGIInfoQueue_ClearStorageFilter = CID_IDXGIInfoQueue_BASE + 11,
    CID_IDXGIInfoQueue_PushEmptyStorageFilter = CID_IDXGIInfoQueue_BASE + 12,
    CID_IDXGIInfoQueue_PushDenyAllStorageFilter = CID_IDXGIInfoQueue_BASE + 13,
    CID_IDXGIInfoQueue_PushCopyOfStorageFilter = CID_IDXGIInfoQueue_BASE + 14,
    CID_IDXGIInfoQueue_PushStorageFilter = CID_IDXGIInfoQueue_BASE + 15,
    CID_IDXGIInfoQueue_PopStorageFilter = CID_IDXGIInfoQueue_BASE + 16,
    CID_IDXGIInfoQueue_GetStorageFilterStackSize = CID_IDXGIInfoQueue_BASE + 17,
    CID_IDXGIInfoQueue_AddRetrievalFilterEntries = CID_IDXGIInfoQueue_BASE + 18,
    CID_IDXGIInfoQueue_GetRetrievalFilter = CID_IDXGIInfoQueue_BASE + 19,
    CID_IDXGIInfoQueue_ClearRetrievalFilter = CID_IDXGIInfoQueue_BASE + 20,
    CID_IDXGIInfoQueue_PushEmptyRetrievalFilter = CID_IDXGIInfoQueue_BASE + 21,
    CID_IDXGIInfoQueue_PushDenyAllRetrievalFilter = CID_IDXGIInfoQueue_BASE + 22,
    CID_IDXGIInfoQueue_PushCopyOfRetrievalFilter = CID_IDXGIInfoQueue_BASE + 23,
    CID_IDXGIInfoQueue_PushRetrievalFilter = CID_IDXGIInfoQueue_BASE + 24,
    CID_IDXGIInfoQueue_PopRetrievalFilter = CID_IDXGIInfoQueue_BASE + 25,
    CID_IDXGIInfoQueue_GetRetrievalFilterStackSize = CID_IDXGIInfoQueue_BASE + 26,
    CID_IDXGIInfoQueue_AddMessage = CID_IDXGIInfoQueue_BASE + 27,
    CID_IDXGIInfoQueue_AddApplicationMessage = CID_IDXGIInfoQueue_BASE + 28,
    CID_IDXGIInfoQueue_SetBreakOnCategory = CID_IDXGIInfoQueue_BASE + 29,
    CID_IDXGIInfoQueue_SetBreakOnSeverity = CID_IDXGIInfoQueue_BASE + 30,
    CID_IDXGIInfoQueue_SetBreakOnID = CID_IDXGIInfoQueue_BASE + 31,
    CID_IDXGIInfoQueue_GetBreakOnCategory = CID_IDXGIInfoQueue_BASE + 32,
    CID_IDXGIInfoQueue_GetBreakOnSeverity = CID_IDXGIInfoQueue_BASE + 33,
    CID_IDXGIInfoQueue_GetBreakOnID = CID_IDXGIInfoQueue_BASE + 34,
    CID_IDXGIInfoQueue_SetMuteDebugOutput = CID_IDXGIInfoQueue_BASE + 35,
    CID_IDXGIInfoQueue_GetMuteDebugOutput = CID_IDXGIInfoQueue_BASE + 36,

    // CID for IDXGIDebug
    CID_IDXGIDebug_BASE,
    CID_IDXGIDebug_COUNT = 1,
    CID_IDXGIDebug_ReportLiveObjects = CID_IDXGIDebug_BASE + 0,
