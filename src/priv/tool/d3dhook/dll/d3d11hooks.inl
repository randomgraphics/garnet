...
// IDXGIInfoQueue
// ==============================================================================
class DXGIInfoQueueHook : public HookBase<IDXGIInfoQueue>
{

protected:

    DXGIInfoQueueHook(UnknownBase & unknown,     IUnknown * realobj)
        : BASE_CLASS(unknown, realobj)
    {
    }
...
public:
    ...
    static IUnknown * sNewInstance(void * context, UnknownBase & unknown, IUnknown * realobj)
    {
        ...
        try
        {
            return new DXGIInfoQueueHook(unknown, realobj);
        }
        catch(std::bad_alloc&)
        {
            HOOK_ERROR_LOG("Out of memory.");
    ...
    {
        UNREFERENCED_PARAMETER(context);
        DXGIInfoQueueHook * typedPtr = (DXGIInfoQueueHook *)ptr;
        delete typedPtr;
    }

    // -----------------------------------------------------------------------------
    virtual HRESULT STDMETHODCALLTYPE SetMessageCountLimit(_In_  DXGI_DEBUG_ID Producer, _In_  UINT64 MessageCountLimit);
    NullPtr<void (DXGIInfoQueueHook::*)(_In_  DXGI_DEBUG_ID &, _In_  UINT64 &)> _SetMessageCountLimit_pre_ptr;
    NullPtr<void (DXGIInfoQueueHook::*)(HRESULT, _In_  DXGI_DEBUG_ID, _In_  UINT64)> _SetMessageCountLimit_post_ptr;

    // -----------------------------------------------------------------------------
    virtual void STDMETHODCALLTYPE ClearStoredMessages(_In_  DXGI_DEBUG_ID Producer);
    NullPtr<void (DXGIInfoQueueHook::*)(_In_  DXGI_DEBUG_ID &)> _ClearStoredMessages_pre_ptr;
    NullPtr<void (DXGIInfoQueueHook::*)(_In_  DXGI_DEBUG_ID)> _ClearStoredMessages_post_ptr;

    // -----------------------------------------------------------------------------
    virtual HRESULT STDMETHODCALLTYPE GetMessage(_In_  DXGI_DEBUG_ID Producer, _In_  UINT64 MessageIndex, _Out_writes_bytes_opt_(*pMessageByteLength)  DXGI_INFO_QUEUE_MESSAGE * pMessage, _Inout_  SIZE_T * pMessageByteLength);
    NullPtr<void (DXGIInfoQueueHook::*)(_In_  DXGI_DEBUG_ID &, _In_  UINT64 &, _Out_writes_bytes_opt_(*pMessageByteLength)  DXGI_INFO_QUEUE_MESSAGE * &, _Inout_  SIZE_T * &)> _GetMessage_pre_ptr;
    NullPtr<void (DXGIInfoQueueHook::*)(HRESULT, _In_  DXGI_DEBUG_ID, _In_  UINT64, _Out_writes_bytes_opt_(*pMessageByteLength)  DXGI_INFO_QUEUE_MESSAGE *, _Inout_  SIZE_T *)> _GetMessage_post_ptr;

    // -----------------------------------------------------------------------------
    virtual UINT64 STDMETHODCALLTYPE GetNumStoredMessagesAllowedByRetrievalFilters(_In_  DXGI_DEBUG_ID Producer);
    NullPtr<void (DXGIInfoQueueHook::*)(_In_  DXGI_DEBUG_ID &)> _GetNumStoredMessagesAllowedByRetrievalFilters_pre_ptr;
    NullPtr<void (DXGIInfoQueueHook::*)(UINT64, _In_  DXGI_DEBUG_ID)> _GetNumStoredMessagesAllowedByRetrievalFilters_post_ptr;

    // -----------------------------------------------------------------------------
    virtual UINT64 STDMETHODCALLTYPE GetNumStoredMessages(_In_  DXGI_DEBUG_ID Producer);
    NullPtr<void (DXGIInfoQueueHook::*)(_In_  DXGI_DEBUG_ID &)> _GetNumStoredMessages_pre_ptr;
    NullPtr<void (DXGIInfoQueueHook::*)(UINT64, _In_  DXGI_DEBUG_ID)> _GetNumStoredMessages_post_ptr;

    // -----------------------------------------------------------------------------
    virtual UINT64 STDMETHODCALLTYPE GetNumMessagesDiscardedByMessageCountLimit(_In_  DXGI_DEBUG_ID Producer);
    NullPtr<void (DXGIInfoQueueHook::*)(_In_  DXGI_DEBUG_ID &)> _GetNumMessagesDiscardedByMessageCountLimit_pre_ptr;
    NullPtr<void (DXGIInfoQueueHook::*)(UINT64, _In_  DXGI_DEBUG_ID)> _GetNumMessagesDiscardedByMessageCountLimit_post_ptr;

    // -----------------------------------------------------------------------------
    virtual UINT64 STDMETHODCALLTYPE GetMessageCountLimit(_In_  DXGI_DEBUG_ID Producer);
    NullPtr<void (DXGIInfoQueueHook::*)(_In_  DXGI_DEBUG_ID &)> _GetMessageCountLimit_pre_ptr;
    NullPtr<void (DXGIInfoQueueHook::*)(UINT64, _In_  DXGI_DEBUG_ID)> _GetMessageCountLimit_post_ptr;

    // -----------------------------------------------------------------------------
    virtual UINT64 STDMETHODCALLTYPE GetNumMessagesAllowedByStorageFilter(_In_  DXGI_DEBUG_ID Producer);
    NullPtr<void (DXGIInfoQueueHook::*)(_In_  DXGI_DEBUG_ID &)> _GetNumMessagesAllowedByStorageFilter_pre_ptr;
    NullPtr<void (DXGIInfoQueueHook::*)(UINT64, _In_  DXGI_DEBUG_ID)> _GetNumMessagesAllowedByStorageFilter_post_ptr;

    // -----------------------------------------------------------------------------
    virtual UINT64 STDMETHODCALLTYPE GetNumMessagesDeniedByStorageFilter(_In_  DXGI_DEBUG_ID Producer);
    NullPtr<void (DXGIInfoQueueHook::*)(_In_  DXGI_DEBUG_ID &)> _GetNumMessagesDeniedByStorageFilter_pre_ptr;
    NullPtr<void (DXGIInfoQueueHook::*)(UINT64, _In_  DXGI_DEBUG_ID)> _GetNumMessagesDeniedByStorageFilter_post_ptr;

    // -----------------------------------------------------------------------------
    virtual HRESULT STDMETHODCALLTYPE AddStorageFilterEntries(_In_  DXGI_DEBUG_ID Producer, _In_  DXGI_INFO_QUEUE_FILTER * pFilter);
    NullPtr<void (DXGIInfoQueueHook::*)(_In_  DXGI_DEBUG_ID &, _In_  DXGI_INFO_QUEUE_FILTER * &)> _AddStorageFilterEntries_pre_ptr;
    NullPtr<void (DXGIInfoQueueHook::*)(HRESULT, _In_  DXGI_DEBUG_ID, _In_  DXGI_INFO_QUEUE_FILTER *)> _AddStorageFilterEntries_post_ptr;

    // -----------------------------------------------------------------------------
    virtual HRESULT STDMETHODCALLTYPE GetStorageFilter(_In_  DXGI_DEBUG_ID Producer, _Out_writes_bytes_opt_(*pFilterByteLength)  DXGI_INFO_QUEUE_FILTER * pFilter, _Inout_  SIZE_T * pFilterByteLength);
    NullPtr<void (DXGIInfoQueueHook::*)(_In_  DXGI_DEBUG_ID &, _Out_writes_bytes_opt_(*pFilterByteLength)  DXGI_INFO_QUEUE_FILTER * &, _Inout_  SIZE_T * &)> _GetStorageFilter_pre_ptr;
    NullPtr<void (DXGIInfoQueueHook::*)(HRESULT, _In_  DXGI_DEBUG_ID, _Out_writes_bytes_opt_(*pFilterByteLength)  DXGI_INFO_QUEUE_FILTER *, _Inout_  SIZE_T *)> _GetStorageFilter_post_ptr;

    // -----------------------------------------------------------------------------
    virtual void STDMETHODCALLTYPE ClearStorageFilter(_In_  DXGI_DEBUG_ID Producer);
    NullPtr<void (DXGIInfoQueueHook::*)(_In_  DXGI_DEBUG_ID &)> _ClearStorageFilter_pre_ptr;
    NullPtr<void (DXGIInfoQueueHook::*)(_In_  DXGI_DEBUG_ID)> _ClearStorageFilter_post_ptr;

    // -----------------------------------------------------------------------------
    virtual HRESULT STDMETHODCALLTYPE PushEmptyStorageFilter(_In_  DXGI_DEBUG_ID Producer);
    NullPtr<void (DXGIInfoQueueHook::*)(_In_  DXGI_DEBUG_ID &)> _PushEmptyStorageFilter_pre_ptr;
    NullPtr<void (DXGIInfoQueueHook::*)(HRESULT, _In_  DXGI_DEBUG_ID)> _PushEmptyStorageFilter_post_ptr;

    // -----------------------------------------------------------------------------
    virtual HRESULT STDMETHODCALLTYPE PushDenyAllStorageFilter(_In_  DXGI_DEBUG_ID Producer);
    NullPtr<void (DXGIInfoQueueHook::*)(_In_  DXGI_DEBUG_ID &)> _PushDenyAllStorageFilter_pre_ptr;
    NullPtr<void (DXGIInfoQueueHook::*)(HRESULT, _In_  DXGI_DEBUG_ID)> _PushDenyAllStorageFilter_post_ptr;

    // -----------------------------------------------------------------------------
    virtual HRESULT STDMETHODCALLTYPE PushCopyOfStorageFilter(_In_  DXGI_DEBUG_ID Producer);
    NullPtr<void (DXGIInfoQueueHook::*)(_In_  DXGI_DEBUG_ID &)> _PushCopyOfStorageFilter_pre_ptr;
    NullPtr<void (DXGIInfoQueueHook::*)(HRESULT, _In_  DXGI_DEBUG_ID)> _PushCopyOfStorageFilter_post_ptr;

    // -----------------------------------------------------------------------------
    virtual HRESULT STDMETHODCALLTYPE PushStorageFilter(_In_  DXGI_DEBUG_ID Producer, _In_  DXGI_INFO_QUEUE_FILTER * pFilter);
    NullPtr<void (DXGIInfoQueueHook::*)(_In_  DXGI_DEBUG_ID &, _In_  DXGI_INFO_QUEUE_FILTER * &)> _PushStorageFilter_pre_ptr;
    NullPtr<void (DXGIInfoQueueHook::*)(HRESULT, _In_  DXGI_DEBUG_ID, _In_  DXGI_INFO_QUEUE_FILTER *)> _PushStorageFilter_post_ptr;

    // -----------------------------------------------------------------------------
    virtual void STDMETHODCALLTYPE PopStorageFilter(_In_  DXGI_DEBUG_ID Producer);
    NullPtr<void (DXGIInfoQueueHook::*)(_In_  DXGI_DEBUG_ID &)> _PopStorageFilter_pre_ptr;
    NullPtr<void (DXGIInfoQueueHook::*)(_In_  DXGI_DEBUG_ID)> _PopStorageFilter_post_ptr;

    // -----------------------------------------------------------------------------
    virtual UINT STDMETHODCALLTYPE GetStorageFilterStackSize(_In_  DXGI_DEBUG_ID Producer);
    NullPtr<void (DXGIInfoQueueHook::*)(_In_  DXGI_DEBUG_ID &)> _GetStorageFilterStackSize_pre_ptr;
    NullPtr<void (DXGIInfoQueueHook::*)(UINT, _In_  DXGI_DEBUG_ID)> _GetStorageFilterStackSize_post_ptr;

    // -----------------------------------------------------------------------------
    virtual HRESULT STDMETHODCALLTYPE AddRetrievalFilterEntries(_In_  DXGI_DEBUG_ID Producer, _In_  DXGI_INFO_QUEUE_FILTER * pFilter);
    NullPtr<void (DXGIInfoQueueHook::*)(_In_  DXGI_DEBUG_ID &, _In_  DXGI_INFO_QUEUE_FILTER * &)> _AddRetrievalFilterEntries_pre_ptr;
    NullPtr<void (DXGIInfoQueueHook::*)(HRESULT, _In_  DXGI_DEBUG_ID, _In_  DXGI_INFO_QUEUE_FILTER *)> _AddRetrievalFilterEntries_post_ptr;

    // -----------------------------------------------------------------------------
    virtual HRESULT STDMETHODCALLTYPE GetRetrievalFilter(_In_  DXGI_DEBUG_ID Producer, _Out_writes_bytes_opt_(*pFilterByteLength)  DXGI_INFO_QUEUE_FILTER * pFilter, _Inout_  SIZE_T * pFilterByteLength);
    NullPtr<void (DXGIInfoQueueHook::*)(_In_  DXGI_DEBUG_ID &, _Out_writes_bytes_opt_(*pFilterByteLength)  DXGI_INFO_QUEUE_FILTER * &, _Inout_  SIZE_T * &)> _GetRetrievalFilter_pre_ptr;
    NullPtr<void (DXGIInfoQueueHook::*)(HRESULT, _In_  DXGI_DEBUG_ID, _Out_writes_bytes_opt_(*pFilterByteLength)  DXGI_INFO_QUEUE_FILTER *, _Inout_  SIZE_T *)> _GetRetrievalFilter_post_ptr;

    // -----------------------------------------------------------------------------
    virtual void STDMETHODCALLTYPE ClearRetrievalFilter(_In_  DXGI_DEBUG_ID Producer);
    NullPtr<void (DXGIInfoQueueHook::*)(_In_  DXGI_DEBUG_ID &)> _ClearRetrievalFilter_pre_ptr;
    NullPtr<void (DXGIInfoQueueHook::*)(_In_  DXGI_DEBUG_ID)> _ClearRetrievalFilter_post_ptr;

    // -----------------------------------------------------------------------------
    virtual HRESULT STDMETHODCALLTYPE PushEmptyRetrievalFilter(_In_  DXGI_DEBUG_ID Producer);
    NullPtr<void (DXGIInfoQueueHook::*)(_In_  DXGI_DEBUG_ID &)> _PushEmptyRetrievalFilter_pre_ptr;
    NullPtr<void (DXGIInfoQueueHook::*)(HRESULT, _In_  DXGI_DEBUG_ID)> _PushEmptyRetrievalFilter_post_ptr;

    // -----------------------------------------------------------------------------
    virtual HRESULT STDMETHODCALLTYPE PushDenyAllRetrievalFilter(_In_  DXGI_DEBUG_ID Producer);
    NullPtr<void (DXGIInfoQueueHook::*)(_In_  DXGI_DEBUG_ID &)> _PushDenyAllRetrievalFilter_pre_ptr;
    NullPtr<void (DXGIInfoQueueHook::*)(HRESULT, _In_  DXGI_DEBUG_ID)> _PushDenyAllRetrievalFilter_post_ptr;

    // -----------------------------------------------------------------------------
    virtual HRESULT STDMETHODCALLTYPE PushCopyOfRetrievalFilter(_In_  DXGI_DEBUG_ID Producer);
    NullPtr<void (DXGIInfoQueueHook::*)(_In_  DXGI_DEBUG_ID &)> _PushCopyOfRetrievalFilter_pre_ptr;
    NullPtr<void (DXGIInfoQueueHook::*)(HRESULT, _In_  DXGI_DEBUG_ID)> _PushCopyOfRetrievalFilter_post_ptr;

    // -----------------------------------------------------------------------------
    virtual HRESULT STDMETHODCALLTYPE PushRetrievalFilter(_In_  DXGI_DEBUG_ID Producer, _In_  DXGI_INFO_QUEUE_FILTER * pFilter);
    NullPtr<void (DXGIInfoQueueHook::*)(_In_  DXGI_DEBUG_ID &, _In_  DXGI_INFO_QUEUE_FILTER * &)> _PushRetrievalFilter_pre_ptr;
    NullPtr<void (DXGIInfoQueueHook::*)(HRESULT, _In_  DXGI_DEBUG_ID, _In_  DXGI_INFO_QUEUE_FILTER *)> _PushRetrievalFilter_post_ptr;

    // -----------------------------------------------------------------------------
    virtual void STDMETHODCALLTYPE PopRetrievalFilter(_In_  DXGI_DEBUG_ID Producer);
    NullPtr<void (DXGIInfoQueueHook::*)(_In_  DXGI_DEBUG_ID &)> _PopRetrievalFilter_pre_ptr;
    NullPtr<void (DXGIInfoQueueHook::*)(_In_  DXGI_DEBUG_ID)> _PopRetrievalFilter_post_ptr;

    // -----------------------------------------------------------------------------
    virtual UINT STDMETHODCALLTYPE GetRetrievalFilterStackSize(_In_  DXGI_DEBUG_ID Producer);
    NullPtr<void (DXGIInfoQueueHook::*)(_In_  DXGI_DEBUG_ID &)> _GetRetrievalFilterStackSize_pre_ptr;
    NullPtr<void (DXGIInfoQueueHook::*)(UINT, _In_  DXGI_DEBUG_ID)> _GetRetrievalFilterStackSize_post_ptr;

    // -----------------------------------------------------------------------------
    virtual HRESULT STDMETHODCALLTYPE AddMessage(_In_  DXGI_DEBUG_ID Producer, _In_  DXGI_INFO_QUEUE_MESSAGE_CATEGORY Category, _In_  DXGI_INFO_QUEUE_MESSAGE_SEVERITY Severity, _In_  DXGI_INFO_QUEUE_MESSAGE_ID ID, _In_  LPCSTR pDescription);
    NullPtr<void (DXGIInfoQueueHook::*)(_In_  DXGI_DEBUG_ID &, _In_  DXGI_INFO_QUEUE_MESSAGE_CATEGORY &, _In_  DXGI_INFO_QUEUE_MESSAGE_SEVERITY &, _In_  DXGI_INFO_QUEUE_MESSAGE_ID &, _In_  LPCSTR &)> _AddMessage_pre_ptr;
    NullPtr<void (DXGIInfoQueueHook::*)(HRESULT, _In_  DXGI_DEBUG_ID, _In_  DXGI_INFO_QUEUE_MESSAGE_CATEGORY, _In_  DXGI_INFO_QUEUE_MESSAGE_SEVERITY, _In_  DXGI_INFO_QUEUE_MESSAGE_ID, _In_  LPCSTR)> _AddMessage_post_ptr;

    // -----------------------------------------------------------------------------
    virtual HRESULT STDMETHODCALLTYPE AddApplicationMessage(_In_  DXGI_INFO_QUEUE_MESSAGE_SEVERITY Severity, _In_  LPCSTR pDescription);
    NullPtr<void (DXGIInfoQueueHook::*)(_In_  DXGI_INFO_QUEUE_MESSAGE_SEVERITY &, _In_  LPCSTR &)> _AddApplicationMessage_pre_ptr;
    NullPtr<void (DXGIInfoQueueHook::*)(HRESULT, _In_  DXGI_INFO_QUEUE_MESSAGE_SEVERITY, _In_  LPCSTR)> _AddApplicationMessage_post_ptr;

    // -----------------------------------------------------------------------------
    virtual HRESULT STDMETHODCALLTYPE SetBreakOnCategory(_In_  DXGI_DEBUG_ID Producer, _In_  DXGI_INFO_QUEUE_MESSAGE_CATEGORY Category, _In_  BOOL bEnable);
    NullPtr<void (DXGIInfoQueueHook::*)(_In_  DXGI_DEBUG_ID &, _In_  DXGI_INFO_QUEUE_MESSAGE_CATEGORY &, _In_  BOOL &)> _SetBreakOnCategory_pre_ptr;
    NullPtr<void (DXGIInfoQueueHook::*)(HRESULT, _In_  DXGI_DEBUG_ID, _In_  DXGI_INFO_QUEUE_MESSAGE_CATEGORY, _In_  BOOL)> _SetBreakOnCategory_post_ptr;

    // -----------------------------------------------------------------------------
    virtual HRESULT STDMETHODCALLTYPE SetBreakOnSeverity(_In_  DXGI_DEBUG_ID Producer, _In_  DXGI_INFO_QUEUE_MESSAGE_SEVERITY Severity, _In_  BOOL bEnable);
    NullPtr<void (DXGIInfoQueueHook::*)(_In_  DXGI_DEBUG_ID &, _In_  DXGI_INFO_QUEUE_MESSAGE_SEVERITY &, _In_  BOOL &)> _SetBreakOnSeverity_pre_ptr;
    NullPtr<void (DXGIInfoQueueHook::*)(HRESULT, _In_  DXGI_DEBUG_ID, _In_  DXGI_INFO_QUEUE_MESSAGE_SEVERITY, _In_  BOOL)> _SetBreakOnSeverity_post_ptr;

    // -----------------------------------------------------------------------------
    virtual HRESULT STDMETHODCALLTYPE SetBreakOnID(_In_  DXGI_DEBUG_ID Producer, _In_  DXGI_INFO_QUEUE_MESSAGE_ID ID, _In_  BOOL bEnable);
    NullPtr<void (DXGIInfoQueueHook::*)(_In_  DXGI_DEBUG_ID &, _In_  DXGI_INFO_QUEUE_MESSAGE_ID &, _In_  BOOL &)> _SetBreakOnID_pre_ptr;
    NullPtr<void (DXGIInfoQueueHook::*)(HRESULT, _In_  DXGI_DEBUG_ID, _In_  DXGI_INFO_QUEUE_MESSAGE_ID, _In_  BOOL)> _SetBreakOnID_post_ptr;

    // -----------------------------------------------------------------------------
    virtual BOOL STDMETHODCALLTYPE GetBreakOnCategory(_In_  DXGI_DEBUG_ID Producer, _In_  DXGI_INFO_QUEUE_MESSAGE_CATEGORY Category);
    NullPtr<void (DXGIInfoQueueHook::*)(_In_  DXGI_DEBUG_ID &, _In_  DXGI_INFO_QUEUE_MESSAGE_CATEGORY &)> _GetBreakOnCategory_pre_ptr;
    NullPtr<void (DXGIInfoQueueHook::*)(BOOL, _In_  DXGI_DEBUG_ID, _In_  DXGI_INFO_QUEUE_MESSAGE_CATEGORY)> _GetBreakOnCategory_post_ptr;

    // -----------------------------------------------------------------------------
    virtual BOOL STDMETHODCALLTYPE GetBreakOnSeverity(_In_  DXGI_DEBUG_ID Producer, _In_  DXGI_INFO_QUEUE_MESSAGE_SEVERITY Severity);
    NullPtr<void (DXGIInfoQueueHook::*)(_In_  DXGI_DEBUG_ID &, _In_  DXGI_INFO_QUEUE_MESSAGE_SEVERITY &)> _GetBreakOnSeverity_pre_ptr;
    NullPtr<void (DXGIInfoQueueHook::*)(BOOL, _In_  DXGI_DEBUG_ID, _In_  DXGI_INFO_QUEUE_MESSAGE_SEVERITY)> _GetBreakOnSeverity_post_ptr;

    // -----------------------------------------------------------------------------
    virtual BOOL STDMETHODCALLTYPE GetBreakOnID(_In_  DXGI_DEBUG_ID Producer, _In_  DXGI_INFO_QUEUE_MESSAGE_ID ID);
    NullPtr<void (DXGIInfoQueueHook::*)(_In_  DXGI_DEBUG_ID &, _In_  DXGI_INFO_QUEUE_MESSAGE_ID &)> _GetBreakOnID_pre_ptr;
    NullPtr<void (DXGIInfoQueueHook::*)(BOOL, _In_  DXGI_DEBUG_ID, _In_  DXGI_INFO_QUEUE_MESSAGE_ID)> _GetBreakOnID_post_ptr;

    // -----------------------------------------------------------------------------
    virtual void STDMETHODCALLTYPE SetMuteDebugOutput(_In_  DXGI_DEBUG_ID Producer, _In_  BOOL bMute);
    NullPtr<void (DXGIInfoQueueHook::*)(_In_  DXGI_DEBUG_ID &, _In_  BOOL &)> _SetMuteDebugOutput_pre_ptr;
    NullPtr<void (DXGIInfoQueueHook::*)(_In_  DXGI_DEBUG_ID, _In_  BOOL)> _SetMuteDebugOutput_post_ptr;

    // -----------------------------------------------------------------------------
    virtual BOOL STDMETHODCALLTYPE GetMuteDebugOutput(_In_  DXGI_DEBUG_ID Producer);
    NullPtr<void (DXGIInfoQueueHook::*)(_In_  DXGI_DEBUG_ID &)> _GetMuteDebugOutput_pre_ptr;
    NullPtr<void (DXGIInfoQueueHook::*)(BOOL, _In_  DXGI_DEBUG_ID)> _GetMuteDebugOutput_post_ptr;
...
// IDXGIDebug
// ==============================================================================
class DXGIDebugHook : public HookBase<IDXGIDebug>
{

protected:

    DXGIDebugHook(UnknownBase & unknown,     IUnknown * realobj)
        : BASE_CLASS(unknown, realobj)
    {
    }
...
public:
    ...
    static IUnknown * sNewInstance(void * context, UnknownBase & unknown, IUnknown * realobj)
    {
        ...
        try
        {
            return new DXGIDebugHook(unknown, realobj);
        }
        catch(std::bad_alloc&)
        {
            HOOK_ERROR_LOG("Out of memory.");
    ...
    {
        UNREFERENCED_PARAMETER(context);
        DXGIDebugHook * typedPtr = (DXGIDebugHook *)ptr;
        delete typedPtr;
    }

    // -----------------------------------------------------------------------------
    virtual HRESULT STDMETHODCALLTYPE ReportLiveObjects(GUID apiid, DXGI_DEBUG_RLO_FLAGS flags);
    NullPtr<void (DXGIDebugHook::*)(GUID &, DXGI_DEBUG_RLO_FLAGS &)> _ReportLiveObjects_pre_ptr;
    NullPtr<void (DXGIDebugHook::*)(HRESULT, GUID, DXGI_DEBUG_RLO_FLAGS)> _ReportLiveObjects_post_ptr;
