...
static GN::Logger * sLogger = GN::getLogger("GN.gfx.d3d10.d3d10app");
...
//
// -----------------------------------------------------------------------------
GN::gfx::d3d10::D3D10Application::D3D10Application()
    : mWindow(0)
    , mAdapter(0)
    , mDevice(0)
    , mSwapChain(0)
...
//
// -----------------------------------------------------------------------------
int GN::gfx::d3d10::D3D10Application::run( const D3D10AppOption * )
{
    GN_GUARD_ALWAYS;
...
//
// -----------------------------------------------------------------------------
bool GN::gfx::d3d10::D3D10Application::changeOption( const D3D10AppOption & o )
{
    destroyDevice();
    mOption = o;
    return createDevice();
...
//
// -----------------------------------------------------------------------------
bool GN::gfx::d3d10::D3D10Application::init()
{
    // get primary monitor
...
//
// -----------------------------------------------------------------------------
void GN::gfx::d3d10::D3D10Application::quit()
{
    onQuit();
...
//
// -----------------------------------------------------------------------------
bool GN::gfx::d3d10::D3D10Application::createDevice()
{
...
//
// -----------------------------------------------------------------------------
void GN::gfx::d3d10::D3D10Application::destroyDevice()
{
    if( mDevice )
    {
        mDevice->ClearState();
