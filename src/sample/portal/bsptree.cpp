...
//
// ----------------------------------------------------------------------------
bool bsptree_c::check_segment(cldinfo_s * cinfo, const Vector3f & start, const Vector3f & end, uint root_index) const {
    GN_GUARD_SLOW;
...
//
// ----------------------------------------------------------------------------
bool bsptree_c::check_radial(cldinfo_s * /*cinfo*/, const Vector3f & /*start*/, const Vector3f & /*dir*/, uint root_index) const {
    GN_GUARD_SLOW;
