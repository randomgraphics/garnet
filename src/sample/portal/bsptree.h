...
public:
    ...
    bool check_segment(cldinfo_s * cldinfo, const Vector3f & v1, const Vector3f & v2, uint root_index = 0) const;

    // 检查射线start-direction是否与bsp树相交
    bool check_radial(cldinfo_s * cldinfo, const Vector3f & start, const Vector3f & direction, uint root_index = 0) const;
