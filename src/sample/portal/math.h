...
//           ....终点...........................相交。
//
bool intersection_plane_segment(Vector3f & ipoint, const Plane3f & plane, const Vector3f & start, const Vector3f & end);
...
//
bool intersection_plane_ray(Vector3f & ipoint, const Plane3f & plane, const Vector3f & start, const Vector3f & direction);

// 除了返回交点以外，还返回交点所对应的ratio值，
// ratio越大，说明交点离start越远。
bool intersection_plane_ray(Vector3f & ipoint, float & ratio, const Plane3f & plane, const Vector3f & start, const Vector3f & direction);
...
// NOTE : 1. 如果返回值是，则ipoint中的值是不确定的；
//
bool intersection_plane_line(Vector3f & ipoint, const Plane3f & plane, const Vector3f & point, const Vector3f & direction);
...
// ==============================
//
void clip_polygon_with_plane_list(std::vector<Vector3f> & result, const Vector3f * verts, size_t numvert, const Plane3f * planes, size_t numplane);
