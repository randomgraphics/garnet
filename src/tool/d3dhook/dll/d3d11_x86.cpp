...
extern "C" __declspec(naked) void __stdcall D3D11CoreCreateDevice_wrapper() {
    __asm {jmp mProcs[0*4] }
}
extern "C" __declspec(naked) void __stdcall D3D11CoreCreateLayeredDevice_wrapper() {
    __asm {jmp mProcs[1*4] }
}
extern "C" __declspec(naked) void __stdcall D3D11CoreGetLayeredDeviceSize_wrapper() {
    __asm {jmp mProcs[2*4] }
}
extern "C" __declspec(naked) void __stdcall D3D11CoreRegisterLayers_wrapper() {
...
extern "C" __declspec(naked) void __stdcall D3DPerformance_BeginEvent_wrapper() {
    __asm {jmp mProcs[40*4] }
}
extern "C" __declspec(naked) void __stdcall D3DPerformance_EndEvent_wrapper() {
    __asm {jmp mProcs[41*4] }
}
extern "C" __declspec(naked) void __stdcall D3DPerformance_GetStatus_wrapper() {
    __asm {jmp mProcs[42*4] }
}
extern "C" __declspec(naked) void __stdcall D3DPerformance_SetMarker_wrapper() {
    __asm {jmp mProcs[43*4] }
}
extern "C" __declspec(naked) void __stdcall EnableFeatureLevelUpgrade_wrapper() {
