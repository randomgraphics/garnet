...
//
// -----------------------------------------------------------------------------
bool GN::IniFile::loadFromFile(const wchar_t * filename) { return false; }
...
//
// -----------------------------------------------------------------------------
bool GN::IniFile::readi(const char * section, const char * key, int & value) { return false; }

//
//
// -----------------------------------------------------------------------------
bool GN::IniFile::readf(const char * section, const char * key, float & value) { return false; }

//
//
// -----------------------------------------------------------------------------
bool GN::IniFile::readb(const char * section, const char * key, bool & value) { return false; }
