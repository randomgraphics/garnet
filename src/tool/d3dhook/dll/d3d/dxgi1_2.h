...
public:
    ...
    virtual void STDMETHODCALLTYPE SetStereoEnabled(BOOL enabled) = 0;
};
...
interface IDXGIOutputDuplication {
    CONST_VTBL struct IDXGIOutputDuplicationVtbl * lpVtbl;
                    ...
                    #define IDXGIOutputDuplication_GetFramePointerShape(This, PointerShapeBufferSize, pPointerShapeBuffer, pPointerShapeBufferSizeRequired, \
                                                                        pPointerShapeInfo)                                                                  \
                        ((This)->lpVtbl->GetFramePointerShape(This, PointerShapeBufferSize, pPointerShapeBuffer, pPointerShapeBufferSizeRequired,           \
                                                              pPointerShapeInfo))
...
public:
    virtual HRESULT STDMETHODCALLTYPE CreateSubresourceSurface(UINT index,
                                                               /* [annotation][out] */
...
typedef enum DXGI_SCALING { DXGI_SCALING_STRETCH = 0, DXGI_SCALING_NONE = 1 } DXGI_SCALING;
