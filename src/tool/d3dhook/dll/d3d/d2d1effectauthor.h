...
//
//------------------------------------------------------------------------------
typedef HRESULT(CALLBACK * PD2D1_PROPERTY_GET_FUNCTION)(_In_ const IUnknown * effect, _Out_writes_opt_(dataSize) BYTE * data, UINT32 dataSize,
...
interface DX_DECLARE_INTERFACE("688d15c3-02b0-438d-b13a-d1b44c32c39a") ID2D1ResourceTexture : public IUnknown {
    ...
    //
    STDMETHOD(Update)
    (_In_reads_opt_(dimensions) CONST UINT32 * minimumExtents, _In_reads_opt_(dimensions) CONST UINT32 * maximimumExtents,
...
interface DX_DECLARE_INTERFACE("693ce632-7f2f-45de-93fe-18d88b37aa21") ID2D1DrawInfo : public ID2D1RenderInfo {
    ...
    //
    STDMETHOD(SetPixelShaderConstantBuffer)(_In_reads_(bufferCount) CONST BYTE * buffer, UINT32 bufferCount) PURE;

    //
    // Sets the resource texture corresponding to the given shader texture index.
    //
    STDMETHOD(SetResourceTexture)(UINT32 textureIndex, _In_ ID2D1ResourceTexture * resourceTexture) PURE;

    //
    // Set the constant buffer for this transform's vertex shader.
    //
    STDMETHOD(SetVertexShaderConstantBuffer)(_In_reads_(bufferCount) CONST BYTE * buffer, UINT32 bufferCount) PURE;

    //
    // Set the shader instructions for this transform.
    //
    STDMETHOD(SetPixelShader)(_In_ REFGUID shaderId, D2D1_PIXEL_OPTIONS pixelOptions = D2D1_PIXEL_OPTIONS_NONE) PURE;
    ...
    (_In_opt_ ID2D1VertexBuffer * vertexBuffer, D2D1_VERTEX_OPTIONS vertexOptions, _In_opt_ CONST D2D1_BLEND_DESCRIPTION * blendDescription = NULL,
     _In_opt_ CONST D2D1_VERTEX_RANGE * vertexRange = NULL, _In_opt_ CONST GUID * vertexShader = NULL) PURE;
...
interface DX_DECLARE_INTERFACE("5598b14b-9fd7-48b7-9bdb-8f0964eb38bc") ID2D1ComputeInfo : public ID2D1RenderInfo {
    ...
    //
    STDMETHOD(SetComputeShaderConstantBuffer)(_In_reads_(bufferCount) CONST BYTE * buffer, UINT32 bufferCount) PURE;

    //
    // Set the shader instructions for this transform.
    //
    STDMETHOD(SetComputeShader)(_In_ REFGUID shaderId) PURE;
...
interface DX_DECLARE_INTERFACE("13d29038-c3e6-4034-9081-13b53a417992") ID2D1TransformGraph : public IUnknown {
    ...
    // inputs.
    //
    STDMETHOD(SetSingleTransformNode)(_In_ ID2D1TransformNode * node) PURE;

    //
    // Adds the given transform node to the graph.
    //
    STDMETHOD(AddNode)(_In_ ID2D1TransformNode * node) PURE;

    //
    // Removes the given transform node from the graph.
    //
    STDMETHOD(RemoveNode)(_In_ ID2D1TransformNode * node) PURE;

    //
    // Indicates that the given transform node should be considered to be the output
    // node of the graph.
    //
    STDMETHOD(SetOutputNode)(_In_ ID2D1TransformNode * node) PURE;

    //
    // Connects one node to another node inside the graph.
    //
    STDMETHOD(ConnectNode)(_In_ ID2D1TransformNode * fromNode, _In_ ID2D1TransformNode * toNode, UINT32 toNodeInputIndex) PURE;

    //
    // Connects a transform node inside the graph to the corresponding input of the
    // encapsulating effect.
    //
    STDMETHOD(ConnectToEffectInput)(UINT32 toEffectInputIndex, _In_ ID2D1TransformNode * node, UINT32 toNodeInputIndex) PURE;
...
interface DX_DECLARE_INTERFACE("ef1a287d-342a-4f76-8fdb-da0d6ea9f92b") ID2D1Transform : public ID2D1TransformNode {
    ...
    (_In_ CONST D2D1_RECT_L * outputRect, _Out_writes_(inputRectsCount) D2D1_RECT_L * inputRects, UINT32 inputRectsCount) CONST PURE;

    STDMETHOD(MapInputRectsToOutputRect)
    (_In_reads_(inputRectCount) CONST D2D1_RECT_L * inputRects, _In_reads_(inputRectCount) CONST D2D1_RECT_L * inputOpaqueSubRects, UINT32 inputRectCount,
     _Out_ D2D1_RECT_L * outputRect, _Out_ D2D1_RECT_L * outputOpaqueSubRect) PURE;

    STDMETHOD(MapInvalidRect)(UINT32 inputIndex, D2D1_RECT_L invalidInputRect, _Out_ D2D1_RECT_L * invalidOutputRect) CONST PURE;
...
interface DX_DECLARE_INTERFACE("36bfdcb6-9739-435d-a30d-a653beff6a6f") ID2D1DrawTransform : public ID2D1Transform {
    ...
    STDMETHOD(SetDrawInfo)(_In_ ID2D1DrawInfo * drawInfo) PURE;
...
interface DX_DECLARE_INTERFACE("0d85573c-01e3-4f7d-bfd9-0d60608bf3c3") ID2D1ComputeTransform : public ID2D1Transform {
    ...
    STDMETHOD(SetComputeInfo)(_In_ ID2D1ComputeInfo * computeInfo) PURE;

    STDMETHOD(CalculateThreadgroups)(_In_ CONST D2D1_RECT_L * outputRect, _Out_ UINT32 * dimensionX, _Out_ UINT32 * dimensionY, _Out_ UINT32 * dimensionZ) PURE;
...
interface DX_DECLARE_INTERFACE("0359dc30-95e6-4568-9055-27720d130e93") ID2D1AnalysisTransform : public IUnknown {
    ...
    STDMETHOD(ProcessAnalysisResults)(_In_reads_(analysisDataCount) CONST BYTE * analysisData, UINT32 analysisDataCount) PURE;
...
interface DX_DECLARE_INTERFACE("db1800dd-0c34-4cf9-be90-31cc0a5653e1") ID2D1SourceTransform : public ID2D1Transform {
    ...
    STDMETHOD(SetRenderInfo)(_In_ ID2D1RenderInfo * renderInfo) PURE;

    STDMETHOD(Draw)(_In_ ID2D1Bitmap1 * target, _In_ CONST D2D1_RECT_L * drawRect, D2D1_POINT_2U targetOrigin) PURE;
...
interface DX_DECLARE_INTERFACE("63ac0b32-ba44-450f-8806-7f4ca1ff2f1b") ID2D1BlendTransform : public ID2D1ConcreteTransform {
    ...
    STDMETHOD_(void, SetDescription)(_In_ CONST D2D1_BLEND_DESCRIPTION * description) PURE;

    STDMETHOD_(void, GetDescription)(_Out_ D2D1_BLEND_DESCRIPTION * description) CONST PURE;
...
interface DX_DECLARE_INTERFACE("90f732e2-5092-4606-a819-8651970baccd") ID2D1BoundsAdjustmentTransform : public ID2D1TransformNode {
    ...
    STDMETHOD_(void, SetOutputBounds)(_In_ CONST D2D1_RECT_L * outputBounds) PURE;

    STDMETHOD_(void, GetOutputBounds)(_Out_ D2D1_RECT_L * outputBounds) CONST PURE;
...
interface DX_DECLARE_INTERFACE("a248fd3f-3e6c-4e63-9f03-7f68ecc91db9") ID2D1EffectImpl : public IUnknown {
    ...
    //
    STDMETHOD(Initialize)(_In_ ID2D1EffectContext * effectContext, _In_ ID2D1TransformGraph * transformGraph) PURE;
    ...
    //
    STDMETHOD(SetGraph)(_In_ ID2D1TransformGraph * transformGraph) PURE;
...
interface DX_DECLARE_INTERFACE("3d9f916b-27dc-4ad7-b4f1-64945340f563") ID2D1EffectContext : public IUnknown {
    ...
    STDMETHOD(LoadVertexShader)(REFGUID resourceId, _In_reads_(shaderBufferCount) CONST BYTE * shaderBuffer, UINT32 shaderBufferCount) PURE;

    STDMETHOD(LoadComputeShader)(REFGUID resourceId, _In_reads_(shaderBufferCount) CONST BYTE * shaderBuffer, UINT32 shaderBufferCount) PURE;
...
typedef struct ID2D1VertexBufferVtbl {
    ...
    STDMETHOD(Map)(ID2D1VertexBuffer * This, _Outptr_result_bytebuffer_(bufferSize) BYTE ** data, UINT32 bufferSize) PURE;
...
interface ID2D1VertexBuffer {
    CONST struct ID2D1VertexBufferVtbl * lpVtbl;
        ...
        #define ID2D1VertexBuffer_AddRef(This) ((This)->lpVtbl->Base.AddRef((IUnknown *) This))

        #define ID2D1VertexBuffer_Release(This) ((This)->lpVtbl->Base.Release((IUnknown *) This))

        #define ID2D1VertexBuffer_Map(This, data, bufferSize) ((This)->lpVtbl->Map(This, data, bufferSize))
...
typedef struct ID2D1ResourceTextureVtbl {
    ...
    STDMETHOD(Update)
    (ID2D1ResourceTexture * This, _In_reads_opt_(dimensions) CONST UINT32 * minimumExtents, _In_reads_opt_(dimensions) CONST UINT32 * maximimumExtents,
     _In_reads_opt_(dimensions - 1) CONST UINT32 * strides, UINT32 dimensions, _In_reads_(dataCount) CONST BYTE * data, UINT32 dataCount) PURE;
...
interface ID2D1ResourceTexture {
    CONST struct ID2D1ResourceTextureVtbl * lpVtbl;
        ...
        #define ID2D1ResourceTexture_AddRef(This) ((This)->lpVtbl->Base.AddRef((IUnknown *) This))

        #define ID2D1ResourceTexture_Release(This) ((This)->lpVtbl->Base.Release((IUnknown *) This))
...
typedef struct ID2D1RenderInfoVtbl {
    ...
    STDMETHOD(SetInputDescription)(ID2D1RenderInfo * This, UINT32 inputIndex, D2D1_INPUT_DESCRIPTION inputDescription) PURE;

    STDMETHOD(SetOutputBuffer)(ID2D1RenderInfo * This, D2D1_BUFFER_PRECISION bufferPrecision, D2D1_CHANNEL_DEPTH channelDepth) PURE;

    STDMETHOD_(void, SetCached)(ID2D1RenderInfo * This, BOOL isCached) PURE;
...
interface ID2D1RenderInfo {
    CONST struct ID2D1RenderInfoVtbl * lpVtbl;
        ...
        #define ID2D1RenderInfo_AddRef(This) ((This)->lpVtbl->Base.AddRef((IUnknown *) This))

        #define ID2D1RenderInfo_Release(This) ((This)->lpVtbl->Base.Release((IUnknown *) This))
        ...
        #define ID2D1RenderInfo_SetOutputBuffer(This, bufferPrecision, channelDepth) ((This)->lpVtbl->SetOutputBuffer(This, bufferPrecision, channelDepth))

        #define ID2D1RenderInfo_SetCached(This, isCached) ((This)->lpVtbl->SetCached(This, isCached))

        #define ID2D1RenderInfo_SetInstructionCountHint(This, instructionCount) ((This)->lpVtbl->SetInstructionCountHint(This, instructionCount))
...
typedef struct ID2D1DrawInfoVtbl {
    ...
    STDMETHOD(SetPixelShaderConstantBuffer)(ID2D1DrawInfo * This, _In_reads_(bufferCount) CONST BYTE * buffer, UINT32 bufferCount) PURE;

    STDMETHOD(SetResourceTexture)(ID2D1DrawInfo * This, UINT32 textureIndex, _In_ ID2D1ResourceTexture * resourceTexture) PURE;

    STDMETHOD(SetVertexShaderConstantBuffer)(ID2D1DrawInfo * This, _In_reads_(bufferCount) CONST BYTE * buffer, UINT32 bufferCount) PURE;

    STDMETHOD(SetPixelShader)(ID2D1DrawInfo * This, _In_ REFGUID shaderId, D2D1_PIXEL_OPTIONS pixelOptions) PURE;

    STDMETHOD(SetVertexProcessing)
    (ID2D1DrawInfo * This, _In_opt_ ID2D1VertexBuffer * vertexBuffer, D2D1_VERTEX_OPTIONS vertexOptions,
...
interface ID2D1DrawInfo {
    CONST struct ID2D1DrawInfoVtbl * lpVtbl;
        ...
        #define ID2D1DrawInfo_AddRef(This) ((This)->lpVtbl->Base.Base.AddRef((IUnknown *) This))

        #define ID2D1DrawInfo_Release(This) ((This)->lpVtbl->Base.Base.Release((IUnknown *) This))
        ...
        #define ID2D1DrawInfo_SetCached(This, isCached) ((This)->lpVtbl->Base.SetCached((ID2D1RenderInfo *) This, isCached))
        ...
        #define ID2D1DrawInfo_SetPixelShaderConstantBuffer(This, buffer, bufferCount) ((This)->lpVtbl->SetPixelShaderConstantBuffer(This, buffer, bufferCount))

        #define ID2D1DrawInfo_SetResourceTexture(This, textureIndex, resourceTexture) ((This)->lpVtbl->SetResourceTexture(This, textureIndex, resourceTexture))
        ...
        #define ID2D1DrawInfo_SetPixelShader(This, shaderId, pixelOptions) ((This)->lpVtbl->SetPixelShader(This, shaderId, pixelOptions))
...
typedef struct ID2D1ComputeInfoVtbl {
    ...
    STDMETHOD(SetComputeShaderConstantBuffer)(ID2D1ComputeInfo * This, _In_reads_(bufferCount) CONST BYTE * buffer, UINT32 bufferCount) PURE;

    STDMETHOD(SetComputeShader)(ID2D1ComputeInfo * This, _In_ REFGUID shaderId) PURE;
...
interface ID2D1ComputeInfo {
    CONST struct ID2D1ComputeInfoVtbl * lpVtbl;
        ...
        #define ID2D1ComputeInfo_AddRef(This) ((This)->lpVtbl->Base.Base.AddRef((IUnknown *) This))

        #define ID2D1ComputeInfo_Release(This) ((This)->lpVtbl->Base.Base.Release((IUnknown *) This))
        ...
        #define ID2D1ComputeInfo_SetCached(This, isCached) ((This)->lpVtbl->Base.SetCached((ID2D1RenderInfo *) This, isCached))
        ...
        #define ID2D1ComputeInfo_SetComputeShader(This, shaderId) ((This)->lpVtbl->SetComputeShader(This, shaderId))
...
interface ID2D1TransformNode {
    CONST struct ID2D1TransformNodeVtbl * lpVtbl;
        ...
        #define ID2D1TransformNode_AddRef(This) ((This)->lpVtbl->Base.AddRef((IUnknown *) This))

        #define ID2D1TransformNode_Release(This) ((This)->lpVtbl->Base.Release((IUnknown *) This))
...
typedef struct ID2D1TransformGraphVtbl {
    ...
    STDMETHOD_(UINT32, GetInputCount)(ID2D1TransformGraph * This) PURE;

    STDMETHOD(SetSingleTransformNode)(ID2D1TransformGraph * This, _In_ ID2D1TransformNode * node) PURE;

    STDMETHOD(AddNode)(ID2D1TransformGraph * This, _In_ ID2D1TransformNode * node) PURE;

    STDMETHOD(RemoveNode)(ID2D1TransformGraph * This, _In_ ID2D1TransformNode * node) PURE;

    STDMETHOD(SetOutputNode)(ID2D1TransformGraph * This, _In_ ID2D1TransformNode * node) PURE;

    STDMETHOD(ConnectNode)(ID2D1TransformGraph * This, _In_ ID2D1TransformNode * fromNode, _In_ ID2D1TransformNode * toNode, UINT32 toNodeInputIndex) PURE;

    STDMETHOD(ConnectToEffectInput)(ID2D1TransformGraph * This, UINT32 toEffectInputIndex, _In_ ID2D1TransformNode * node, UINT32 toNodeInputIndex) PURE;

    STDMETHOD_(void, Clear)(ID2D1TransformGraph * This) PURE;
...
interface ID2D1TransformGraph {
    CONST struct ID2D1TransformGraphVtbl * lpVtbl;
        ...
        #define ID2D1TransformGraph_AddRef(This) ((This)->lpVtbl->Base.AddRef((IUnknown *) This))

        #define ID2D1TransformGraph_Release(This) ((This)->lpVtbl->Base.Release((IUnknown *) This))
        ...
        #define ID2D1TransformGraph_SetPassthroughGraph(This, effectInputIndex) ((This)->lpVtbl->SetPassthroughGraph(This, effectInputIndex))
...
typedef struct ID2D1TransformVtbl {
    ...
    STDMETHOD(MapOutputRectToInputRects)
    (ID2D1Transform * This, _In_ CONST D2D1_RECT_L * outputRect, _Out_writes_(inputRectsCount) D2D1_RECT_L * inputRects, UINT32 inputRectsCount) PURE;

    STDMETHOD(MapInputRectsToOutputRect)
    (ID2D1Transform * This, _In_reads_(inputRectCount) CONST D2D1_RECT_L * inputRects, _In_reads_(inputRectCount) CONST D2D1_RECT_L * inputOpaqueSubRects,
     UINT32 inputRectCount, _Out_ D2D1_RECT_L * outputRect, _Out_ D2D1_RECT_L * outputOpaqueSubRect) PURE;
...
interface ID2D1Transform {
    CONST struct ID2D1TransformVtbl * lpVtbl;
        ...
        #define ID2D1Transform_AddRef(This) ((This)->lpVtbl->Base.Base.AddRef((IUnknown *) This))

        #define ID2D1Transform_Release(This) ((This)->lpVtbl->Base.Base.Release((IUnknown *) This))

        #define ID2D1Transform_GetInputCount(This) ((This)->lpVtbl->Base.GetInputCount((ID2D1TransformNode *) This))
...
interface ID2D1DrawTransform {
    CONST struct ID2D1DrawTransformVtbl * lpVtbl;
        ...
        #define ID2D1DrawTransform_AddRef(This) ((This)->lpVtbl->Base.Base.Base.AddRef((IUnknown *) This))

        #define ID2D1DrawTransform_Release(This) ((This)->lpVtbl->Base.Base.Base.Release((IUnknown *) This))

        #define ID2D1DrawTransform_GetInputCount(This) ((This)->lpVtbl->Base.Base.GetInputCount((ID2D1TransformNode *) This))
        ...
        #define ID2D1DrawTransform_MapInputRectsToOutputRect(This, inputRects, inputOpaqueSubRects, inputRectCount, outputRect, outputOpaqueSubRect) \
            ((This)->lpVtbl->Base.MapInputRectsToOutputRect((ID2D1Transform *) This, inputRects, inputOpaqueSubRects, inputRectCount, outputRect,    \
                                                            outputOpaqueSubRect))
        ...
        #define ID2D1DrawTransform_SetDrawInfo(This, drawInfo) ((This)->lpVtbl->SetDrawInfo(This, drawInfo))
...
typedef struct ID2D1ComputeTransformVtbl {
    ...
    STDMETHOD(SetComputeInfo)(ID2D1ComputeTransform * This, _In_ ID2D1ComputeInfo * computeInfo) PURE;
...
interface ID2D1ComputeTransform {
    CONST struct ID2D1ComputeTransformVtbl * lpVtbl;
        ...
        #define ID2D1ComputeTransform_AddRef(This) ((This)->lpVtbl->Base.Base.Base.AddRef((IUnknown *) This))

        #define ID2D1ComputeTransform_Release(This) ((This)->lpVtbl->Base.Base.Base.Release((IUnknown *) This))

        #define ID2D1ComputeTransform_GetInputCount(This) ((This)->lpVtbl->Base.Base.GetInputCount((ID2D1TransformNode *) This))
        ...
        #define ID2D1ComputeTransform_SetComputeInfo(This, computeInfo) ((This)->lpVtbl->SetComputeInfo(This, computeInfo))
...
interface ID2D1AnalysisTransform {
    CONST struct ID2D1AnalysisTransformVtbl * lpVtbl;
        ...
        #define ID2D1AnalysisTransform_AddRef(This) ((This)->lpVtbl->Base.AddRef((IUnknown *) This))

        #define ID2D1AnalysisTransform_Release(This) ((This)->lpVtbl->Base.Release((IUnknown *) This))
...
typedef struct ID2D1SourceTransformVtbl {
    ...
    STDMETHOD(SetRenderInfo)(ID2D1SourceTransform * This, _In_ ID2D1RenderInfo * renderInfo) PURE;
...
interface ID2D1SourceTransform {
    CONST struct ID2D1SourceTransformVtbl * lpVtbl;
        ...
        #define ID2D1SourceTransform_AddRef(This) ((This)->lpVtbl->Base.Base.Base.AddRef((IUnknown *) This))

        #define ID2D1SourceTransform_Release(This) ((This)->lpVtbl->Base.Base.Base.Release((IUnknown *) This))

        #define ID2D1SourceTransform_GetInputCount(This) ((This)->lpVtbl->Base.Base.GetInputCount((ID2D1TransformNode *) This))
        ...
        #define ID2D1SourceTransform_SetRenderInfo(This, renderInfo) ((This)->lpVtbl->SetRenderInfo(This, renderInfo))

        #define ID2D1SourceTransform_Draw(This, target, drawRect, targetOrigin) ((This)->lpVtbl->Draw(This, target, drawRect, targetOrigin))
...
typedef struct ID2D1ConcreteTransformVtbl {
    ...
    STDMETHOD(SetOutputBuffer)(ID2D1ConcreteTransform * This, D2D1_BUFFER_PRECISION bufferPrecision, D2D1_CHANNEL_DEPTH channelDepth) PURE;
...
interface ID2D1ConcreteTransform {
    CONST struct ID2D1ConcreteTransformVtbl * lpVtbl;
        ...
        #define ID2D1ConcreteTransform_AddRef(This) ((This)->lpVtbl->Base.Base.AddRef((IUnknown *) This))

        #define ID2D1ConcreteTransform_Release(This) ((This)->lpVtbl->Base.Base.Release((IUnknown *) This))

        #define ID2D1ConcreteTransform_GetInputCount(This) ((This)->lpVtbl->Base.GetInputCount((ID2D1TransformNode *) This))
        ...
        #define ID2D1ConcreteTransform_SetCached(This, isCached) ((This)->lpVtbl->SetCached(This, isCached))
...
typedef struct ID2D1BlendTransformVtbl {
    ...
    STDMETHOD_(void, SetDescription)(ID2D1BlendTransform * This, _In_ CONST D2D1_BLEND_DESCRIPTION * description) PURE;
...
interface ID2D1BlendTransform {
    CONST struct ID2D1BlendTransformVtbl * lpVtbl;
        ...
        #define ID2D1BlendTransform_AddRef(This) ((This)->lpVtbl->Base.Base.Base.AddRef((IUnknown *) This))

        #define ID2D1BlendTransform_Release(This) ((This)->lpVtbl->Base.Base.Base.Release((IUnknown *) This))

        #define ID2D1BlendTransform_GetInputCount(This) ((This)->lpVtbl->Base.Base.GetInputCount((ID2D1TransformNode *) This))
        ...
        #define ID2D1BlendTransform_SetCached(This, isCached) ((This)->lpVtbl->Base.SetCached((ID2D1ConcreteTransform *) This, isCached))
...
typedef struct ID2D1BorderTransformVtbl {
    ...
    STDMETHOD_(void, SetExtendModeX)(ID2D1BorderTransform * This, D2D1_EXTEND_MODE extendMode) PURE;

    STDMETHOD_(void, SetExtendModeY)(ID2D1BorderTransform * This, D2D1_EXTEND_MODE extendMode) PURE;

    STDMETHOD_(D2D1_EXTEND_MODE, GetExtendModeX)(ID2D1BorderTransform * This) PURE;
...
interface ID2D1BorderTransform {
    CONST struct ID2D1BorderTransformVtbl * lpVtbl;
        ...
        #define ID2D1BorderTransform_AddRef(This) ((This)->lpVtbl->Base.Base.Base.AddRef((IUnknown *) This))

        #define ID2D1BorderTransform_Release(This) ((This)->lpVtbl->Base.Base.Base.Release((IUnknown *) This))

        #define ID2D1BorderTransform_GetInputCount(This) ((This)->lpVtbl->Base.Base.GetInputCount((ID2D1TransformNode *) This))

        #define ID2D1BorderTransform_SetOutputBuffer(This, bufferPrecision, channelDepth) \
            ((This)->lpVtbl->Base.SetOutputBuffer((ID2D1ConcreteTransform *) This, bufferPrecision, channelDepth))

        #define ID2D1BorderTransform_SetCached(This, isCached) ((This)->lpVtbl->Base.SetCached((ID2D1ConcreteTransform *) This, isCached))

        #define ID2D1BorderTransform_SetExtendModeX(This, extendMode) ((This)->lpVtbl->SetExtendModeX(This, extendMode))

        #define ID2D1BorderTransform_SetExtendModeY(This, extendMode) ((This)->lpVtbl->SetExtendModeY(This, extendMode))
...
typedef struct ID2D1OffsetTransformVtbl {
    ...
    STDMETHOD_(void, SetOffset)(ID2D1OffsetTransform * This, D2D1_POINT_2L offset) PURE;
...
interface ID2D1OffsetTransform {
    CONST struct ID2D1OffsetTransformVtbl * lpVtbl;
        ...
        #define ID2D1OffsetTransform_AddRef(This) ((This)->lpVtbl->Base.Base.AddRef((IUnknown *) This))

        #define ID2D1OffsetTransform_Release(This) ((This)->lpVtbl->Base.Base.Release((IUnknown *) This))

        #define ID2D1OffsetTransform_GetInputCount(This) ((This)->lpVtbl->Base.GetInputCount((ID2D1TransformNode *) This))

        #define ID2D1OffsetTransform_SetOffset(This, offset) ((This)->lpVtbl->SetOffset(This, offset))

        #define ID2D1OffsetTransform_GetOffset(This) ((This)->lpVtbl->GetOffset(This))
...
typedef struct ID2D1BoundsAdjustmentTransformVtbl {
    ...
    STDMETHOD_(void, SetOutputBounds)(ID2D1BoundsAdjustmentTransform * This, _In_ CONST D2D1_RECT_L * outputBounds) PURE;
...
interface ID2D1BoundsAdjustmentTransform {
    CONST struct ID2D1BoundsAdjustmentTransformVtbl * lpVtbl;
        ...
        #define ID2D1BoundsAdjustmentTransform_AddRef(This) ((This)->lpVtbl->Base.Base.AddRef((IUnknown *) This))

        #define ID2D1BoundsAdjustmentTransform_Release(This) ((This)->lpVtbl->Base.Base.Release((IUnknown *) This))

        #define ID2D1BoundsAdjustmentTransform_GetInputCount(This) ((This)->lpVtbl->Base.GetInputCount((ID2D1TransformNode *) This))

        #define ID2D1BoundsAdjustmentTransform_SetOutputBounds(This, outputBounds) ((This)->lpVtbl->SetOutputBounds(This, outputBounds))

        #define ID2D1BoundsAdjustmentTransform_GetOutputBounds(This, outputBounds) ((This)->lpVtbl->GetOutputBounds(This, outputBounds))
...
typedef struct ID2D1EffectImplVtbl {
    ...
    STDMETHOD(Initialize)(ID2D1EffectImpl * This, _In_ ID2D1EffectContext * effectContext, _In_ ID2D1TransformGraph * transformGraph) PURE;

    STDMETHOD(PrepareForRender)(ID2D1EffectImpl * This, D2D1_CHANGE_TYPE changeType) PURE;
...
typedef struct ID2D1EffectContextVtbl {
    ...
    STDMETHOD_(void, GetDpi)(ID2D1EffectContext * This, _Out_ FLOAT * dpiX, _Out_ FLOAT * dpiY) PURE;

    STDMETHOD(CreateEffect)(ID2D1EffectContext * This, _In_ REFCLSID effectId, _Outptr_ ID2D1Effect ** effect) PURE;

    STDMETHOD(GetMaximumSupportedFeatureLevel)
    (ID2D1EffectContext * This, _In_reads_(featureLevelsCount) CONST D3D_FEATURE_LEVEL * featureLevels, UINT32 featureLevelsCount,
     _Out_ D3D_FEATURE_LEVEL * maximumSupportedFeatureLevel) PURE;

    STDMETHOD(CreateTransformNodeFromEffect)(ID2D1EffectContext * This, _In_ ID2D1Effect * effect, _Outptr_ ID2D1TransformNode ** transformNode) PURE;

    STDMETHOD(CreateBlendTransform)
    (ID2D1EffectContext * This, UINT32 numInputs, _In_ CONST D2D1_BLEND_DESCRIPTION * blendDescription, _Outptr_ ID2D1BlendTransform ** transform) PURE;

    STDMETHOD(CreateBorderTransform)
    (ID2D1EffectContext * This, D2D1_EXTEND_MODE extendModeX, D2D1_EXTEND_MODE extendModeY, _Outptr_ ID2D1BorderTransform ** transform) PURE;

    STDMETHOD(CreateOffsetTransform)(ID2D1EffectContext * This, D2D1_POINT_2L offset, _Outptr_ ID2D1OffsetTransform ** transform) PURE;

    STDMETHOD(CreateBoundsAdjustmentTransform)
    (ID2D1EffectContext * This, _In_ CONST D2D1_RECT_L * outputRectangle, _Outptr_ ID2D1BoundsAdjustmentTransform ** transform) PURE;

    STDMETHOD(LoadPixelShader)
    (ID2D1EffectContext * This, REFGUID shaderId, _In_reads_(shaderBufferCount) CONST BYTE * shaderBuffer, UINT32 shaderBufferCount) PURE;

    STDMETHOD(LoadVertexShader)
    (ID2D1EffectContext * This, REFGUID resourceId, _In_reads_(shaderBufferCount) CONST BYTE * shaderBuffer, UINT32 shaderBufferCount) PURE;

    STDMETHOD(LoadComputeShader)
    (ID2D1EffectContext * This, REFGUID resourceId, _In_reads_(shaderBufferCount) CONST BYTE * shaderBuffer, UINT32 shaderBufferCount) PURE;

    STDMETHOD_(BOOL, IsShaderLoaded)(ID2D1EffectContext * This, REFGUID shaderId) PURE;

    STDMETHOD(CreateResourceTexture)
    (ID2D1EffectContext * This, _In_opt_ CONST GUID * resourceId, _In_ CONST D2D1_RESOURCE_TEXTURE_PROPERTIES * resourceTextureProperties,
     _In_reads_opt_(dataSize) CONST BYTE * data, _In_reads_opt_(resourceTextureProperties->dimensions - 1) CONST UINT32 * strides, UINT32 dataSize,
     _Outptr_ ID2D1ResourceTexture ** resourceTexture) PURE;

    STDMETHOD(FindResourceTexture)(ID2D1EffectContext * This, _In_ CONST GUID * resourceId, _Outptr_ ID2D1ResourceTexture ** resourceTexture) PURE;

    STDMETHOD(CreateVertexBuffer)
    (ID2D1EffectContext * This, _In_ CONST D2D1_VERTEX_BUFFER_PROPERTIES * vertexBufferProperties, _In_opt_ CONST GUID * resourceId,
     _In_opt_ CONST D2D1_CUSTOM_VERTEX_BUFFER_PROPERTIES * customVertexBufferProperties, _Outptr_ ID2D1VertexBuffer ** buffer) PURE;

    STDMETHOD(FindVertexBuffer)(ID2D1EffectContext * This, _In_ CONST GUID * resourceId, _Outptr_ ID2D1VertexBuffer ** buffer) PURE;

    STDMETHOD(CreateColorContext)
    (ID2D1EffectContext * This, D2D1_COLOR_SPACE space, _In_reads_opt_(profileSize) CONST BYTE * profile, UINT32 profileSize,
     _Outptr_ ID2D1ColorContext ** colorContext) PURE;

    STDMETHOD(CreateColorContextFromFilename)(ID2D1EffectContext * This, _In_ PCWSTR filename, _Outptr_ ID2D1ColorContext ** colorContext) PURE;

    STDMETHOD(CreateColorContextFromWicColorContext)
    (ID2D1EffectContext * This, _In_ IWICColorContext * wicColorContext, _Outptr_ ID2D1ColorContext ** colorContext) PURE;

    STDMETHOD(CheckFeatureSupport)
    (ID2D1EffectContext * This, D2D1_FEATURE feature, _Out_writes_bytes_(featureSupportDataSize) void * featureSupportData, UINT32 featureSupportDataSize) PURE;
...
interface ID2D1EffectContext {
    CONST struct ID2D1EffectContextVtbl * lpVtbl;
        ...
        #define ID2D1EffectContext_AddRef(This) ((This)->lpVtbl->Base.AddRef((IUnknown *) This))

        #define ID2D1EffectContext_Release(This) ((This)->lpVtbl->Base.Release((IUnknown *) This))

        #define ID2D1EffectContext_GetDpi(This, dpiX, dpiY) ((This)->lpVtbl->GetDpi(This, dpiX, dpiY))

        #define ID2D1EffectContext_CreateEffect(This, effectId, effect) ((This)->lpVtbl->CreateEffect(This, effectId, effect))
        ...
        #define ID2D1EffectContext_IsShaderLoaded(This, shaderId) ((This)->lpVtbl->IsShaderLoaded(This, shaderId))
        ...
        #define ID2D1EffectContext_FindVertexBuffer(This, resourceId, buffer) ((This)->lpVtbl->FindVertexBuffer(This, resourceId, buffer))
        ...
        #define ID2D1EffectContext_IsBufferPrecisionSupported(This, bufferPrecision) ((This)->lpVtbl->IsBufferPrecisionSupported(This, bufferPrecision))
