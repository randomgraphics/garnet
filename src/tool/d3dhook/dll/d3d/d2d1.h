...
//
//------------------------------------------------------------------------------
interface DX_DECLARE_INTERFACE("65019f75-8da2-497c-b32c-dfa34e48ede6") ID2D1Image : public ID2D1Resource {}; // interface ID2D1Image
...
interface DX_DECLARE_INTERFACE("a2296057-ea42-4099-983b-539fb6505426") ID2D1Bitmap : public ID2D1Image {
    ...
    //
    STDMETHOD_(D2D1_SIZE_F, GetSize)() CONST PURE;
    ...
    //
    STDMETHOD_(D2D1_PIXEL_FORMAT, GetPixelFormat)() CONST PURE;

    //
    // Return the DPI of the bitmap.
    //
    STDMETHOD_(void, GetDpi)(_Out_ FLOAT * dpiX, _Out_ FLOAT * dpiY) CONST PURE;

    STDMETHOD(CopyFromBitmap)(_In_opt_ CONST D2D1_POINT_2U * destPoint, _In_ ID2D1Bitmap * bitmap, _In_opt_ CONST D2D1_RECT_U * srcRect) PURE;

    STDMETHOD(CopyFromRenderTarget)(_In_opt_ CONST D2D1_POINT_2U * destPoint, _In_ ID2D1RenderTarget * renderTarget, _In_opt_ CONST D2D1_RECT_U * srcRect) PURE;

    STDMETHOD(CopyFromMemory)(_In_opt_ CONST D2D1_RECT_U * dstRect, _In_ CONST void * srcData, UINT32 pitch) PURE;
...
interface DX_DECLARE_INTERFACE("2cd906a7-12e2-11dc-9fed-001143a055f9") ID2D1GradientStopCollection : public ID2D1Resource {
    ...
    //
    STDMETHOD_(UINT32, GetGradientStopCount)() CONST PURE;
    ...
    //
    STDMETHOD_(D2D1_GAMMA, GetColorInterpolationGamma)() CONST PURE;

    STDMETHOD_(D2D1_EXTEND_MODE, GetExtendMode)() CONST PURE;
...
interface DX_DECLARE_INTERFACE("2cd906a8-12e2-11dc-9fed-001143a055f9") ID2D1Brush : public ID2D1Resource {
    ...
    //
    STDMETHOD_(void, SetTransform)(_In_ CONST D2D1_MATRIX_3X2_F * transform) PURE;

    STDMETHOD_(FLOAT, GetOpacity)() CONST PURE;

    STDMETHOD_(void, GetTransform)(_Out_ D2D1_MATRIX_3X2_F * transform) CONST PURE;

    void SetTransform(CONST D2D1_MATRIX_3X2_F & transform) { SetTransform(&transform); }
}; // interface ID2D1Brush
...
interface DX_DECLARE_INTERFACE("2cd906aa-12e2-11dc-9fed-001143a055f9") ID2D1BitmapBrush : public ID2D1Brush {
    ...
    //
    STDMETHOD_(void, SetBitmap)(_In_opt_ ID2D1Bitmap * bitmap) PURE;
...
interface DX_DECLARE_INTERFACE("2cd906a9-12e2-11dc-9fed-001143a055f9") ID2D1SolidColorBrush : public ID2D1Brush {
    ...
    STDMETHOD_(void, SetColor)(_In_ CONST D2D1_COLOR_F * color) PURE;

    STDMETHOD_(D2D1_COLOR_F, GetColor)() CONST PURE;

    void SetColor(CONST D2D1_COLOR_F & color) { SetColor(&color); }
...
interface DX_DECLARE_INTERFACE("2cd906ab-12e2-11dc-9fed-001143a055f9") ID2D1LinearGradientBrush : public ID2D1Brush {
    ...
    STDMETHOD_(D2D1_POINT_2F, GetStartPoint)() CONST PURE;
...
interface DX_DECLARE_INTERFACE("2cd906ac-12e2-11dc-9fed-001143a055f9") ID2D1RadialGradientBrush : public ID2D1Brush {
    ...
    STDMETHOD_(D2D1_POINT_2F, GetCenter)() CONST PURE;

    STDMETHOD_(D2D1_POINT_2F, GetGradientOriginOffset)() CONST PURE;

    STDMETHOD_(FLOAT, GetRadiusX)() CONST PURE;
...
interface DX_DECLARE_INTERFACE("2cd9069d-12e2-11dc-9fed-001143a055f9") ID2D1StrokeStyle : public ID2D1Resource {
    ...
    STDMETHOD_(D2D1_CAP_STYLE, GetStartCap)() CONST PURE;

    STDMETHOD_(D2D1_CAP_STYLE, GetEndCap)() CONST PURE;

    STDMETHOD_(D2D1_CAP_STYLE, GetDashCap)() CONST PURE;

    STDMETHOD_(FLOAT, GetMiterLimit)() CONST PURE;

    STDMETHOD_(D2D1_LINE_JOIN, GetLineJoin)() CONST PURE;

    STDMETHOD_(FLOAT, GetDashOffset)() CONST PURE;

    STDMETHOD_(D2D1_DASH_STYLE, GetDashStyle)() CONST PURE;

    STDMETHOD_(UINT32, GetDashesCount)() CONST PURE;
    ...
    //
    STDMETHOD_(void, GetDashes)(_Out_writes_(dashesCount) FLOAT * dashes, UINT32 dashesCount) CONST PURE;
...
interface DX_DECLARE_INTERFACE("2cd906a1-12e2-11dc-9fed-001143a055f9") ID2D1Geometry : public ID2D1Resource {
    ...
    //
    STDMETHOD(GetBounds)(_In_opt_ CONST D2D1_MATRIX_3X2_F * worldTransform, _Out_ D2D1_RECT_F * bounds) CONST PURE;
    ...
    (FLOAT strokeWidth, _In_opt_ ID2D1StrokeStyle * strokeStyle, _In_opt_ CONST D2D1_MATRIX_3X2_F * worldTransform, FLOAT flatteningTolerance,
     _Out_ D2D1_RECT_F * bounds) CONST PURE;
    ...
    (D2D1_POINT_2F point, FLOAT strokeWidth, _In_opt_ ID2D1StrokeStyle * strokeStyle, _In_opt_ CONST D2D1_MATRIX_3X2_F * worldTransform,
     FLOAT flatteningTolerance, _Out_ BOOL * contains) CONST PURE;

    //
    // Test whether the given fill of this geometry would contain this point.
    //
    STDMETHOD(FillContainsPoint)
    (D2D1_POINT_2F point, _In_opt_ CONST D2D1_MATRIX_3X2_F * worldTransform, FLOAT flatteningTolerance, _Out_ BOOL * contains) CONST PURE;

    //
    // Compare how one geometry intersects or contains another geometry.
    //
    STDMETHOD(CompareWithGeometry)
    (_In_ ID2D1Geometry * inputGeometry, _In_opt_ CONST D2D1_MATRIX_3X2_F * inputGeometryTransform, FLOAT flatteningTolerance,
     _Out_ D2D1_GEOMETRY_RELATION * relation) CONST PURE;
    ...
    //
    STDMETHOD(Simplify)
    (D2D1_GEOMETRY_SIMPLIFICATION_OPTION simplificationOption, _In_opt_ CONST D2D1_MATRIX_3X2_F * worldTransform, FLOAT flatteningTolerance,
     _In_ ID2D1SimplifiedGeometrySink * geometrySink) CONST PURE;

    //
    // Tessellates a geometry into triangles.
    //
    STDMETHOD(Tessellate)
    (_In_opt_ CONST D2D1_MATRIX_3X2_F * worldTransform, FLOAT flatteningTolerance, _In_ ID2D1TessellationSink * tessellationSink) CONST PURE;
    ...
    (_In_ ID2D1Geometry * inputGeometry, D2D1_COMBINE_MODE combineMode, _In_opt_ CONST D2D1_MATRIX_3X2_F * inputGeometryTransform, FLOAT flatteningTolerance,
     _In_ ID2D1SimplifiedGeometrySink * geometrySink) CONST PURE;
    ...
    //
    STDMETHOD(Outline)
    (_In_opt_ CONST D2D1_MATRIX_3X2_F * worldTransform, FLOAT flatteningTolerance, _In_ ID2D1SimplifiedGeometrySink * geometrySink) CONST PURE;

    //
    // Computes the area of the geometry.
    //
    STDMETHOD(ComputeArea)(_In_opt_ CONST D2D1_MATRIX_3X2_F * worldTransform, FLOAT flatteningTolerance, _Out_ FLOAT * area) CONST PURE;

    //
    // Computes the length of the geometry.
    //
    STDMETHOD(ComputeLength)(_In_opt_ CONST D2D1_MATRIX_3X2_F * worldTransform, FLOAT flatteningTolerance, _Out_ FLOAT * length) CONST PURE;

    //
    // Computes the point and tangent a given distance along the path.
    //
    STDMETHOD(ComputePointAtLength)
    (FLOAT length, _In_opt_ CONST D2D1_MATRIX_3X2_F * worldTransform, FLOAT flatteningTolerance, _Out_opt_ D2D1_POINT_2F * point,
     _Out_opt_ D2D1_POINT_2F * unitTangentVector) CONST PURE;
    ...
    //
    HRESULT
    GetBounds(CONST D2D1_MATRIX_3X2_F & worldTransform, _Out_ D2D1_RECT_F * bounds) CONST { return GetBounds(&worldTransform, bounds); }
    ...
    //
    HRESULT
    GetWidenedBounds(FLOAT strokeWidth, _In_opt_ ID2D1StrokeStyle * strokeStyle, CONST D2D1_MATRIX_3X2_F & worldTransform, FLOAT flatteningTolerance,
    ...
    //
    HRESULT
    GetWidenedBounds(FLOAT strokeWidth, _In_opt_ ID2D1StrokeStyle * strokeStyle, CONST D2D1_MATRIX_3X2_F & worldTransform, _Out_ D2D1_RECT_F * bounds) CONST {
        return GetWidenedBounds(strokeWidth, strokeStyle, &worldTransform, D2D1_DEFAULT_FLATTENING_TOLERANCE, bounds);
    }

    HRESULT
    StrokeContainsPoint(D2D1_POINT_2F point, FLOAT strokeWidth, _In_opt_ ID2D1StrokeStyle * strokeStyle, CONST D2D1_MATRIX_3X2_F & worldTransform,
                        FLOAT flatteningTolerance, _Out_ BOOL * contains) CONST {
    ...
    //
    HRESULT
    StrokeContainsPoint(D2D1_POINT_2F point, FLOAT strokeWidth, _In_opt_ ID2D1StrokeStyle * strokeStyle, _In_opt_ CONST D2D1_MATRIX_3X2_F * worldTransform,
    ...
    HRESULT
    FillContainsPoint(D2D1_POINT_2F point, CONST D2D1_MATRIX_3X2_F & worldTransform, FLOAT flatteningTolerance, _Out_ BOOL * contains) CONST {
    ...
    //
    HRESULT
    FillContainsPoint(D2D1_POINT_2F point, _In_opt_ CONST D2D1_MATRIX_3X2_F * worldTransform, _Out_ BOOL * contains) CONST {
        return FillContainsPoint(point, worldTransform, D2D1_DEFAULT_FLATTENING_TOLERANCE, contains);
    }

    HRESULT
    FillContainsPoint(D2D1_POINT_2F point, CONST D2D1_MATRIX_3X2_F & worldTransform, _Out_ BOOL * contains) CONST {
        return FillContainsPoint(point, &worldTransform, D2D1_DEFAULT_FLATTENING_TOLERANCE, contains);
    }
    ...
    //
    HRESULT
    CompareWithGeometry(_In_ ID2D1Geometry * inputGeometry, CONST D2D1_MATRIX_3X2_F & inputGeometryTransform, FLOAT flatteningTolerance,
    ...
    //
    HRESULT
    CompareWithGeometry(_In_ ID2D1Geometry * inputGeometry, CONST D2D1_MATRIX_3X2_F & inputGeometryTransform, _Out_ D2D1_GEOMETRY_RELATION * relation) CONST {
        return CompareWithGeometry(inputGeometry, &inputGeometryTransform, D2D1_DEFAULT_FLATTENING_TOLERANCE, relation);
    }
    ...
    //
    HRESULT
    Simplify(D2D1_GEOMETRY_SIMPLIFICATION_OPTION simplificationOption, CONST D2D1_MATRIX_3X2_F & worldTransform, FLOAT flatteningTolerance,
    ...
    //
    HRESULT
    Simplify(D2D1_GEOMETRY_SIMPLIFICATION_OPTION simplificationOption, _In_opt_ CONST D2D1_MATRIX_3X2_F * worldTransform,
             _In_ ID2D1SimplifiedGeometrySink * geometrySink) CONST {
    ...
    //
    HRESULT
    Simplify(D2D1_GEOMETRY_SIMPLIFICATION_OPTION simplificationOption, CONST D2D1_MATRIX_3X2_F & worldTransform,
             _In_ ID2D1SimplifiedGeometrySink * geometrySink) CONST {
        return Simplify(simplificationOption, &worldTransform, D2D1_DEFAULT_FLATTENING_TOLERANCE, geometrySink);
    }
    ...
    //
    HRESULT
    Tessellate(CONST D2D1_MATRIX_3X2_F & worldTransform, FLOAT flatteningTolerance, _In_ ID2D1TessellationSink * tessellationSink) CONST {
    ...
    //
    HRESULT
    Tessellate(_In_opt_ CONST D2D1_MATRIX_3X2_F * worldTransform, _In_ ID2D1TessellationSink * tessellationSink) CONST {
    ...
    //
    HRESULT
    Tessellate(CONST D2D1_MATRIX_3X2_F & worldTransform, _In_ ID2D1TessellationSink * tessellationSink) CONST {
        return Tessellate(&worldTransform, D2D1_DEFAULT_FLATTENING_TOLERANCE, tessellationSink);
    }
    ...
    //
    HRESULT
    CombineWithGeometry(_In_ ID2D1Geometry * inputGeometry, D2D1_COMBINE_MODE combineMode, CONST D2D1_MATRIX_3X2_F & inputGeometryTransform,
                        FLOAT flatteningTolerance, _In_ ID2D1SimplifiedGeometrySink * geometrySink) CONST {
    ...
    //
    HRESULT
    CombineWithGeometry(_In_ ID2D1Geometry * inputGeometry, D2D1_COMBINE_MODE combineMode, _In_opt_ CONST D2D1_MATRIX_3X2_F * inputGeometryTransform,
                        _In_ ID2D1SimplifiedGeometrySink * geometrySink) CONST {
    ...
    //
    HRESULT
    Outline(CONST D2D1_MATRIX_3X2_F & worldTransform, FLOAT flatteningTolerance, _In_ ID2D1SimplifiedGeometrySink * geometrySink) CONST {
    ...
    //
    HRESULT
    Outline(_In_opt_ CONST D2D1_MATRIX_3X2_F * worldTransform, _In_ ID2D1SimplifiedGeometrySink * geometrySink) CONST {
    ...
    //
    HRESULT
    Outline(CONST D2D1_MATRIX_3X2_F & worldTransform, _In_ ID2D1SimplifiedGeometrySink * geometrySink) CONST {
        return Outline(&worldTransform, D2D1_DEFAULT_FLATTENING_TOLERANCE, geometrySink);
    }
    ...
    //
    HRESULT
    ComputeArea(CONST D2D1_MATRIX_3X2_F & worldTransform, FLOAT flatteningTolerance, _Out_ FLOAT * area) CONST {
    ...
    //
    HRESULT
    ComputeArea(_In_opt_ CONST D2D1_MATRIX_3X2_F * worldTransform, _Out_ FLOAT * area) CONST {
    ...
    //
    HRESULT
    ComputeArea(CONST D2D1_MATRIX_3X2_F & worldTransform, _Out_ FLOAT * area) CONST {
        return ComputeArea(&worldTransform, D2D1_DEFAULT_FLATTENING_TOLERANCE, area);
    }
    ...
    //
    HRESULT
    ComputeLength(CONST D2D1_MATRIX_3X2_F & worldTransform, FLOAT flatteningTolerance, _Out_ FLOAT * length) CONST {
    ...
    //
    HRESULT
    ComputeLength(_In_opt_ CONST D2D1_MATRIX_3X2_F * worldTransform, _Out_ FLOAT * length) CONST {
    ...
    //
    HRESULT
    ComputeLength(CONST D2D1_MATRIX_3X2_F & worldTransform, _Out_ FLOAT * length) CONST {
        return ComputeLength(&worldTransform, D2D1_DEFAULT_FLATTENING_TOLERANCE, length);
    }
    ...
    //
    HRESULT
    ComputePointAtLength(FLOAT length, CONST D2D1_MATRIX_3X2_F & worldTransform, FLOAT flatteningTolerance, _Out_opt_ D2D1_POINT_2F * point,
    ...
    //
    HRESULT
    ComputePointAtLength(FLOAT length, _In_opt_ CONST D2D1_MATRIX_3X2_F * worldTransform, _Out_opt_ D2D1_POINT_2F * point,
                         _Out_opt_ D2D1_POINT_2F * unitTangentVector) CONST {
    ...
    //
    HRESULT
    Widen(FLOAT strokeWidth, _In_opt_ ID2D1StrokeStyle * strokeStyle, CONST D2D1_MATRIX_3X2_F & worldTransform, FLOAT flatteningTolerance,
          _In_ ID2D1SimplifiedGeometrySink * geometrySink) CONST {
    ...
    //
    HRESULT
    Widen(FLOAT strokeWidth, _In_opt_ ID2D1StrokeStyle * strokeStyle, _In_opt_ CONST D2D1_MATRIX_3X2_F * worldTransform,
          _In_ ID2D1SimplifiedGeometrySink * geometrySink) CONST {
...
interface DX_DECLARE_INTERFACE("2cd906a2-12e2-11dc-9fed-001143a055f9") ID2D1RectangleGeometry : public ID2D1Geometry {
    ...
    STDMETHOD_(void, GetRect)(_Out_ D2D1_RECT_F * rect) CONST PURE;
...
interface DX_DECLARE_INTERFACE("2cd906a3-12e2-11dc-9fed-001143a055f9") ID2D1RoundedRectangleGeometry : public ID2D1Geometry {
    ...
    STDMETHOD_(void, GetRoundedRect)(_Out_ D2D1_ROUNDED_RECT * roundedRect) CONST PURE;
...
interface DX_DECLARE_INTERFACE("2cd906a4-12e2-11dc-9fed-001143a055f9") ID2D1EllipseGeometry : public ID2D1Geometry {
    ...
    STDMETHOD_(void, GetEllipse)(_Out_ D2D1_ELLIPSE * ellipse) CONST PURE;
...
interface DX_DECLARE_INTERFACE("2cd9069e-12e2-11dc-9fed-001143a055f9") ID2D1SimplifiedGeometrySink : public IUnknown {
    ...
    STDMETHOD_(void, AddLines)(_In_reads_(pointsCount) CONST D2D1_POINT_2F * points, UINT32 pointsCount) PURE;

    STDMETHOD_(void, AddBeziers)(_In_reads_(beziersCount) CONST D2D1_BEZIER_SEGMENT * beziers, UINT32 beziersCount) PURE;
...
interface DX_DECLARE_INTERFACE("2cd9069f-12e2-11dc-9fed-001143a055f9") ID2D1GeometrySink : public ID2D1SimplifiedGeometrySink {
    ...
    STDMETHOD_(void, AddBezier)(_In_ CONST D2D1_BEZIER_SEGMENT * bezier) PURE;

    STDMETHOD_(void, AddQuadraticBezier)(_In_ CONST D2D1_QUADRATIC_BEZIER_SEGMENT * bezier) PURE;

    STDMETHOD_(void, AddQuadraticBeziers)(_In_reads_(beziersCount) CONST D2D1_QUADRATIC_BEZIER_SEGMENT * beziers, UINT32 beziersCount) PURE;

    STDMETHOD_(void, AddArc)(_In_ CONST D2D1_ARC_SEGMENT * arc) PURE;

    void AddBezier(CONST D2D1_BEZIER_SEGMENT & bezier) { AddBezier(&bezier); }

    void AddQuadraticBezier(CONST D2D1_QUADRATIC_BEZIER_SEGMENT & bezier) { AddQuadraticBezier(&bezier); }

    void AddArc(CONST D2D1_ARC_SEGMENT & arc) { AddArc(&arc); }
...
interface DX_DECLARE_INTERFACE("2cd906c1-12e2-11dc-9fed-001143a055f9") ID2D1TessellationSink : public IUnknown {
    ...
    STDMETHOD_(void, AddTriangles)(_In_reads_(trianglesCount) CONST D2D1_TRIANGLE * triangles, UINT32 trianglesCount) PURE;
...
interface DX_DECLARE_INTERFACE("2cd906a5-12e2-11dc-9fed-001143a055f9") ID2D1PathGeometry : public ID2D1Geometry {
    ...
    //
    STDMETHOD(Stream)(_In_ ID2D1GeometrySink * geometrySink) CONST PURE;

    STDMETHOD(GetSegmentCount)(_Out_ UINT32 * count) CONST PURE;

    STDMETHOD(GetFigureCount)(_Out_ UINT32 * count) CONST PURE;
...
interface DX_DECLARE_INTERFACE("28506e39-ebf6-46a1-bb47-fd85565ab957") ID2D1DrawingStateBlock : public ID2D1Resource {
    ...
    //
    STDMETHOD_(void, GetDescription)(_Out_ D2D1_DRAWING_STATE_DESCRIPTION * stateDescription) CONST PURE;

    //
    // Sets the state description of this state block resource.
    //
    STDMETHOD_(void, SetDescription)(_In_ CONST D2D1_DRAWING_STATE_DESCRIPTION * stateDescription) PURE;

    //
    // Sets the text rendering parameters of this state block resource.
    //
    STDMETHOD_(void, SetTextRenderingParams)(_In_opt_ IDWriteRenderingParams * textRenderingParams = NULL) PURE;
...
interface DX_DECLARE_INTERFACE("2cd90694-12e2-11dc-9fed-001143a055f9") ID2D1RenderTarget : public ID2D1Resource {
    ...
    (D2D1_SIZE_U size, _In_opt_ CONST void * srcData, UINT32 pitch, _In_ CONST D2D1_BITMAP_PROPERTIES * bitmapProperties, _Outptr_ ID2D1Bitmap ** bitmap) PURE;
    ...
    (_In_ REFIID riid, _Inout_ void * data, _In_opt_ CONST D2D1_BITMAP_PROPERTIES * bitmapProperties, _Outptr_ ID2D1Bitmap ** bitmap) PURE;
    ...
    (_In_reads_(gradientStopsCount) CONST D2D1_GRADIENT_STOP * gradientStops, _In_range_(>=, 1) UINT32 gradientStopsCount,
    ...
    (_In_ CONST D2D1_RECT_F * rect, _In_ ID2D1Brush * brush, FLOAT strokeWidth = 1.0f, _In_opt_ ID2D1StrokeStyle * strokeStyle = NULL) PURE;

    STDMETHOD_(void, FillRectangle)(_In_ CONST D2D1_RECT_F * rect, _In_ ID2D1Brush * brush) PURE;

    STDMETHOD_(void, DrawRoundedRectangle)
    (_In_ CONST D2D1_ROUNDED_RECT * roundedRect, _In_ ID2D1Brush * brush, FLOAT strokeWidth = 1.0f, _In_opt_ ID2D1StrokeStyle * strokeStyle = NULL) PURE;

    STDMETHOD_(void, FillRoundedRectangle)(_In_ CONST D2D1_ROUNDED_RECT * roundedRect, _In_ ID2D1Brush * brush) PURE;

    STDMETHOD_(void, DrawEllipse)
    (_In_ CONST D2D1_ELLIPSE * ellipse, _In_ ID2D1Brush * brush, FLOAT strokeWidth = 1.0f, _In_opt_ ID2D1StrokeStyle * strokeStyle = NULL) PURE;

    STDMETHOD_(void, FillEllipse)(_In_ CONST D2D1_ELLIPSE * ellipse, _In_ ID2D1Brush * brush) PURE;

    STDMETHOD_(void, DrawGeometry)
    (_In_ ID2D1Geometry * geometry, _In_ ID2D1Brush * brush, FLOAT strokeWidth = 1.0f, _In_opt_ ID2D1StrokeStyle * strokeStyle = NULL) PURE;

    STDMETHOD_(void, FillGeometry)
    (_In_ ID2D1Geometry * geometry, _In_ ID2D1Brush * brush,
    ...
    (_In_ ID2D1Bitmap * opacityMask, _In_ ID2D1Brush * brush, D2D1_OPACITY_MASK_CONTENT content, _In_opt_ CONST D2D1_RECT_F * destinationRectangle = NULL,
     _In_opt_ CONST D2D1_RECT_F * sourceRectangle = NULL) PURE;

    STDMETHOD_(void, DrawBitmap)
    (_In_ ID2D1Bitmap * bitmap, _In_opt_ CONST D2D1_RECT_F * destinationRectangle = NULL, FLOAT opacity = 1.0f,
     D2D1_BITMAP_INTERPOLATION_MODE interpolationMode = D2D1_BITMAP_INTERPOLATION_MODE_LINEAR, _In_opt_ CONST D2D1_RECT_F * sourceRectangle = NULL) PURE;
    ...
    (_In_reads_(stringLength) CONST WCHAR * string, UINT32 stringLength, _In_ IDWriteTextFormat * textFormat, _In_ CONST D2D1_RECT_F * layoutRect,
     _In_ ID2D1Brush * defaultForegroundBrush, D2D1_DRAW_TEXT_OPTIONS options = D2D1_DRAW_TEXT_OPTIONS_NONE,
    ...
    (D2D1_POINT_2F origin, _In_ IDWriteTextLayout * textLayout, _In_ ID2D1Brush * defaultForegroundBrush,
     ...
     //
     D2D1_DRAW_TEXT_OPTIONS options = D2D1_DRAW_TEXT_OPTIONS_NONE) PURE;

    STDMETHOD_(void, DrawGlyphRun)
    (D2D1_POINT_2F baselineOrigin, _In_ CONST DWRITE_GLYPH_RUN * glyphRun, _In_ ID2D1Brush * foregroundBrush,
     DWRITE_MEASURING_MODE measuringMode = DWRITE_MEASURING_MODE_NATURAL) PURE;
    ...
    STDMETHOD_(D2D1_ANTIALIAS_MODE, GetAntialiasMode)() CONST PURE;

    STDMETHOD_(void, SetTextAntialiasMode)(D2D1_TEXT_ANTIALIAS_MODE textAntialiasMode) PURE;

    STDMETHOD_(D2D1_TEXT_ANTIALIAS_MODE, GetTextAntialiasMode)() CONST PURE;
    ...
    //
    STDMETHOD_(void, GetTags)(_Out_opt_ D2D1_TAG * tag1 = NULL, _Out_opt_ D2D1_TAG * tag2 = NULL) CONST PURE;
    ...
    //
    STDMETHOD_(void, PushLayer)(_In_ CONST D2D1_LAYER_PARAMETERS * layerParameters, _In_opt_ ID2D1Layer * layer) PURE;

    //
    // Ends a layer that was defined with particular layer resources.
    //
    STDMETHOD_(void, PopLayer)() PURE;

    STDMETHOD(Flush)(_Out_opt_ D2D1_TAG * tag1 = NULL, _Out_opt_ D2D1_TAG * tag2 = NULL) PURE;

    //
    // Gets the current drawing state and saves it into the supplied
    // IDrawingStatckBlock.
    //
    STDMETHOD_(void, SaveDrawingState)(_Inout_ ID2D1DrawingStateBlock * drawingStateBlock) CONST PURE;

    //
    // Copies the state stored in the block interface.
    //
    STDMETHOD_(void, RestoreDrawingState)(_In_ ID2D1DrawingStateBlock * drawingStateBlock) PURE;
    ...
    //
    STDMETHOD_(void, PushAxisAlignedClip)(_In_ CONST D2D1_RECT_F * clipRect, D2D1_ANTIALIAS_MODE antialiasMode) PURE;

    STDMETHOD_(void, PopAxisAlignedClip)() PURE;

    STDMETHOD_(void, Clear)(_In_opt_ CONST D2D1_COLOR_F * clearColor = NULL) PURE;
    ...
    //
    STDMETHOD(EndDraw)(_Out_opt_ D2D1_TAG * tag1 = NULL, _Out_opt_ D2D1_TAG * tag2 = NULL) PURE;
    ...
    //
    STDMETHOD_(UINT32, GetMaximumBitmapSize)() CONST PURE;
    ...
    // supported.
    //
    STDMETHOD_(BOOL, IsSupported)(_In_ CONST D2D1_RENDER_TARGET_PROPERTIES * renderTargetProperties) CONST PURE;

    HRESULT
    CreateBitmap(D2D1_SIZE_U size, _In_opt_ CONST void * srcData, UINT32 pitch, CONST D2D1_BITMAP_PROPERTIES & bitmapProperties,
    ...
    void FillRectangle(CONST D2D1_RECT_F & rect, _In_ ID2D1Brush * brush) { FillRectangle(&rect, brush); }

    void DrawRoundedRectangle(CONST D2D1_ROUNDED_RECT & roundedRect, _In_ ID2D1Brush * brush, FLOAT strokeWidth = 1.0f,
                              _In_opt_ ID2D1StrokeStyle * strokeStyle = NULL) {
        DrawRoundedRectangle(&roundedRect, brush, strokeWidth, strokeStyle);
    }

    void FillRoundedRectangle(CONST D2D1_ROUNDED_RECT & roundedRect, _In_ ID2D1Brush * brush) { FillRoundedRectangle(&roundedRect, brush); }

    void DrawEllipse(CONST D2D1_ELLIPSE & ellipse, _In_ ID2D1Brush * brush, FLOAT strokeWidth = 1.0f, _In_opt_ ID2D1StrokeStyle * strokeStyle = NULL) {
        DrawEllipse(&ellipse, brush, strokeWidth, strokeStyle);
    }

    void FillEllipse(CONST D2D1_ELLIPSE & ellipse, _In_ ID2D1Brush * brush) { FillEllipse(&ellipse, brush); }

    void FillOpacityMask(_In_ ID2D1Bitmap * opacityMask, _In_ ID2D1Brush * brush, D2D1_OPACITY_MASK_CONTENT content, CONST D2D1_RECT_F & destinationRectangle,
    ...
    void DrawBitmap(_In_ ID2D1Bitmap * bitmap, CONST D2D1_RECT_F & destinationRectangle, FLOAT opacity, D2D1_BITMAP_INTERPOLATION_MODE interpolationMode,
                    CONST D2D1_RECT_F & sourceRectangle) {
        DrawBitmap(bitmap, &destinationRectangle, opacity, interpolationMode, &sourceRectangle);
    }
    ...
    void PushLayer(CONST D2D1_LAYER_PARAMETERS & layerParameters, _In_opt_ ID2D1Layer * layer) { PushLayer(&layerParameters, layer); }

    void PushAxisAlignedClip(CONST D2D1_RECT_F & clipRect, D2D1_ANTIALIAS_MODE antialiasMode) { return PushAxisAlignedClip(&clipRect, antialiasMode); }
    ...
    // clips it.
    //
    void DrawText(_In_reads_(stringLength) CONST WCHAR * string, UINT32 stringLength, _In_ IDWriteTextFormat * textFormat, CONST D2D1_RECT_F & layoutRect,
                  _In_ ID2D1Brush * defaultForegroundBrush, D2D1_DRAW_TEXT_OPTIONS options = D2D1_DRAW_TEXT_OPTIONS_NONE,
...
interface DX_DECLARE_INTERFACE("2cd90698-12e2-11dc-9fed-001143a055f9") ID2D1HwndRenderTarget : public ID2D1RenderTarget {
    ...
    //
    STDMETHOD(Resize)(_In_ CONST D2D1_SIZE_U * pixelSize) PURE;

    STDMETHOD_(HWND, GetHwnd)() CONST PURE;

    HRESULT
    Resize(CONST D2D1_SIZE_U & pixelSize) { return Resize(&pixelSize); }
...
interface DX_DECLARE_INTERFACE("e0db51c3-6f77-4bae-b3d5-e47509b35838") ID2D1GdiInteropRenderTarget : public IUnknown {
    ...
    STDMETHOD(GetDC)(D2D1_DC_INITIALIZE_MODE mode, _Out_ HDC * hdc) PURE;

    STDMETHOD(ReleaseDC)(_In_opt_ CONST RECT * update) PURE;
...
interface DX_DECLARE_INTERFACE("1c51bc64-de61-46fd-9899-63a5d8f03950") ID2D1DCRenderTarget : public ID2D1RenderTarget {
    ...
    STDMETHOD(BindDC)(_In_ CONST HDC hDC, _In_ CONST RECT * pSubRect) PURE;
...
interface DX_DECLARE_INTERFACE("06152247-6f50-465a-9245-118bfd3b6007") ID2D1Factory : public IUnknown {
    ...
    // on factory creation.
    //
    STDMETHOD(ReloadSystemMetrics)() PURE;
...
interface ID2D1Image {
    CONST struct ID2D1ImageVtbl * lpVtbl;
            ...
            #define ID2D1Image_GetFactory(This, factory) ((This)->lpVtbl->Base.GetFactory((ID2D1Resource *) This, factory))
...
typedef struct ID2D1BitmapVtbl {
    ...
    STDMETHOD_(void, GetDpi)(ID2D1Bitmap * This, _Out_ FLOAT * dpiX, _Out_ FLOAT * dpiY) PURE;

    STDMETHOD(CopyFromBitmap)
    (ID2D1Bitmap * This, _In_opt_ CONST D2D1_POINT_2U * destPoint, _In_ ID2D1Bitmap * bitmap, _In_opt_ CONST D2D1_RECT_U * srcRect) PURE;

    STDMETHOD(CopyFromRenderTarget)
    (ID2D1Bitmap * This, _In_opt_ CONST D2D1_POINT_2U * destPoint, _In_ ID2D1RenderTarget * renderTarget, _In_opt_ CONST D2D1_RECT_U * srcRect) PURE;
...
interface ID2D1Bitmap {
    CONST struct ID2D1BitmapVtbl * lpVtbl;
            ...
            #define ID2D1Bitmap_GetFactory(This, factory) ((This)->lpVtbl->Base.Base.GetFactory((ID2D1Resource *) This, factory))
            ...
            #define ID2D1Bitmap_GetDpi(This, dpiX, dpiY) ((This)->lpVtbl->GetDpi(This, dpiX, dpiY))

            #define ID2D1Bitmap_CopyFromBitmap(This, destPoint, bitmap, srcRect) ((This)->lpVtbl->CopyFromBitmap(This, destPoint, bitmap, srcRect))
            ...
            #define ID2D1Bitmap_CopyFromMemory(This, dstRect, srcData, pitch) ((This)->lpVtbl->CopyFromMemory(This, dstRect, srcData, pitch))
...
interface ID2D1GradientStopCollection {
    CONST struct ID2D1GradientStopCollectionVtbl * lpVtbl;
            ...
            #define ID2D1GradientStopCollection_GetFactory(This, factory) ((This)->lpVtbl->Base.GetFactory((ID2D1Resource *) This, factory))
...
typedef struct ID2D1BrushVtbl {
    ...
    STDMETHOD_(void, SetTransform)(ID2D1Brush * This, _In_ CONST D2D1_MATRIX_3X2_F * transform) PURE;
...
interface ID2D1Brush {
    CONST struct ID2D1BrushVtbl * lpVtbl;
            ...
            #define ID2D1Brush_GetFactory(This, factory) ((This)->lpVtbl->Base.GetFactory((ID2D1Resource *) This, factory))
...
typedef struct ID2D1BitmapBrushVtbl {
    ...
    STDMETHOD_(void, SetBitmap)(ID2D1BitmapBrush * This, _In_opt_ ID2D1Bitmap * bitmap) PURE;
...
interface ID2D1BitmapBrush {
    CONST struct ID2D1BitmapBrushVtbl * lpVtbl;
            ...
            #define ID2D1BitmapBrush_GetFactory(This, factory) ((This)->lpVtbl->Base.Base.GetFactory((ID2D1Resource *) This, factory))

            #define ID2D1BitmapBrush_SetOpacity(This, opacity) ((This)->lpVtbl->Base.SetOpacity((ID2D1Brush *) This, opacity))

            #define ID2D1BitmapBrush_SetTransform(This, transform) ((This)->lpVtbl->Base.SetTransform((ID2D1Brush *) This, transform))

            #define ID2D1BitmapBrush_GetOpacity(This) ((This)->lpVtbl->Base.GetOpacity((ID2D1Brush *) This))

            #define ID2D1BitmapBrush_GetTransform(This, transform) ((This)->lpVtbl->Base.GetTransform((ID2D1Brush *) This, transform))

            #define ID2D1BitmapBrush_SetExtendModeX(This, extendModeX) ((This)->lpVtbl->SetExtendModeX(This, extendModeX))

            #define ID2D1BitmapBrush_SetExtendModeY(This, extendModeY) ((This)->lpVtbl->SetExtendModeY(This, extendModeY))

            #define ID2D1BitmapBrush_SetInterpolationMode(This, interpolationMode) ((This)->lpVtbl->SetInterpolationMode(This, interpolationMode))
...
typedef struct ID2D1SolidColorBrushVtbl {
    ...
    STDMETHOD_(void, SetColor)(ID2D1SolidColorBrush * This, _In_ CONST D2D1_COLOR_F * color) PURE;
...
interface ID2D1SolidColorBrush {
    CONST struct ID2D1SolidColorBrushVtbl * lpVtbl;
            ...
            #define ID2D1SolidColorBrush_GetFactory(This, factory) ((This)->lpVtbl->Base.Base.GetFactory((ID2D1Resource *) This, factory))

            #define ID2D1SolidColorBrush_SetOpacity(This, opacity) ((This)->lpVtbl->Base.SetOpacity((ID2D1Brush *) This, opacity))

            #define ID2D1SolidColorBrush_SetTransform(This, transform) ((This)->lpVtbl->Base.SetTransform((ID2D1Brush *) This, transform))

            #define ID2D1SolidColorBrush_GetOpacity(This) ((This)->lpVtbl->Base.GetOpacity((ID2D1Brush *) This))

            #define ID2D1SolidColorBrush_GetTransform(This, transform) ((This)->lpVtbl->Base.GetTransform((ID2D1Brush *) This, transform))
...
interface ID2D1LinearGradientBrush {
    CONST struct ID2D1LinearGradientBrushVtbl * lpVtbl;
            ...
            #define ID2D1LinearGradientBrush_GetFactory(This, factory) ((This)->lpVtbl->Base.Base.GetFactory((ID2D1Resource *) This, factory))

            #define ID2D1LinearGradientBrush_SetOpacity(This, opacity) ((This)->lpVtbl->Base.SetOpacity((ID2D1Brush *) This, opacity))

            #define ID2D1LinearGradientBrush_SetTransform(This, transform) ((This)->lpVtbl->Base.SetTransform((ID2D1Brush *) This, transform))

            #define ID2D1LinearGradientBrush_GetOpacity(This) ((This)->lpVtbl->Base.GetOpacity((ID2D1Brush *) This))

            #define ID2D1LinearGradientBrush_GetTransform(This, transform) ((This)->lpVtbl->Base.GetTransform((ID2D1Brush *) This, transform))

            #define ID2D1LinearGradientBrush_SetStartPoint(This, startPoint) ((This)->lpVtbl->SetStartPoint(This, startPoint))

            #define ID2D1LinearGradientBrush_SetEndPoint(This, endPoint) ((This)->lpVtbl->SetEndPoint(This, endPoint))
...
interface ID2D1RadialGradientBrush {
    CONST struct ID2D1RadialGradientBrushVtbl * lpVtbl;
            ...
            #define ID2D1RadialGradientBrush_GetFactory(This, factory) ((This)->lpVtbl->Base.Base.GetFactory((ID2D1Resource *) This, factory))

            #define ID2D1RadialGradientBrush_SetOpacity(This, opacity) ((This)->lpVtbl->Base.SetOpacity((ID2D1Brush *) This, opacity))

            #define ID2D1RadialGradientBrush_SetTransform(This, transform) ((This)->lpVtbl->Base.SetTransform((ID2D1Brush *) This, transform))

            #define ID2D1RadialGradientBrush_GetOpacity(This) ((This)->lpVtbl->Base.GetOpacity((ID2D1Brush *) This))

            #define ID2D1RadialGradientBrush_GetTransform(This, transform) ((This)->lpVtbl->Base.GetTransform((ID2D1Brush *) This, transform))
            ...
            #define ID2D1RadialGradientBrush_SetRadiusX(This, radiusX) ((This)->lpVtbl->SetRadiusX(This, radiusX))

            #define ID2D1RadialGradientBrush_SetRadiusY(This, radiusY) ((This)->lpVtbl->SetRadiusY(This, radiusY))
...
interface ID2D1StrokeStyle {
    CONST struct ID2D1StrokeStyleVtbl * lpVtbl;
            ...
            #define ID2D1StrokeStyle_GetFactory(This, factory) ((This)->lpVtbl->Base.GetFactory((ID2D1Resource *) This, factory))
            ...
            #define ID2D1StrokeStyle_GetDashes(This, dashes, dashesCount) ((This)->lpVtbl->GetDashes(This, dashes, dashesCount))
...
typedef struct ID2D1GeometryVtbl {
    ...
    STDMETHOD(GetBounds)(ID2D1Geometry * This, _In_opt_ CONST D2D1_MATRIX_3X2_F * worldTransform, _Out_ D2D1_RECT_F * bounds) PURE;

    STDMETHOD(GetWidenedBounds)
    (ID2D1Geometry * This, FLOAT strokeWidth, _In_opt_ ID2D1StrokeStyle * strokeStyle, _In_opt_ CONST D2D1_MATRIX_3X2_F * worldTransform,
     FLOAT flatteningTolerance, _Out_ D2D1_RECT_F * bounds) PURE;

    STDMETHOD(StrokeContainsPoint)
    (ID2D1Geometry * This, D2D1_POINT_2F point, FLOAT strokeWidth, _In_opt_ ID2D1StrokeStyle * strokeStyle, _In_opt_ CONST D2D1_MATRIX_3X2_F * worldTransform,
     FLOAT flatteningTolerance, _Out_ BOOL * contains) PURE;

    STDMETHOD(FillContainsPoint)
    (ID2D1Geometry * This, D2D1_POINT_2F point, _In_opt_ CONST D2D1_MATRIX_3X2_F * worldTransform, FLOAT flatteningTolerance, _Out_ BOOL * contains) PURE;

    STDMETHOD(CompareWithGeometry)
    (ID2D1Geometry * This, _In_ ID2D1Geometry * inputGeometry, _In_opt_ CONST D2D1_MATRIX_3X2_F * inputGeometryTransform, FLOAT flatteningTolerance,
     _Out_ D2D1_GEOMETRY_RELATION * relation) PURE;

    STDMETHOD(Simplify)
    (ID2D1Geometry * This, D2D1_GEOMETRY_SIMPLIFICATION_OPTION simplificationOption, _In_opt_ CONST D2D1_MATRIX_3X2_F * worldTransform,
     FLOAT flatteningTolerance, _In_ ID2D1SimplifiedGeometrySink * geometrySink) PURE;

    STDMETHOD(Tessellate)
    (ID2D1Geometry * This, _In_opt_ CONST D2D1_MATRIX_3X2_F * worldTransform, FLOAT flatteningTolerance, _In_ ID2D1TessellationSink * tessellationSink) PURE;

    STDMETHOD(CombineWithGeometry)
    (ID2D1Geometry * This, _In_ ID2D1Geometry * inputGeometry, D2D1_COMBINE_MODE combineMode, _In_opt_ CONST D2D1_MATRIX_3X2_F * inputGeometryTransform,
     FLOAT flatteningTolerance, _In_ ID2D1SimplifiedGeometrySink * geometrySink) PURE;

    STDMETHOD(Outline)
    (ID2D1Geometry * This, _In_opt_ CONST D2D1_MATRIX_3X2_F * worldTransform, FLOAT flatteningTolerance, _In_ ID2D1SimplifiedGeometrySink * geometrySink) PURE;

    STDMETHOD(ComputeArea)(ID2D1Geometry * This, _In_opt_ CONST D2D1_MATRIX_3X2_F * worldTransform, FLOAT flatteningTolerance, _Out_ FLOAT * area) PURE;

    STDMETHOD(ComputeLength)(ID2D1Geometry * This, _In_opt_ CONST D2D1_MATRIX_3X2_F * worldTransform, FLOAT flatteningTolerance, _Out_ FLOAT * length) PURE;

    STDMETHOD(ComputePointAtLength)
    (ID2D1Geometry * This, FLOAT length, _In_opt_ CONST D2D1_MATRIX_3X2_F * worldTransform, FLOAT flatteningTolerance, _Out_opt_ D2D1_POINT_2F * point,
     _Out_opt_ D2D1_POINT_2F * unitTangentVector) PURE;
...
interface ID2D1Geometry {
    CONST struct ID2D1GeometryVtbl * lpVtbl;
            ...
            #define ID2D1Geometry_GetFactory(This, factory) ((This)->lpVtbl->Base.GetFactory((ID2D1Resource *) This, factory))

            #define ID2D1Geometry_GetBounds(This, worldTransform, bounds) ((This)->lpVtbl->GetBounds(This, worldTransform, bounds))
...
interface ID2D1RectangleGeometry {
    CONST struct ID2D1RectangleGeometryVtbl * lpVtbl;
            ...
            #define ID2D1RectangleGeometry_GetFactory(This, factory) ((This)->lpVtbl->Base.Base.GetFactory((ID2D1Resource *) This, factory))
            ...
            #define ID2D1RectangleGeometry_StrokeContainsPoint(This, point, strokeWidth, strokeStyle, worldTransform, flatteningTolerance, contains)    \
                ((This)->lpVtbl->Base.StrokeContainsPoint((ID2D1Geometry *) This, point, strokeWidth, strokeStyle, worldTransform, flatteningTolerance, \
                                                          contains))
            ...
            #define ID2D1RectangleGeometry_CombineWithGeometry(This, inputGeometry, combineMode, inputGeometryTransform, flatteningTolerance, geometrySink) \
                ((This)->lpVtbl->Base.CombineWithGeometry((ID2D1Geometry *) This, inputGeometry, combineMode, inputGeometryTransform, flatteningTolerance,  \
                                                          geometrySink))
...
interface ID2D1RoundedRectangleGeometry {
    CONST struct ID2D1RoundedRectangleGeometryVtbl * lpVtbl;
            ...
            #define ID2D1RoundedRectangleGeometry_GetFactory(This, factory) ((This)->lpVtbl->Base.Base.GetFactory((ID2D1Resource *) This, factory))
            ...
            #define ID2D1RoundedRectangleGeometry_CombineWithGeometry(This, inputGeometry, combineMode, inputGeometryTransform, flatteningTolerance,       \
                                                                      geometrySink)                                                                        \
                ((This)->lpVtbl->Base.CombineWithGeometry((ID2D1Geometry *) This, inputGeometry, combineMode, inputGeometryTransform, flatteningTolerance, \
                                                          geometrySink))
            ...
            #define ID2D1RoundedRectangleGeometry_GetRoundedRect(This, roundedRect) ((This)->lpVtbl->GetRoundedRect(This, roundedRect))
...
interface ID2D1EllipseGeometry {
    CONST struct ID2D1EllipseGeometryVtbl * lpVtbl;
            ...
            #define ID2D1EllipseGeometry_GetFactory(This, factory) ((This)->lpVtbl->Base.Base.GetFactory((ID2D1Resource *) This, factory))
...
interface ID2D1GeometryGroup {
    CONST struct ID2D1GeometryGroupVtbl * lpVtbl;
            ...
            #define ID2D1GeometryGroup_GetFactory(This, factory) ((This)->lpVtbl->Base.Base.GetFactory((ID2D1Resource *) This, factory))

            #define ID2D1GeometryGroup_GetBounds(This, worldTransform, bounds) ((This)->lpVtbl->Base.GetBounds((ID2D1Geometry *) This, worldTransform, bounds))
...
typedef struct ID2D1TransformedGeometryVtbl {
    ...
    STDMETHOD_(void, GetSourceGeometry)(ID2D1TransformedGeometry * This, _Outptr_ ID2D1Geometry ** sourceGeometry) PURE;
...
interface ID2D1TransformedGeometry {
    CONST struct ID2D1TransformedGeometryVtbl * lpVtbl;
            ...
            #define ID2D1TransformedGeometry_GetFactory(This, factory) ((This)->lpVtbl->Base.Base.GetFactory((ID2D1Resource *) This, factory))
            ...
            #define ID2D1TransformedGeometry_GetSourceGeometry(This, sourceGeometry) ((This)->lpVtbl->GetSourceGeometry(This, sourceGeometry))
...
typedef struct ID2D1SimplifiedGeometrySinkVtbl {
    ...
    STDMETHOD_(void, AddLines)(ID2D1SimplifiedGeometrySink * This, _In_reads_(pointsCount) CONST D2D1_POINT_2F * points, UINT32 pointsCount) PURE;

    STDMETHOD_(void, AddBeziers)(ID2D1SimplifiedGeometrySink * This, _In_reads_(beziersCount) CONST D2D1_BEZIER_SEGMENT * beziers, UINT32 beziersCount) PURE;
...
interface ID2D1SimplifiedGeometrySink {
    CONST struct ID2D1SimplifiedGeometrySinkVtbl * lpVtbl;
            ...
            #define ID2D1SimplifiedGeometrySink_SetFillMode(This, fillMode) ((This)->lpVtbl->SetFillMode(This, fillMode))
            ...
            #define ID2D1SimplifiedGeometrySink_AddLines(This, points, pointsCount) ((This)->lpVtbl->AddLines(This, points, pointsCount))

            #define ID2D1SimplifiedGeometrySink_AddBeziers(This, beziers, beziersCount) ((This)->lpVtbl->AddBeziers(This, beziers, beziersCount))
...
typedef struct ID2D1GeometrySinkVtbl {
    ...
    STDMETHOD_(void, AddBezier)(ID2D1GeometrySink * This, _In_ CONST D2D1_BEZIER_SEGMENT * bezier) PURE;

    STDMETHOD_(void, AddQuadraticBezier)(ID2D1GeometrySink * This, _In_ CONST D2D1_QUADRATIC_BEZIER_SEGMENT * bezier) PURE;

    STDMETHOD_(void, AddQuadraticBeziers)
    (ID2D1GeometrySink * This, _In_reads_(beziersCount) CONST D2D1_QUADRATIC_BEZIER_SEGMENT * beziers, UINT32 beziersCount) PURE;
...
interface ID2D1GeometrySink {
    CONST struct ID2D1GeometrySinkVtbl * lpVtbl;
            ...
            #define ID2D1GeometrySink_SetFillMode(This, fillMode) ((This)->lpVtbl->Base.SetFillMode((ID2D1SimplifiedGeometrySink *) This, fillMode))
            ...
            #define ID2D1GeometrySink_EndFigure(This, figureEnd) ((This)->lpVtbl->Base.EndFigure((ID2D1SimplifiedGeometrySink *) This, figureEnd))
            ...
            #define ID2D1GeometrySink_AddQuadraticBeziers(This, beziers, beziersCount) ((This)->lpVtbl->AddQuadraticBeziers(This, beziers, beziersCount))
...
typedef struct ID2D1TessellationSinkVtbl {
    ...
    STDMETHOD_(void, AddTriangles)(ID2D1TessellationSink * This, _In_reads_(trianglesCount) CONST D2D1_TRIANGLE * triangles, UINT32 trianglesCount) PURE;
...
interface ID2D1TessellationSink {
    CONST struct ID2D1TessellationSinkVtbl * lpVtbl;
            ...
            #define ID2D1TessellationSink_AddTriangles(This, triangles, trianglesCount) ((This)->lpVtbl->AddTriangles(This, triangles, trianglesCount))
...
typedef struct ID2D1PathGeometryVtbl {
    ...
    STDMETHOD(Open)(ID2D1PathGeometry * This, _Outptr_ ID2D1GeometrySink ** geometrySink) PURE;

    STDMETHOD(Stream)(ID2D1PathGeometry * This, _In_ ID2D1GeometrySink * geometrySink) PURE;

    STDMETHOD(GetSegmentCount)(ID2D1PathGeometry * This, _Out_ UINT32 * count) PURE;
...
interface ID2D1PathGeometry {
    CONST struct ID2D1PathGeometryVtbl * lpVtbl;
            ...
            #define ID2D1PathGeometry_GetFactory(This, factory) ((This)->lpVtbl->Base.Base.GetFactory((ID2D1Resource *) This, factory))

            #define ID2D1PathGeometry_GetBounds(This, worldTransform, bounds) ((This)->lpVtbl->Base.GetBounds((ID2D1Geometry *) This, worldTransform, bounds))
            ...
            #define ID2D1PathGeometry_Open(This, geometrySink) ((This)->lpVtbl->Open(This, geometrySink))

            #define ID2D1PathGeometry_Stream(This, geometrySink) ((This)->lpVtbl->Stream(This, geometrySink))
...
interface ID2D1Mesh {
    CONST struct ID2D1MeshVtbl * lpVtbl;
            ...
            #define ID2D1Mesh_GetFactory(This, factory) ((This)->lpVtbl->Base.GetFactory((ID2D1Resource *) This, factory))

            #define ID2D1Mesh_Open(This, tessellationSink) ((This)->lpVtbl->Open(This, tessellationSink))
...
interface ID2D1Layer {
    CONST struct ID2D1LayerVtbl * lpVtbl;
            ...
            #define ID2D1Layer_GetFactory(This, factory) ((This)->lpVtbl->Base.GetFactory((ID2D1Resource *) This, factory))
...
typedef struct ID2D1DrawingStateBlockVtbl {
    ...
    STDMETHOD_(void, GetDescription)(ID2D1DrawingStateBlock * This, _Out_ D2D1_DRAWING_STATE_DESCRIPTION * stateDescription) PURE;

    STDMETHOD_(void, SetDescription)(ID2D1DrawingStateBlock * This, _In_ CONST D2D1_DRAWING_STATE_DESCRIPTION * stateDescription) PURE;

    STDMETHOD_(void, SetTextRenderingParams)(ID2D1DrawingStateBlock * This, _In_opt_ IDWriteRenderingParams * textRenderingParams) PURE;
...
interface ID2D1DrawingStateBlock {
    CONST struct ID2D1DrawingStateBlockVtbl * lpVtbl;
            ...
            #define ID2D1DrawingStateBlock_GetFactory(This, factory) ((This)->lpVtbl->Base.GetFactory((ID2D1Resource *) This, factory))

            #define ID2D1DrawingStateBlock_GetDescription(This, stateDescription) ((This)->lpVtbl->GetDescription(This, stateDescription))

            #define ID2D1DrawingStateBlock_SetDescription(This, stateDescription) ((This)->lpVtbl->SetDescription(This, stateDescription))

            #define ID2D1DrawingStateBlock_SetTextRenderingParams(This, textRenderingParams) ((This)->lpVtbl->SetTextRenderingParams(This, textRenderingParams))

            #define ID2D1DrawingStateBlock_GetTextRenderingParams(This, textRenderingParams) ((This)->lpVtbl->GetTextRenderingParams(This, textRenderingParams))
...
typedef struct ID2D1RenderTargetVtbl {
    ...
    STDMETHOD(CreateBitmap)
    (ID2D1RenderTarget * This, D2D1_SIZE_U size, _In_opt_ CONST void * srcData, UINT32 pitch, _In_ CONST D2D1_BITMAP_PROPERTIES * bitmapProperties,
     _Outptr_ ID2D1Bitmap ** bitmap) PURE;

    STDMETHOD(CreateBitmapFromWicBitmap)
    (ID2D1RenderTarget * This, _In_ IWICBitmapSource * wicBitmapSource, _In_opt_ CONST D2D1_BITMAP_PROPERTIES * bitmapProperties,
     _Outptr_ ID2D1Bitmap ** bitmap) PURE;
    ...
    (ID2D1RenderTarget * This, _In_opt_ ID2D1Bitmap * bitmap, _In_opt_ CONST D2D1_BITMAP_BRUSH_PROPERTIES * bitmapBrushProperties,
     _In_opt_ CONST D2D1_BRUSH_PROPERTIES * brushProperties, _Outptr_ ID2D1BitmapBrush ** bitmapBrush) PURE;

    STDMETHOD(CreateSolidColorBrush)
    (ID2D1RenderTarget * This, _In_ CONST D2D1_COLOR_F * color, _In_opt_ CONST D2D1_BRUSH_PROPERTIES * brushProperties,
     _Outptr_ ID2D1SolidColorBrush ** solidColorBrush) PURE;

    STDMETHOD(CreateGradientStopCollection)
    (ID2D1RenderTarget * This, _In_reads_(gradientStopsCount) CONST D2D1_GRADIENT_STOP * gradientStops, _In_range_(>=, 1) UINT32 gradientStopsCount,
     D2D1_GAMMA colorInterpolationGamma, D2D1_EXTEND_MODE extendMode, _Outptr_ ID2D1GradientStopCollection ** gradientStopCollection) PURE;

    STDMETHOD(CreateLinearGradientBrush)
    (ID2D1RenderTarget * This, _In_ CONST D2D1_LINEAR_GRADIENT_BRUSH_PROPERTIES * linearGradientBrushProperties,
     _In_opt_ CONST D2D1_BRUSH_PROPERTIES * brushProperties, _In_ ID2D1GradientStopCollection * gradientStopCollection,
     _Outptr_ ID2D1LinearGradientBrush ** linearGradientBrush) PURE;

    STDMETHOD(CreateRadialGradientBrush)
    (ID2D1RenderTarget * This, _In_ CONST D2D1_RADIAL_GRADIENT_BRUSH_PROPERTIES * radialGradientBrushProperties,
     _In_opt_ CONST D2D1_BRUSH_PROPERTIES * brushProperties, _In_ ID2D1GradientStopCollection * gradientStopCollection,
     _Outptr_ ID2D1RadialGradientBrush ** radialGradientBrush) PURE;
    ...
    STDMETHOD_(void, DrawEllipse)
    (ID2D1RenderTarget * This, _In_ CONST D2D1_ELLIPSE * ellipse, _In_ ID2D1Brush * brush, FLOAT strokeWidth, _In_opt_ ID2D1StrokeStyle * strokeStyle) PURE;

    STDMETHOD_(void, FillEllipse)(ID2D1RenderTarget * This, _In_ CONST D2D1_ELLIPSE * ellipse, _In_ ID2D1Brush * brush) PURE;

    STDMETHOD_(void, DrawGeometry)
    (ID2D1RenderTarget * This, _In_ ID2D1Geometry * geometry, _In_ ID2D1Brush * brush, FLOAT strokeWidth, _In_opt_ ID2D1StrokeStyle * strokeStyle) PURE;

    STDMETHOD_(void, FillGeometry)(ID2D1RenderTarget * This, _In_ ID2D1Geometry * geometry, _In_ ID2D1Brush * brush, _In_opt_ ID2D1Brush * opacityBrush) PURE;

    STDMETHOD_(void, FillMesh)(ID2D1RenderTarget * This, _In_ ID2D1Mesh * mesh, _In_ ID2D1Brush * brush) PURE;

    STDMETHOD_(void, FillOpacityMask)
    (ID2D1RenderTarget * This, _In_ ID2D1Bitmap * opacityMask, _In_ ID2D1Brush * brush, D2D1_OPACITY_MASK_CONTENT content,
     _In_opt_ CONST D2D1_RECT_F * destinationRectangle, _In_opt_ CONST D2D1_RECT_F * sourceRectangle) PURE;

    STDMETHOD_(void, DrawBitmap)
    (ID2D1RenderTarget * This, _In_ ID2D1Bitmap * bitmap, _In_opt_ CONST D2D1_RECT_F * destinationRectangle, FLOAT opacity,
     D2D1_BITMAP_INTERPOLATION_MODE interpolationMode, _In_opt_ CONST D2D1_RECT_F * sourceRectangle) PURE;

    STDMETHOD_(void, DrawText)
    (ID2D1RenderTarget * This, _In_reads_(stringLength) CONST WCHAR * string, UINT32 stringLength, _In_ IDWriteTextFormat * textFormat,
     _In_ CONST D2D1_RECT_F * layoutRect, _In_ ID2D1Brush * defaultForegroundBrush, D2D1_DRAW_TEXT_OPTIONS options, DWRITE_MEASURING_MODE measuringMode) PURE;

    STDMETHOD_(void, DrawTextLayout)
    (ID2D1RenderTarget * This, D2D1_POINT_2F origin, _In_ IDWriteTextLayout * textLayout, _In_ ID2D1Brush * defaultForegroundBrush,
     D2D1_DRAW_TEXT_OPTIONS options) PURE;

    STDMETHOD_(void, DrawGlyphRun)
    (ID2D1RenderTarget * This, D2D1_POINT_2F baselineOrigin, _In_ CONST DWRITE_GLYPH_RUN * glyphRun, _In_ ID2D1Brush * foregroundBrush,
     DWRITE_MEASURING_MODE measuringMode) PURE;

    STDMETHOD_(void, SetTransform)(ID2D1RenderTarget * This, _In_ CONST D2D1_MATRIX_3X2_F * transform) PURE;

    STDMETHOD_(void, GetTransform)(ID2D1RenderTarget * This, _Out_ D2D1_MATRIX_3X2_F * transform) PURE;
    ...
    STDMETHOD_(void, SetTextRenderingParams)(ID2D1RenderTarget * This, _In_opt_ IDWriteRenderingParams * textRenderingParams) PURE;

    STDMETHOD_(void, GetTextRenderingParams)(ID2D1RenderTarget * This, _Outptr_result_maybenull_ IDWriteRenderingParams ** textRenderingParams) PURE;

    STDMETHOD_(void, SetTags)(ID2D1RenderTarget * This, D2D1_TAG tag1, D2D1_TAG tag2) PURE;

    STDMETHOD_(void, GetTags)(ID2D1RenderTarget * This, _Out_opt_ D2D1_TAG * tag1, _Out_opt_ D2D1_TAG * tag2) PURE;

    STDMETHOD_(void, PushLayer)(ID2D1RenderTarget * This, _In_ CONST D2D1_LAYER_PARAMETERS * layerParameters, _In_opt_ ID2D1Layer * layer) PURE;

    STDMETHOD_(void, PopLayer)(ID2D1RenderTarget * This) PURE;

    STDMETHOD(Flush)(ID2D1RenderTarget * This, _Out_opt_ D2D1_TAG * tag1, _Out_opt_ D2D1_TAG * tag2) PURE;

    STDMETHOD_(void, SaveDrawingState)(ID2D1RenderTarget * This, _Inout_ ID2D1DrawingStateBlock * drawingStateBlock) PURE;

    STDMETHOD_(void, RestoreDrawingState)(ID2D1RenderTarget * This, _In_ ID2D1DrawingStateBlock * drawingStateBlock) PURE;

    STDMETHOD_(void, PushAxisAlignedClip)(ID2D1RenderTarget * This, _In_ CONST D2D1_RECT_F * clipRect, D2D1_ANTIALIAS_MODE antialiasMode) PURE;

    STDMETHOD_(void, PopAxisAlignedClip)(ID2D1RenderTarget * This) PURE;

    STDMETHOD_(void, Clear)(ID2D1RenderTarget * This, _In_opt_ CONST D2D1_COLOR_F * clearColor) PURE;

    STDMETHOD_(void, BeginDraw)(ID2D1RenderTarget * This) PURE;

    STDMETHOD(EndDraw)(ID2D1RenderTarget * This, _Out_opt_ D2D1_TAG * tag1, _Out_opt_ D2D1_TAG * tag2) PURE;
    ...
    STDMETHOD_(void, GetDpi)(ID2D1RenderTarget * This, _Out_ FLOAT * dpiX, _Out_ FLOAT * dpiY) PURE;
...
interface ID2D1RenderTarget {
    CONST struct ID2D1RenderTargetVtbl * lpVtbl;
            ...
            #define ID2D1RenderTarget_GetFactory(This, factory) ((This)->lpVtbl->Base.GetFactory((ID2D1Resource *) This, factory))
            ...
            #define ID2D1RenderTarget_CreateGradientStopCollection(This, gradientStops, gradientStopsCount, colorInterpolationGamma, extendMode, \
                                                                   gradientStopCollection)                                                       \
                ((This)->lpVtbl->CreateGradientStopCollection(This, gradientStops, gradientStopsCount, colorInterpolationGamma, extendMode,      \
                                                              gradientStopCollection))

            #define ID2D1RenderTarget_CreateLinearGradientBrush(This, linearGradientBrushProperties, brushProperties, gradientStopCollection, \
                                                                linearGradientBrush)                                                          \
            ...
            #define ID2D1RenderTarget_CreateRadialGradientBrush(This, radialGradientBrushProperties, brushProperties, gradientStopCollection, \
                                                                radialGradientBrush)                                                          \
            ...
            #define ID2D1RenderTarget_FillRoundedRectangle(This, roundedRect, brush) ((This)->lpVtbl->FillRoundedRectangle(This, roundedRect, brush))
            ...
            #define ID2D1RenderTarget_FillGeometry(This, geometry, brush, opacityBrush) ((This)->lpVtbl->FillGeometry(This, geometry, brush, opacityBrush))
            ...
            #define ID2D1RenderTarget_SetAntialiasMode(This, antialiasMode) ((This)->lpVtbl->SetAntialiasMode(This, antialiasMode))

            #define ID2D1RenderTarget_GetAntialiasMode(This) ((This)->lpVtbl->GetAntialiasMode(This))

            #define ID2D1RenderTarget_SetTextAntialiasMode(This, textAntialiasMode) ((This)->lpVtbl->SetTextAntialiasMode(This, textAntialiasMode))

            #define ID2D1RenderTarget_GetTextAntialiasMode(This) ((This)->lpVtbl->GetTextAntialiasMode(This))

            #define ID2D1RenderTarget_SetTextRenderingParams(This, textRenderingParams) ((This)->lpVtbl->SetTextRenderingParams(This, textRenderingParams))

            #define ID2D1RenderTarget_GetTextRenderingParams(This, textRenderingParams) ((This)->lpVtbl->GetTextRenderingParams(This, textRenderingParams))
            ...
            #define ID2D1RenderTarget_PushLayer(This, layerParameters, layer) ((This)->lpVtbl->PushLayer(This, layerParameters, layer))
            ...
            #define ID2D1RenderTarget_SaveDrawingState(This, drawingStateBlock) ((This)->lpVtbl->SaveDrawingState(This, drawingStateBlock))

            #define ID2D1RenderTarget_RestoreDrawingState(This, drawingStateBlock) ((This)->lpVtbl->RestoreDrawingState(This, drawingStateBlock))

            #define ID2D1RenderTarget_PushAxisAlignedClip(This, clipRect, antialiasMode) ((This)->lpVtbl->PushAxisAlignedClip(This, clipRect, antialiasMode))

            #define ID2D1RenderTarget_PopAxisAlignedClip(This) ((This)->lpVtbl->PopAxisAlignedClip(This))

            #define ID2D1RenderTarget_Clear(This, clearColor) ((This)->lpVtbl->Clear(This, clearColor))
            ...
            #define ID2D1RenderTarget_SetDpi(This, dpiX, dpiY) ((This)->lpVtbl->SetDpi(This, dpiX, dpiY))

            #define ID2D1RenderTarget_GetDpi(This, dpiX, dpiY) ((This)->lpVtbl->GetDpi(This, dpiX, dpiY))
            ...
            #define ID2D1RenderTarget_IsSupported(This, renderTargetProperties) ((This)->lpVtbl->IsSupported(This, renderTargetProperties))
...
interface ID2D1BitmapRenderTarget {
    CONST struct ID2D1BitmapRenderTargetVtbl * lpVtbl;
            ...
            #define ID2D1BitmapRenderTarget_GetFactory(This, factory) ((This)->lpVtbl->Base.Base.GetFactory((ID2D1Resource *) This, factory))
            ...
            #define ID2D1BitmapRenderTarget_CreateGradientStopCollection(This, gradientStops, gradientStopsCount, colorInterpolationGamma, extendMode,     \
                                                                         gradientStopCollection)                                                           \
            ...
            #define ID2D1BitmapRenderTarget_CreateRadialGradientBrush(This, radialGradientBrushProperties, brushProperties, gradientStopCollection, \
                                                                      radialGradientBrush)                                                          \
            ...
            #define ID2D1BitmapRenderTarget_CreateLayer(This, size, layer) ((This)->lpVtbl->Base.CreateLayer((ID2D1RenderTarget *) This, size, layer))

            #define ID2D1BitmapRenderTarget_CreateMesh(This, mesh) ((This)->lpVtbl->Base.CreateMesh((ID2D1RenderTarget *) This, mesh))
            ...
            #define ID2D1BitmapRenderTarget_FillRectangle(This, rect, brush) ((This)->lpVtbl->Base.FillRectangle((ID2D1RenderTarget *) This, rect, brush))
            ...
            #define ID2D1BitmapRenderTarget_FillEllipse(This, ellipse, brush) ((This)->lpVtbl->Base.FillEllipse((ID2D1RenderTarget *) This, ellipse, brush))
            ...
            #define ID2D1BitmapRenderTarget_FillMesh(This, mesh, brush) ((This)->lpVtbl->Base.FillMesh((ID2D1RenderTarget *) This, mesh, brush))
            ...
            #define ID2D1BitmapRenderTarget_SetTransform(This, transform) ((This)->lpVtbl->Base.SetTransform((ID2D1RenderTarget *) This, transform))

            #define ID2D1BitmapRenderTarget_GetTransform(This, transform) ((This)->lpVtbl->Base.GetTransform((ID2D1RenderTarget *) This, transform))
            ...
            #define ID2D1BitmapRenderTarget_SetTags(This, tag1, tag2) ((This)->lpVtbl->Base.SetTags((ID2D1RenderTarget *) This, tag1, tag2))

            #define ID2D1BitmapRenderTarget_GetTags(This, tag1, tag2) ((This)->lpVtbl->Base.GetTags((ID2D1RenderTarget *) This, tag1, tag2))
            ...
            #define ID2D1BitmapRenderTarget_Flush(This, tag1, tag2) ((This)->lpVtbl->Base.Flush((ID2D1RenderTarget *) This, tag1, tag2))
            ...
            #define ID2D1BitmapRenderTarget_Clear(This, clearColor) ((This)->lpVtbl->Base.Clear((ID2D1RenderTarget *) This, clearColor))

            #define ID2D1BitmapRenderTarget_BeginDraw(This) ((This)->lpVtbl->Base.BeginDraw((ID2D1RenderTarget *) This))

            #define ID2D1BitmapRenderTarget_EndDraw(This, tag1, tag2) ((This)->lpVtbl->Base.EndDraw((ID2D1RenderTarget *) This, tag1, tag2))

            #define ID2D1BitmapRenderTarget_GetPixelFormat(This) ((This)->lpVtbl->Base.GetPixelFormat((ID2D1RenderTarget *) This))

            #define ID2D1BitmapRenderTarget_SetDpi(This, dpiX, dpiY) ((This)->lpVtbl->Base.SetDpi((ID2D1RenderTarget *) This, dpiX, dpiY))

            #define ID2D1BitmapRenderTarget_GetDpi(This, dpiX, dpiY) ((This)->lpVtbl->Base.GetDpi((ID2D1RenderTarget *) This, dpiX, dpiY))
...
typedef struct ID2D1HwndRenderTargetVtbl {
    ...
    STDMETHOD(Resize)(ID2D1HwndRenderTarget * This, _In_ CONST D2D1_SIZE_U * pixelSize) PURE;
...
interface ID2D1HwndRenderTarget {
    CONST struct ID2D1HwndRenderTargetVtbl * lpVtbl;
            ...
            #define ID2D1HwndRenderTarget_GetFactory(This, factory) ((This)->lpVtbl->Base.Base.GetFactory((ID2D1Resource *) This, factory))
            ...
            #define ID2D1HwndRenderTarget_CreateGradientStopCollection(This, gradientStops, gradientStopsCount, colorInterpolationGamma, extendMode,       \
                                                                       gradientStopCollection)                                                             \
                ((This)->lpVtbl->Base.CreateGradientStopCollection((ID2D1RenderTarget *) This, gradientStops, gradientStopsCount, colorInterpolationGamma, \
                                                                   extendMode, gradientStopCollection))

            #define ID2D1HwndRenderTarget_CreateLinearGradientBrush(This, linearGradientBrushProperties, brushProperties, gradientStopCollection, \
                                                                    linearGradientBrush)                                                          \
                ((This)->lpVtbl->Base.CreateLinearGradientBrush((ID2D1RenderTarget *) This, linearGradientBrushProperties, brushProperties,       \
                                                                gradientStopCollection, linearGradientBrush))

            #define ID2D1HwndRenderTarget_CreateRadialGradientBrush(This, radialGradientBrushProperties, brushProperties, gradientStopCollection, \
                                                                    radialGradientBrush)                                                          \
                ((This)->lpVtbl->Base.CreateRadialGradientBrush((ID2D1RenderTarget *) This, radialGradientBrushProperties, brushProperties,       \
                                                                gradientStopCollection, radialGradientBrush))
            ...
            #define ID2D1HwndRenderTarget_CreateLayer(This, size, layer) ((This)->lpVtbl->Base.CreateLayer((ID2D1RenderTarget *) This, size, layer))

            #define ID2D1HwndRenderTarget_CreateMesh(This, mesh) ((This)->lpVtbl->Base.CreateMesh((ID2D1RenderTarget *) This, mesh))
            ...
            #define ID2D1HwndRenderTarget_FillRectangle(This, rect, brush) ((This)->lpVtbl->Base.FillRectangle((ID2D1RenderTarget *) This, rect, brush))
            ...
            #define ID2D1HwndRenderTarget_FillEllipse(This, ellipse, brush) ((This)->lpVtbl->Base.FillEllipse((ID2D1RenderTarget *) This, ellipse, brush))
            ...
            #define ID2D1HwndRenderTarget_FillMesh(This, mesh, brush) ((This)->lpVtbl->Base.FillMesh((ID2D1RenderTarget *) This, mesh, brush))
            ...
            #define ID2D1HwndRenderTarget_SetTransform(This, transform) ((This)->lpVtbl->Base.SetTransform((ID2D1RenderTarget *) This, transform))

            #define ID2D1HwndRenderTarget_GetTransform(This, transform) ((This)->lpVtbl->Base.GetTransform((ID2D1RenderTarget *) This, transform))
            ...
            #define ID2D1HwndRenderTarget_SetTags(This, tag1, tag2) ((This)->lpVtbl->Base.SetTags((ID2D1RenderTarget *) This, tag1, tag2))

            #define ID2D1HwndRenderTarget_GetTags(This, tag1, tag2) ((This)->lpVtbl->Base.GetTags((ID2D1RenderTarget *) This, tag1, tag2))
            ...
            #define ID2D1HwndRenderTarget_Flush(This, tag1, tag2) ((This)->lpVtbl->Base.Flush((ID2D1RenderTarget *) This, tag1, tag2))
            ...
            #define ID2D1HwndRenderTarget_Clear(This, clearColor) ((This)->lpVtbl->Base.Clear((ID2D1RenderTarget *) This, clearColor))

            #define ID2D1HwndRenderTarget_BeginDraw(This) ((This)->lpVtbl->Base.BeginDraw((ID2D1RenderTarget *) This))

            #define ID2D1HwndRenderTarget_EndDraw(This, tag1, tag2) ((This)->lpVtbl->Base.EndDraw((ID2D1RenderTarget *) This, tag1, tag2))

            #define ID2D1HwndRenderTarget_GetPixelFormat(This) ((This)->lpVtbl->Base.GetPixelFormat((ID2D1RenderTarget *) This))

            #define ID2D1HwndRenderTarget_SetDpi(This, dpiX, dpiY) ((This)->lpVtbl->Base.SetDpi((ID2D1RenderTarget *) This, dpiX, dpiY))

            #define ID2D1HwndRenderTarget_GetDpi(This, dpiX, dpiY) ((This)->lpVtbl->Base.GetDpi((ID2D1RenderTarget *) This, dpiX, dpiY))
            ...
            #define ID2D1HwndRenderTarget_Resize(This, pixelSize) ((This)->lpVtbl->Resize(This, pixelSize))
...
typedef struct ID2D1GdiInteropRenderTargetVtbl {
    ...
    STDMETHOD(GetDC)(ID2D1GdiInteropRenderTarget * This, D2D1_DC_INITIALIZE_MODE mode, _Out_ HDC * hdc) PURE;
...
interface ID2D1GdiInteropRenderTarget {
    CONST struct ID2D1GdiInteropRenderTargetVtbl * lpVtbl;
            ...
            #define ID2D1GdiInteropRenderTarget_GetDC(This, mode, hdc) ((This)->lpVtbl->GetDC(This, mode, hdc))
...
interface ID2D1DCRenderTarget {
    CONST struct ID2D1DCRenderTargetVtbl * lpVtbl;
            ...
            #define ID2D1DCRenderTarget_GetFactory(This, factory) ((This)->lpVtbl->Base.Base.GetFactory((ID2D1Resource *) This, factory))
            ...
            #define ID2D1DCRenderTarget_CreateGradientStopCollection(This, gradientStops, gradientStopsCount, colorInterpolationGamma, extendMode,         \
                                                                     gradientStopCollection)                                                               \
                ((This)->lpVtbl->Base.CreateGradientStopCollection((ID2D1RenderTarget *) This, gradientStops, gradientStopsCount, colorInterpolationGamma, \
                                                                   extendMode, gradientStopCollection))

            #define ID2D1DCRenderTarget_CreateLinearGradientBrush(This, linearGradientBrushProperties, brushProperties, gradientStopCollection, \
                                                                  linearGradientBrush)                                                          \
                ((This)->lpVtbl->Base.CreateLinearGradientBrush((ID2D1RenderTarget *) This, linearGradientBrushProperties, brushProperties,     \
                                                                gradientStopCollection, linearGradientBrush))

            #define ID2D1DCRenderTarget_CreateRadialGradientBrush(This, radialGradientBrushProperties, brushProperties, gradientStopCollection, \
                                                                  radialGradientBrush)                                                          \
                ((This)->lpVtbl->Base.CreateRadialGradientBrush((ID2D1RenderTarget *) This, radialGradientBrushProperties, brushProperties,     \
                                                                gradientStopCollection, radialGradientBrush))
            ...
            #define ID2D1DCRenderTarget_CreateLayer(This, size, layer) ((This)->lpVtbl->Base.CreateLayer((ID2D1RenderTarget *) This, size, layer))

            #define ID2D1DCRenderTarget_CreateMesh(This, mesh) ((This)->lpVtbl->Base.CreateMesh((ID2D1RenderTarget *) This, mesh))
            ...
            #define ID2D1DCRenderTarget_FillRectangle(This, rect, brush) ((This)->lpVtbl->Base.FillRectangle((ID2D1RenderTarget *) This, rect, brush))
            ...
            #define ID2D1DCRenderTarget_FillEllipse(This, ellipse, brush) ((This)->lpVtbl->Base.FillEllipse((ID2D1RenderTarget *) This, ellipse, brush))
            ...
            #define ID2D1DCRenderTarget_FillMesh(This, mesh, brush) ((This)->lpVtbl->Base.FillMesh((ID2D1RenderTarget *) This, mesh, brush))
            ...
            #define ID2D1DCRenderTarget_SetTransform(This, transform) ((This)->lpVtbl->Base.SetTransform((ID2D1RenderTarget *) This, transform))

            #define ID2D1DCRenderTarget_GetTransform(This, transform) ((This)->lpVtbl->Base.GetTransform((ID2D1RenderTarget *) This, transform))

            #define ID2D1DCRenderTarget_SetAntialiasMode(This, antialiasMode) ((This)->lpVtbl->Base.SetAntialiasMode((ID2D1RenderTarget *) This, antialiasMode))
            ...
            #define ID2D1DCRenderTarget_SetTags(This, tag1, tag2) ((This)->lpVtbl->Base.SetTags((ID2D1RenderTarget *) This, tag1, tag2))

            #define ID2D1DCRenderTarget_GetTags(This, tag1, tag2) ((This)->lpVtbl->Base.GetTags((ID2D1RenderTarget *) This, tag1, tag2))
            ...
            #define ID2D1DCRenderTarget_Flush(This, tag1, tag2) ((This)->lpVtbl->Base.Flush((ID2D1RenderTarget *) This, tag1, tag2))
            ...
            #define ID2D1DCRenderTarget_Clear(This, clearColor) ((This)->lpVtbl->Base.Clear((ID2D1RenderTarget *) This, clearColor))

            #define ID2D1DCRenderTarget_BeginDraw(This) ((This)->lpVtbl->Base.BeginDraw((ID2D1RenderTarget *) This))

            #define ID2D1DCRenderTarget_EndDraw(This, tag1, tag2) ((This)->lpVtbl->Base.EndDraw((ID2D1RenderTarget *) This, tag1, tag2))

            #define ID2D1DCRenderTarget_GetPixelFormat(This) ((This)->lpVtbl->Base.GetPixelFormat((ID2D1RenderTarget *) This))

            #define ID2D1DCRenderTarget_SetDpi(This, dpiX, dpiY) ((This)->lpVtbl->Base.SetDpi((ID2D1RenderTarget *) This, dpiX, dpiY))

            #define ID2D1DCRenderTarget_GetDpi(This, dpiX, dpiY) ((This)->lpVtbl->Base.GetDpi((ID2D1RenderTarget *) This, dpiX, dpiY))
            ...
            #define ID2D1DCRenderTarget_BindDC(This, hDC, pSubRect) ((This)->lpVtbl->BindDC(This, hDC, pSubRect))
...
typedef struct ID2D1FactoryVtbl {
    ...
    STDMETHOD_(void, GetDesktopDpi)(ID2D1Factory * This, _Out_ FLOAT * dpiX, _Out_ FLOAT * dpiY) PURE;

    STDMETHOD(CreateRectangleGeometry)(ID2D1Factory * This, _In_ CONST D2D1_RECT_F * rectangle, _Outptr_ ID2D1RectangleGeometry ** rectangleGeometry) PURE;

    STDMETHOD(CreateRoundedRectangleGeometry)
    (ID2D1Factory * This, _In_ CONST D2D1_ROUNDED_RECT * roundedRectangle, _Outptr_ ID2D1RoundedRectangleGeometry ** roundedRectangleGeometry) PURE;

    STDMETHOD(CreateEllipseGeometry)(ID2D1Factory * This, _In_ CONST D2D1_ELLIPSE * ellipse, _Outptr_ ID2D1EllipseGeometry ** ellipseGeometry) PURE;

    STDMETHOD(CreateGeometryGroup)
    (ID2D1Factory * This, D2D1_FILL_MODE fillMode, _In_reads_(geometriesCount) ID2D1Geometry ** geometries, UINT32 geometriesCount,
     _Outptr_ ID2D1GeometryGroup ** geometryGroup) PURE;

    STDMETHOD(CreateTransformedGeometry)
    (ID2D1Factory * This, _In_ ID2D1Geometry * sourceGeometry, _In_ CONST D2D1_MATRIX_3X2_F * transform,
     _Outptr_ ID2D1TransformedGeometry ** transformedGeometry) PURE;

    STDMETHOD(CreatePathGeometry)(ID2D1Factory * This, _Outptr_ ID2D1PathGeometry ** pathGeometry) PURE;

    STDMETHOD(CreateStrokeStyle)
    (ID2D1Factory * This, _In_ CONST D2D1_STROKE_STYLE_PROPERTIES * strokeStyleProperties, _In_reads_opt_(dashesCount) CONST FLOAT * dashes, UINT32 dashesCount,
     _Outptr_ ID2D1StrokeStyle ** strokeStyle) PURE;

    STDMETHOD(CreateDrawingStateBlock)
    (ID2D1Factory * This, _In_opt_ CONST D2D1_DRAWING_STATE_DESCRIPTION * drawingStateDescription, _In_opt_ IDWriteRenderingParams * textRenderingParams,
     _Outptr_ ID2D1DrawingStateBlock ** drawingStateBlock) PURE;

    STDMETHOD(CreateWicBitmapRenderTarget)
    (ID2D1Factory * This, _In_ IWICBitmap * target, _In_ CONST D2D1_RENDER_TARGET_PROPERTIES * renderTargetProperties,
     _Outptr_ ID2D1RenderTarget ** renderTarget) PURE;

    STDMETHOD(CreateHwndRenderTarget)
    (ID2D1Factory * This, _In_ CONST D2D1_RENDER_TARGET_PROPERTIES * renderTargetProperties,
     _In_ CONST D2D1_HWND_RENDER_TARGET_PROPERTIES * hwndRenderTargetProperties, _Outptr_ ID2D1HwndRenderTarget ** hwndRenderTarget) PURE;

    STDMETHOD(CreateDxgiSurfaceRenderTarget)
    (ID2D1Factory * This, _In_ IDXGISurface * dxgiSurface, _In_ CONST D2D1_RENDER_TARGET_PROPERTIES * renderTargetProperties,
     _Outptr_ ID2D1RenderTarget ** renderTarget) PURE;
...
interface ID2D1Factory {
    CONST struct ID2D1FactoryVtbl * lpVtbl;
            ...
            #define ID2D1Factory_GetDesktopDpi(This, dpiX, dpiY) ((This)->lpVtbl->GetDesktopDpi(This, dpiX, dpiY))
            ...
            #define ID2D1Factory_CreateEllipseGeometry(This, ellipse, ellipseGeometry) ((This)->lpVtbl->CreateEllipseGeometry(This, ellipse, ellipseGeometry))
            ...
            #define ID2D1Factory_CreatePathGeometry(This, pathGeometry) ((This)->lpVtbl->CreatePathGeometry(This, pathGeometry))
...
//
HRESULT WINAPI D2D1CreateFactory(_In_ D2D1_FACTORY_TYPE factoryType, _In_ REFIID riid, _In_opt_ CONST D2D1_FACTORY_OPTIONS * pFactoryOptions,
...
inline HRESULT D2D1CreateFactory(_In_ D2D1_FACTORY_TYPE factoryType, _In_ REFIID riid, _Out_ void ** factory) {
    return D2D1CreateFactory(factoryType, riid, NULL, factory);
}

template<class Factory>
HRESULT D2D1CreateFactory(_In_ D2D1_FACTORY_TYPE factoryType, _Out_ Factory ** factory) {
    return D2D1CreateFactory(factoryType, __uuidof(Factory), reinterpret_cast<void **>(factory));
}

template<class Factory>
HRESULT D2D1CreateFactory(_In_ D2D1_FACTORY_TYPE factoryType, _In_ CONST D2D1_FACTORY_OPTIONS & factoryOptions, _Out_ Factory ** ppFactory) {
    return D2D1CreateFactory(factoryType, __uuidof(Factory), &factoryOptions, reinterpret_cast<void **>(ppFactory));
}
