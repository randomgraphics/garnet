...
interface DX_DECLARE_INTERFACE("82237326-8111-4f7c-bcf4-b5c1175564fe") ID2D1GdiMetafileSink : public IUnknown {
    ...
    //
    STDMETHOD(ProcessRecord)(DWORD recordType, _In_opt_ CONST void * recordData, DWORD recordDataSize) PURE;
...
interface DX_DECLARE_INTERFACE("2f543dc3-cfc1-4211-864f-cfd91c6f3395") ID2D1GdiMetafile : public ID2D1Resource {
    ...
    //
    STDMETHOD(Stream)(_In_ ID2D1GdiMetafileSink * sink) PURE;

    //
    // Gets the bounds of the metafile.
    //
    STDMETHOD(GetBounds)(_Out_ D2D1_RECT_F * bounds) PURE;
...
interface DX_DECLARE_INTERFACE("54d7898a-a061-40a7-bec7-e465bcba2c4f") ID2D1CommandSink : public IUnknown {
    ...
    STDMETHOD(SetTextRenderingParams)(_In_opt_ IDWriteRenderingParams * textRenderingParams) PURE;

    STDMETHOD(SetTransform)(_In_ CONST D2D1_MATRIX_3X2_F * transform) PURE;

    STDMETHOD(SetPrimitiveBlend)(D2D1_PRIMITIVE_BLEND primitiveBlend) PURE;

    STDMETHOD(SetUnitMode)(D2D1_UNIT_MODE unitMode) PURE;

    STDMETHOD(Clear)(_In_opt_ CONST D2D1_COLOR_F * color) PURE;

    STDMETHOD(DrawGlyphRun)
    (D2D1_POINT_2F baselineOrigin, _In_ CONST DWRITE_GLYPH_RUN * glyphRun, _In_opt_ CONST DWRITE_GLYPH_RUN_DESCRIPTION * glyphRunDescription,
     _In_ ID2D1Brush * foregroundBrush, DWRITE_MEASURING_MODE measuringMode) PURE;

    STDMETHOD(DrawLine)(D2D1_POINT_2F point0, D2D1_POINT_2F point1, _In_ ID2D1Brush * brush, FLOAT strokeWidth, _In_opt_ ID2D1StrokeStyle * strokeStyle) PURE;

    STDMETHOD(DrawGeometry)(_In_ ID2D1Geometry * geometry, _In_ ID2D1Brush * brush, FLOAT strokeWidth, _In_opt_ ID2D1StrokeStyle * strokeStyle) PURE;

    STDMETHOD(DrawRectangle)(_In_ CONST D2D1_RECT_F * rect, _In_ ID2D1Brush * brush, FLOAT strokeWidth, _In_opt_ ID2D1StrokeStyle * strokeStyle) PURE;

    STDMETHOD(DrawBitmap)
    (_In_ ID2D1Bitmap * bitmap, _In_opt_ CONST D2D1_RECT_F * destinationRectangle, FLOAT opacity, D2D1_INTERPOLATION_MODE interpolationMode,
     _In_opt_ CONST D2D1_RECT_F * sourceRectangle, _In_opt_ CONST D2D1_MATRIX_4X4_F * perspectiveTransform) PURE;

    STDMETHOD(DrawImage)
    (_In_ ID2D1Image * image, _In_opt_ CONST D2D1_POINT_2F * targetOffset, _In_opt_ CONST D2D1_RECT_F * imageRectangle,
     D2D1_INTERPOLATION_MODE interpolationMode, D2D1_COMPOSITE_MODE compositeMode) PURE;

    STDMETHOD(DrawGdiMetafile)(_In_ ID2D1GdiMetafile * gdiMetafile, _In_opt_ CONST D2D1_POINT_2F * targetOffset) PURE;

    STDMETHOD(FillMesh)(_In_ ID2D1Mesh * mesh, _In_ ID2D1Brush * brush) PURE;

    STDMETHOD(FillOpacityMask)
    (_In_ ID2D1Bitmap * opacityMask, _In_ ID2D1Brush * brush, _In_opt_ CONST D2D1_RECT_F * destinationRectangle, _In_opt_ CONST D2D1_RECT_F * sourceRectangle)
        PURE;

    STDMETHOD(FillGeometry)(_In_ ID2D1Geometry * geometry, _In_ ID2D1Brush * brush, _In_opt_ ID2D1Brush * opacityBrush) PURE;

    STDMETHOD(FillRectangle)(_In_ CONST D2D1_RECT_F * rect, _In_ ID2D1Brush * brush) PURE;

    STDMETHOD(PushAxisAlignedClip)(_In_ CONST D2D1_RECT_F * clipRect, D2D1_ANTIALIAS_MODE antialiasMode) PURE;

    STDMETHOD(PushLayer)(_In_ CONST D2D1_LAYER_PARAMETERS1 * layerParameters1, _In_opt_ ID2D1Layer * layer) PURE;
...
interface DX_DECLARE_INTERFACE("b4f34a19-2383-4d76-94f6-ec343657c3dc") ID2D1CommandList : public ID2D1Image {
    ...
    //
    STDMETHOD(Stream)(_In_ ID2D1CommandSink * sink) PURE;
...
interface DX_DECLARE_INTERFACE("2c1d867d-c290-41c8-ae7e-34a98702e9a5") ID2D1PrintControl : public IUnknown {
    ...
    STDMETHOD(AddPage)
    (_In_ ID2D1CommandList * commandList, D2D_SIZE_F pageSize, _In_opt_ IStream * pagePrintTicketStream, _Out_opt_ D2D1_TAG * tag1 = NULL,
     _Out_opt_ D2D1_TAG * tag2 = NULL) PURE;
...
interface DX_DECLARE_INTERFACE("fe9e984d-3f95-407c-b5db-cb94d4e8f87c") ID2D1ImageBrush : public ID2D1Brush {
    ...
    STDMETHOD_(void, SetImage)(_In_opt_ ID2D1Image * image) PURE;
    ...
    STDMETHOD_(void, SetSourceRectangle)(_In_ CONST D2D1_RECT_F * sourceRectangle) PURE;

    STDMETHOD_(void, GetImage)(_Outptr_ ID2D1Image * *image) CONST PURE;
    ...
    STDMETHOD_(void, GetSourceRectangle)(_Out_ D2D1_RECT_F * sourceRectangle) CONST PURE;
...
interface DX_DECLARE_INTERFACE("62baa2d2-ab54-41b7-b872-787e0106a421") ID2D1PathGeometry1 : public ID2D1PathGeometry {
    ...
    (FLOAT length, UINT32 startSegment, _In_opt_ CONST D2D1_MATRIX_3X2_F * worldTransform, FLOAT flatteningTolerance,
     _Out_ D2D1_POINT_DESCRIPTION * pointDescription) CONST PURE;

    HRESULT
    ComputePointAndSegmentAtLength(FLOAT length, UINT32 startSegment, CONST D2D1_MATRIX_3X2_F & worldTransform, FLOAT flatteningTolerance,
    ...
    HRESULT
    ComputePointAndSegmentAtLength(FLOAT length, UINT32 startSegment, _In_opt_ CONST D2D1_MATRIX_3X2_F * worldTransform,
                                   _Out_ D2D1_POINT_DESCRIPTION * pointDescription) CONST {
    ...
    HRESULT
    ComputePointAndSegmentAtLength(FLOAT length, UINT32 startSegment, CONST D2D1_MATRIX_3X2_F & worldTransform, _Out_ D2D1_POINT_DESCRIPTION * pointDescription)
        CONST {
        return ComputePointAndSegmentAtLength(length, startSegment, &worldTransform, D2D1_DEFAULT_FLATTENING_TOLERANCE, pointDescription);
    }
...
interface DX_DECLARE_INTERFACE("483473d7-cd46-4f9d-9d3a-3112aa80159d") ID2D1Properties : public IUnknown {
    ...
    //
    STDMETHOD(GetPropertyName)(UINT32 index, _Out_writes_(nameCount) PWSTR name, UINT32 nameCount) CONST PURE;
    ...
    //
    STDMETHOD_(UINT32, GetPropertyIndex)(_In_ PCWSTR name) CONST PURE;

    //
    // Sets the value of the given property using its name.
    //
    STDMETHOD(SetValueByName)(_In_ PCWSTR name, D2D1_PROPERTY_TYPE type, _In_reads_(dataSize) CONST BYTE * data, UINT32 dataSize) PURE;

    //
    // Sets the given value using the property index.
    //
    STDMETHOD(SetValue)(UINT32 index, D2D1_PROPERTY_TYPE type, _In_reads_(dataSize) CONST BYTE * data, UINT32 dataSize) PURE;

    //
    // Retrieves the given property or sub-property by name. '.' is the delimiter for
    // sub-properties.
    //
    STDMETHOD(GetValueByName)(_In_ PCWSTR name, D2D1_PROPERTY_TYPE type, _Out_writes_(dataSize) BYTE * data, UINT32 dataSize) CONST PURE;

    //
    // Retrieves the given value by index.
    //
    STDMETHOD(GetValue)(UINT32 index, D2D1_PROPERTY_TYPE type, _Out_writes_(dataSize) BYTE * data, UINT32 dataSize) CONST PURE;
    ...
    //
    STDMETHOD(GetSubProperties)(UINT32 index, _Outptr_opt_ ID2D1Properties * *subProperties) CONST PURE;

    HRESULT
    SetValueByName(_In_ PCWSTR name, _In_reads_(dataSize) CONST BYTE * data, UINT32 dataSize) {
        return SetValueByName(name, D2D1_PROPERTY_TYPE_UNKNOWN, data, dataSize);
    }

    HRESULT
    SetValue(UINT32 index, _In_reads_(dataSize) CONST BYTE * data, UINT32 dataSize) { return SetValue(index, D2D1_PROPERTY_TYPE_UNKNOWN, data, dataSize); }

    HRESULT
    GetValueByName(_In_ PCWSTR name, _Out_writes_(dataSize) BYTE * data, UINT32 dataSize) CONST {
        return GetValueByName(name, D2D1_PROPERTY_TYPE_UNKNOWN, data, dataSize);
    }

    HRESULT
    GetValue(UINT32 index, _Out_writes_(dataSize) BYTE * data, UINT32 dataSize) CONST { return GetValue(index, D2D1_PROPERTY_TYPE_UNKNOWN, data, dataSize); }

    //
    // Templatized helper functions:
    //
    template<typename T>
    HRESULT GetValueByName(_In_ PCWSTR propertyName, _Out_ T * value) const {
        return GetValueByName(propertyName, reinterpret_cast<BYTE *>(value), sizeof(*value));
    }

    template<typename T>
    T GetValueByName(_In_ PCWSTR propertyName) const {
        T       value;
    ...
    template<typename T>
    HRESULT SetValueByName(_In_ PCWSTR propertyName, _In_ const T & value) {
        return SetValueByName(propertyName, reinterpret_cast<const BYTE *>(&value), sizeof(value));
    }

    template<typename U>
    HRESULT GetValue(U index, _Out_writes_(dataSize) BYTE * data, UINT32 dataSize) CONST {
        return GetValue(static_cast<UINT32>(index), data, dataSize);
    }

    template<typename T, typename U>
    HRESULT GetValue(U index, _Out_ T * value) const {
    ...
    template<typename U>
    HRESULT SetValue(U index, _In_reads_(dataSize) CONST BYTE * data, UINT32 dataSize) {
        return SetValue(static_cast<UINT32>(index), data, dataSize);
    }

    template<typename T, typename U>
    HRESULT SetValue(U index, _In_ const T & value) {
        return SetValue(static_cast<UINT32>(index), reinterpret_cast<const BYTE *>(&value), sizeof(value));
    }

    template<typename U>
    HRESULT GetPropertyName(U index, _Out_writes_(nameCount) PWSTR name, UINT32 nameCount) CONST {
    ...
    template<typename U>
    HRESULT GetSubProperties(U index, _Outptr_opt_ ID2D1Properties * *subProperties) CONST {
...
interface DX_DECLARE_INTERFACE("28211a43-7d89-476f-8181-2d6159b220ad") ID2D1Effect : public ID2D1Properties {
    ...
    //
    STDMETHOD_(void, SetInput)(UINT32 index, _In_opt_ ID2D1Image * input, BOOL invalidate = TRUE) PURE;
    ...
    // bitmap.
    //
    STDMETHOD_(void, GetInput)(UINT32 index, _Outptr_opt_ ID2D1Image * *input) CONST PURE;
    ...
    //
    STDMETHOD_(void, GetOutput)(_Outptr_ ID2D1Image * *outputImage) CONST PURE;

    void SetInputEffect(UINT32 index, _In_opt_ ID2D1Effect * inputEffect, BOOL invalidate = TRUE) {
...
interface DX_DECLARE_INTERFACE("a898a84c-3873-4588-b08b-ebbf978df041") ID2D1Bitmap1 : public ID2D1Bitmap {
    ...
    //
    STDMETHOD_(void, GetColorContext)(_Outptr_result_maybenull_ ID2D1ColorContext * *colorContext) CONST PURE;
    ...
    //
    STDMETHOD(GetSurface)(_Outptr_result_maybenull_ IDXGISurface * *dxgiSurface) CONST PURE;

    //
    // Maps the given bitmap into memory. The bitmap must have been created with the
    // D2D1_BITMAP_OPTIONS_CPU_READ flag.
    //
    STDMETHOD(Map)(D2D1_MAP_OPTIONS options, _Out_ D2D1_MAPPED_RECT * mappedRect) PURE;
...
interface DX_DECLARE_INTERFACE("1c4820bb-5771-4518-a581-2fe4dd0ec657") ID2D1ColorContext : public ID2D1Resource {
    ...
    //
    STDMETHOD(GetProfile)(_Out_writes_(profileSize) BYTE * profile, UINT32 profileSize) CONST PURE;
...
interface DX_DECLARE_INTERFACE("689f1f85-c72e-4e33-8f19-85754efd5ace") ID2D1DrawingStateBlock1 : public ID2D1DrawingStateBlock {
    ...
    //
    STDMETHOD_(void, GetDescription)(_Out_ D2D1_DRAWING_STATE_DESCRIPTION1 * stateDescription) CONST PURE;
    ...
    //
    STDMETHOD_(void, SetDescription)(_In_ CONST D2D1_DRAWING_STATE_DESCRIPTION1 * stateDescription) PURE;
...
interface DX_DECLARE_INTERFACE("e8f7fe7a-191c-466d-ad95-975678bda998") ID2D1DeviceContext : public ID2D1RenderTarget {
    ...
    (D2D1_SIZE_U size, _In_opt_ CONST void * sourceData, UINT32 pitch, _In_ CONST D2D1_BITMAP_PROPERTIES1 * bitmapProperties, _Outptr_ ID2D1Bitmap1 ** bitmap)
        PURE;
    ...
    (_In_ IWICBitmapSource * wicBitmapSource, _In_opt_ CONST D2D1_BITMAP_PROPERTIES1 * bitmapProperties, _Outptr_ ID2D1Bitmap1 * *bitmap) PURE;
    ...
    (_In_ IDXGISurface * surface, _In_opt_ CONST D2D1_BITMAP_PROPERTIES1 * bitmapProperties, _Outptr_ ID2D1Bitmap1 * *bitmap) PURE;
    ...
    (_In_reads_(straightAlphaGradientStopsCount) CONST D2D1_GRADIENT_STOP * straightAlphaGradientStops,
     ...
     // alpha space.
     //
     D2D1_COLOR_INTERPOLATION_MODE colorInterpolationMode, _Outptr_ ID2D1GradientStopCollection1 * *gradientStopCollection1) PURE;
    ...
    (_In_opt_ ID2D1Image * image, _In_ CONST D2D1_IMAGE_BRUSH_PROPERTIES * imageBrushProperties, _In_opt_ CONST D2D1_BRUSH_PROPERTIES * brushProperties,
     _Outptr_ ID2D1ImageBrush * *imageBrush) PURE;

    STDMETHOD(CreateBitmapBrush)
    (_In_opt_ ID2D1Bitmap * bitmap, _In_opt_ CONST D2D1_BITMAP_BRUSH_PROPERTIES1 * bitmapBrushProperties,
     _In_opt_ CONST D2D1_BRUSH_PROPERTIES * brushProperties, _Outptr_ ID2D1BitmapBrush1 * *bitmapBrush) PURE;
    ...
    //
    STDMETHOD(CreateCommandList)(_Outptr_ ID2D1CommandList * *commandList) PURE;
    ...
    // device context DPI.
    //
    STDMETHOD(GetImageLocalBounds)(_In_ ID2D1Image * image, _Out_ D2D1_RECT_F * localBounds) CONST PURE;

    //
    // This retrieves the world-space bounds in DIPs of the current image using the
    // device context DPI.
    //
    STDMETHOD(GetImageWorldBounds)(_In_ ID2D1Image * image, _Out_ D2D1_RECT_F * worldBounds) CONST PURE;
    ...
    (D2D1_POINT_2F baselineOrigin, _In_ CONST DWRITE_GLYPH_RUN * glyphRun, DWRITE_MEASURING_MODE measuringMode, _Out_ D2D1_RECT_F * bounds) CONST PURE;

    //
    // Retrieves the device associated with this device context.
    //
    STDMETHOD_(void, GetDevice)(_Outptr_ ID2D1Device * *device) CONST PURE;
    ...
    // flag.
    //
    STDMETHOD_(void, SetTarget)(_In_opt_ ID2D1Image * image) PURE;

    //
    // Gets the target that this device context is currently pointing to.
    //
    STDMETHOD_(void, GetTarget)(_Outptr_result_maybenull_ ID2D1Image * *image) CONST PURE;

    //
    // Sets tuning parameters for internal rendering inside the device context.
    //
    STDMETHOD_(void, SetRenderingControls)(_In_ CONST D2D1_RENDERING_CONTROLS * renderingControls) PURE;

    //
    // This retrieves the rendering controls currently selected into the device
    // context.
    //
    STDMETHOD_(void, GetRenderingControls)(_Out_ D2D1_RENDERING_CONTROLS * renderingControls) CONST PURE;
    ...
    (D2D1_POINT_2F baselineOrigin, _In_ CONST DWRITE_GLYPH_RUN * glyphRun, _In_opt_ CONST DWRITE_GLYPH_RUN_DESCRIPTION * glyphRunDescription,
     _In_ ID2D1Brush * foregroundBrush, DWRITE_MEASURING_MODE measuringMode = DWRITE_MEASURING_MODE_NATURAL) PURE;
    ...
    (_In_ ID2D1Image * image, _In_opt_ CONST D2D1_POINT_2F * targetOffset = NULL, _In_opt_ CONST D2D1_RECT_F * imageRectangle = NULL,
     D2D1_INTERPOLATION_MODE interpolationMode = D2D1_INTERPOLATION_MODE_LINEAR, D2D1_COMPOSITE_MODE compositeMode = D2D1_COMPOSITE_MODE_SOURCE_OVER) PURE;

    //
    // Draw a metafile to the device context.
    //
    STDMETHOD_(void, DrawGdiMetafile)(_In_ ID2D1GdiMetafile * gdiMetafile, _In_opt_ CONST D2D1_POINT_2F * targetOffset = NULL) PURE;

    STDMETHOD_(void, DrawBitmap)
    (_In_ ID2D1Bitmap * bitmap, _In_opt_ CONST D2D1_RECT_F * destinationRectangle, FLOAT opacity, D2D1_INTERPOLATION_MODE interpolationMode,
     _In_opt_ CONST D2D1_RECT_F * sourceRectangle = NULL, _In_opt_ CONST D2D1_MATRIX_4X4_F * perspectiveTransform = NULL) PURE;
    ...
    //
    STDMETHOD_(void, PushLayer)(_In_ CONST D2D1_LAYER_PARAMETERS1 * layerParameters, _In_opt_ ID2D1Layer * layer) PURE;
    ...
    //
    STDMETHOD(InvalidateEffectInputRectangle)(_In_ ID2D1Effect * effect, UINT32 input, _In_ CONST D2D1_RECT_F * inputRectangle) PURE;

    //
    // Gets the number of invalid ouptut rectangles that have accumulated at the
    // effect.
    //
    STDMETHOD(GetEffectInvalidRectangleCount)(_In_ ID2D1Effect * effect, _Out_ UINT32 * rectangleCount) PURE;

    //
    // Gets the invalid rectangles that are at the output of the effect.
    //
    STDMETHOD(GetEffectInvalidRectangles)(_In_ ID2D1Effect * effect, _Out_writes_(rectanglesCount) D2D1_RECT_F * rectangles, UINT32 rectanglesCount) PURE;
    ...
    (_In_ ID2D1Effect * renderEffect, _In_opt_ CONST D2D1_RECT_F * renderImageRectangle,
     _In_reads_(inputCount) CONST D2D1_EFFECT_INPUT_DESCRIPTION * inputDescriptions, _Out_writes_(inputCount) D2D1_RECT_F * requiredInputRects,
     UINT32 inputCount) PURE;
    ...
    (_In_ ID2D1Bitmap * opacityMask, _In_ ID2D1Brush * brush, _In_opt_ CONST D2D1_RECT_F * destinationRectangle = NULL,
     _In_opt_ CONST D2D1_RECT_F * sourceRectangle = NULL) PURE;

    using ID2D1RenderTarget::FillOpacityMask;

    HRESULT
    CreateBitmap(D2D1_SIZE_U size, _In_opt_ CONST void * sourceData, UINT32 pitch, CONST D2D1_BITMAP_PROPERTIES1 & bitmapProperties,
    ...
    //
    HRESULT
    CreateBitmapFromWicBitmap(_In_ IWICBitmapSource * wicBitmapSource, CONST D2D1_BITMAP_PROPERTIES1 & bitmapProperties, _Outptr_ ID2D1Bitmap1 * *bitmap) {
    ...
    //
    HRESULT
    CreateBitmapFromWicBitmap(_In_ IWICBitmapSource * wicBitmapSource, _Outptr_ ID2D1Bitmap1 * *bitmap) {
        return CreateBitmapFromWicBitmap(wicBitmapSource, NULL, bitmap);
    }

    HRESULT
    CreateBitmapFromDxgiSurface(_In_ IDXGISurface * surface, CONST D2D1_BITMAP_PROPERTIES1 & bitmapProperties, _Outptr_ ID2D1Bitmap1 * *bitmap) {
        return CreateBitmapFromDxgiSurface(surface, &bitmapProperties, bitmap);
    }

    HRESULT
    CreateImageBrush(_In_opt_ ID2D1Image * image, CONST D2D1_IMAGE_BRUSH_PROPERTIES & imageBrushProperties, CONST D2D1_BRUSH_PROPERTIES & brushProperties,
                     _Outptr_ ID2D1ImageBrush * *imageBrush) {
        return CreateImageBrush(image, &imageBrushProperties, &brushProperties, imageBrush);
    }

    HRESULT
    CreateImageBrush(_In_opt_ ID2D1Image * image, CONST D2D1_IMAGE_BRUSH_PROPERTIES & imageBrushProperties, _Outptr_ ID2D1ImageBrush * *imageBrush) {
        return CreateImageBrush(image, &imageBrushProperties, NULL, imageBrush);
    }

    HRESULT
    CreateBitmapBrush(_In_opt_ ID2D1Bitmap * bitmap, _Outptr_ ID2D1BitmapBrush1 * *bitmapBrush) { return CreateBitmapBrush(bitmap, NULL, NULL, bitmapBrush); }

    HRESULT
    CreateBitmapBrush(_In_opt_ ID2D1Bitmap * bitmap, CONST D2D1_BITMAP_BRUSH_PROPERTIES1 & bitmapBrushProperties, _Outptr_ ID2D1BitmapBrush1 * *bitmapBrush) {
        return CreateBitmapBrush(bitmap, &bitmapBrushProperties, NULL, bitmapBrush);
    }

    HRESULT
    CreateBitmapBrush(_In_opt_ ID2D1Bitmap * bitmap, CONST D2D1_BITMAP_BRUSH_PROPERTIES1 & bitmapBrushProperties, CONST D2D1_BRUSH_PROPERTIES & brushProperties,
    ...
    //
    void DrawImage(_In_ ID2D1Effect * effect, _In_opt_ CONST D2D1_POINT_2F * targetOffset = NULL, _In_opt_ CONST D2D1_RECT_F * imageRectangle = NULL,
    ...
    void DrawImage(_In_ ID2D1Image * image, D2D1_INTERPOLATION_MODE interpolationMode, D2D1_COMPOSITE_MODE compositeMode = D2D1_COMPOSITE_MODE_SOURCE_OVER) {
        DrawImage(image, NULL, NULL, interpolationMode, compositeMode);
    }

    void DrawImage(_In_ ID2D1Effect * effect, D2D1_INTERPOLATION_MODE interpolationMode, D2D1_COMPOSITE_MODE compositeMode = D2D1_COMPOSITE_MODE_SOURCE_OVER) {
        DrawImage(effect, NULL, NULL, interpolationMode, compositeMode);
    }

    void DrawImage(_In_ ID2D1Image * image, D2D1_POINT_2F targetOffset, D2D1_INTERPOLATION_MODE interpolationMode = D2D1_INTERPOLATION_MODE_LINEAR,
                   D2D1_COMPOSITE_MODE compositeMode = D2D1_COMPOSITE_MODE_SOURCE_OVER) {
        DrawImage(image, &targetOffset, NULL, interpolationMode, compositeMode);
    }

    void DrawImage(_In_ ID2D1Effect * effect, D2D1_POINT_2F targetOffset, D2D1_INTERPOLATION_MODE interpolationMode = D2D1_INTERPOLATION_MODE_LINEAR,
                   D2D1_COMPOSITE_MODE compositeMode = D2D1_COMPOSITE_MODE_SOURCE_OVER) {
        DrawImage(effect, &targetOffset, NULL, interpolationMode, compositeMode);
    }

    void DrawImage(_In_ ID2D1Image * image, D2D1_POINT_2F targetOffset, CONST D2D1_RECT_F & imageRectangle,
                   D2D1_INTERPOLATION_MODE interpolationMode = D2D1_INTERPOLATION_MODE_LINEAR,
                   D2D1_COMPOSITE_MODE     compositeMode     = D2D1_COMPOSITE_MODE_SOURCE_OVER) {
        DrawImage(image, &targetOffset, &imageRectangle, interpolationMode, compositeMode);
    }

    void DrawImage(_In_ ID2D1Effect * effect, D2D1_POINT_2F targetOffset, CONST D2D1_RECT_F & imageRectangle,
                   D2D1_INTERPOLATION_MODE interpolationMode = D2D1_INTERPOLATION_MODE_LINEAR,
                   D2D1_COMPOSITE_MODE     compositeMode     = D2D1_COMPOSITE_MODE_SOURCE_OVER) {
        DrawImage(effect, &targetOffset, &imageRectangle, interpolationMode, compositeMode);
    }

    void PushLayer(CONST D2D1_LAYER_PARAMETERS1 & layerParameters, _In_opt_ ID2D1Layer * layer) { PushLayer(&layerParameters, layer); }

    void DrawGdiMetafile(_In_ ID2D1GdiMetafile * gdiMetafile, D2D1_POINT_2F targetOffset) { DrawGdiMetafile(gdiMetafile, &targetOffset); }

    void DrawBitmap(_In_ ID2D1Bitmap * bitmap, CONST D2D1_RECT_F & destinationRectangle, FLOAT opacity, D2D1_INTERPOLATION_MODE interpolationMode,
                    _In_opt_ CONST D2D1_RECT_F * sourceRectangle = NULL, _In_opt_ CONST D2D1_MATRIX_4X4_F * perspectiveTransform = NULL) {
        DrawBitmap(bitmap, &destinationRectangle, opacity, interpolationMode, sourceRectangle, perspectiveTransform);
    }

    void DrawBitmap(_In_ ID2D1Bitmap * bitmap, CONST D2D1_RECT_F & destinationRectangle, FLOAT opacity, D2D1_INTERPOLATION_MODE interpolationMode,
                    CONST D2D1_RECT_F & sourceRectangle, _In_opt_ CONST D2D1_MATRIX_4X4_F * perspectiveTransform = NULL) {
        DrawBitmap(bitmap, &destinationRectangle, opacity, interpolationMode, &sourceRectangle, perspectiveTransform);
    }

    void DrawBitmap(_In_ ID2D1Bitmap * bitmap, CONST D2D1_RECT_F & destinationRectangle, FLOAT opacity, D2D1_INTERPOLATION_MODE interpolationMode,
                    CONST D2D1_RECT_F & sourceRectangle, CONST D2D1_MATRIX_4X4_F & perspectiveTransform) {
        DrawBitmap(bitmap, &destinationRectangle, opacity, interpolationMode, &sourceRectangle, &perspectiveTransform);
    }

    void FillOpacityMask(_In_ ID2D1Bitmap * opacityMask, _In_ ID2D1Brush * brush, CONST D2D1_RECT_F & destinationRectangle,
    ...
    // Sets tuning parameters for internal rendering inside the device context.
    //
    void SetRenderingControls(CONST D2D1_RENDERING_CONTROLS & renderingControls) { return SetRenderingControls(&renderingControls); }
...
interface DX_DECLARE_INTERFACE("47dd575d-ac05-4cdd-8049-9b02cd16f44c") ID2D1Device : public ID2D1Resource {
    ...
    //
    STDMETHOD(CreateDeviceContext)(D2D1_DEVICE_CONTEXT_OPTIONS options, _Outptr_ ID2D1DeviceContext * *deviceContext) PURE;

    //
    // Creates a D2D print control.
    //
    STDMETHOD(CreatePrintControl)
    (_In_ IWICImagingFactory * wicFactory, _In_ IPrintDocumentPackageTarget * documentTarget,
     _In_opt_ CONST D2D1_PRINT_CONTROL_PROPERTIES * printControlProperties, _Outptr_ ID2D1PrintControl * *printControl) PURE;
    ...
    HRESULT
    CreatePrintControl(_In_ IWICImagingFactory * wicFactory, _In_ IPrintDocumentPackageTarget * documentTarget,
                       CONST D2D1_PRINT_CONTROL_PROPERTIES & printControlProperties, _Outptr_ ID2D1PrintControl * *printControl) {
...
interface DX_DECLARE_INTERFACE("bb12d362-daee-4b9a-aa1d-14ba401cfa1f") ID2D1Factory1 : public ID2D1Factory {
    ...
    //
    STDMETHOD(CreateDevice)(_In_ IDXGIDevice * dxgiDevice, _Outptr_ ID2D1Device * *d2dDevice) PURE;
    ...
    (_In_ CONST D2D1_STROKE_STYLE_PROPERTIES1 * strokeStyleProperties, _In_reads_opt_(dashesCount) CONST FLOAT * dashes, UINT32 dashesCount,
     _Outptr_ ID2D1StrokeStyle1 * *strokeStyle) PURE;
    ...
    //
    STDMETHOD(CreatePathGeometry)(_Outptr_ ID2D1PathGeometry1 * *pathGeometry) PURE;
    ...
    (_In_opt_ CONST D2D1_DRAWING_STATE_DESCRIPTION1 * drawingStateDescription, _In_opt_ IDWriteRenderingParams * textRenderingParams,
     _Outptr_ ID2D1DrawingStateBlock1 * *drawingStateBlock) PURE;
    ...
    //
    STDMETHOD(CreateGdiMetafile)(_In_ IStream * metafileStream, _Outptr_ ID2D1GdiMetafile * *metafile) PURE;
    ...
    (_In_ REFCLSID classId, _In_ IStream * propertyXml, _In_reads_opt_(bindingsCount) CONST D2D1_PROPERTY_BINDING * bindings, UINT32 bindingsCount,
     _In_ CONST PD2D1_EFFECT_FACTORY effectFactory) PURE;
    ...
    (_In_ REFCLSID classId, _In_ PCWSTR propertyXml, _In_reads_opt_(bindingsCount) CONST D2D1_PROPERTY_BINDING * bindings, UINT32 bindingsCount,
     _In_ CONST PD2D1_EFFECT_FACTORY effectFactory) PURE;
    ...
    //
    STDMETHOD(UnregisterEffect)(_In_ REFCLSID classId) PURE;
    ...
    (_Out_writes_to_opt_(effectsCount, *effectsReturned) CLSID * effects, UINT32 effectsCount,
     ...
     //
     _Out_opt_ UINT32 * effectsRegistered) CONST PURE;
    ...
    //
    STDMETHOD(GetEffectProperties)(_In_ REFCLSID effectId, _Outptr_ ID2D1Properties * *properties) CONST PURE;

    HRESULT
    CreateStrokeStyle(CONST D2D1_STROKE_STYLE_PROPERTIES1 & strokeStyleProperties, _In_reads_opt_(dashesCount) CONST FLOAT * dashes, UINT32 dashesCount,
                      _Outptr_ ID2D1StrokeStyle1 * *strokeStyle) {
        return CreateStrokeStyle(&strokeStyleProperties, dashes, dashesCount, strokeStyle);
    }

    HRESULT
    CreateDrawingStateBlock(CONST D2D1_DRAWING_STATE_DESCRIPTION1 & drawingStateDescription, _Outptr_ ID2D1DrawingStateBlock1 * *drawingStateBlock) {
        return CreateDrawingStateBlock(&drawingStateDescription, NULL, drawingStateBlock);
    }

    HRESULT
    CreateDrawingStateBlock(_Outptr_ ID2D1DrawingStateBlock1 * *drawingStateBlock) { return CreateDrawingStateBlock(NULL, NULL, drawingStateBlock); }
...
typedef struct ID2D1GdiMetafileSinkVtbl {
    ...
    STDMETHOD(ProcessRecord)(ID2D1GdiMetafileSink * This, DWORD recordType, _In_opt_ CONST void * recordData, DWORD recordDataSize) PURE;
} ID2D1GdiMetafileSinkVtbl;

interface ID2D1GdiMetafileSink { CONST struct ID2D1GdiMetafileSinkVtbl * lpVtbl; };

            #define ID2D1GdiMetafileSink_QueryInterface(This, riid, ppv) ((This)->lpVtbl->Base.QueryInterface((IUnknown *) This, riid, ppv))

            #define ID2D1GdiMetafileSink_AddRef(This) ((This)->lpVtbl->Base.AddRef((IUnknown *) This))

            #define ID2D1GdiMetafileSink_Release(This) ((This)->lpVtbl->Base.Release((IUnknown *) This))
...
typedef struct ID2D1GdiMetafileVtbl {
    ...
    STDMETHOD(Stream)(ID2D1GdiMetafile * This, _In_ ID2D1GdiMetafileSink * sink) PURE;

    STDMETHOD(GetBounds)(ID2D1GdiMetafile * This, _Out_ D2D1_RECT_F * bounds) PURE;
} ID2D1GdiMetafileVtbl;

interface ID2D1GdiMetafile { CONST struct ID2D1GdiMetafileVtbl * lpVtbl; };

            #define ID2D1GdiMetafile_QueryInterface(This, riid, ppv) ((This)->lpVtbl->Base.Base.QueryInterface((IUnknown *) This, riid, ppv))

            #define ID2D1GdiMetafile_AddRef(This) ((This)->lpVtbl->Base.Base.AddRef((IUnknown *) This))

            #define ID2D1GdiMetafile_Release(This) ((This)->lpVtbl->Base.Base.Release((IUnknown *) This))

            #define ID2D1GdiMetafile_GetFactory(This, factory) ((This)->lpVtbl->Base.GetFactory((ID2D1Resource *) This, factory))
...
typedef struct ID2D1CommandSinkVtbl {
    ...
    STDMETHOD(BeginDraw)(ID2D1CommandSink * This) PURE;

    STDMETHOD(EndDraw)(ID2D1CommandSink * This) PURE;

    STDMETHOD(SetAntialiasMode)(ID2D1CommandSink * This, D2D1_ANTIALIAS_MODE antialiasMode) PURE;

    STDMETHOD(SetTags)(ID2D1CommandSink * This, D2D1_TAG tag1, D2D1_TAG tag2) PURE;

    STDMETHOD(SetTextAntialiasMode)(ID2D1CommandSink * This, D2D1_TEXT_ANTIALIAS_MODE textAntialiasMode) PURE;

    STDMETHOD(SetTextRenderingParams)(ID2D1CommandSink * This, _In_opt_ IDWriteRenderingParams * textRenderingParams) PURE;

    STDMETHOD(SetTransform)(ID2D1CommandSink * This, _In_ CONST D2D1_MATRIX_3X2_F * transform) PURE;

    STDMETHOD(SetPrimitiveBlend)(ID2D1CommandSink * This, D2D1_PRIMITIVE_BLEND primitiveBlend) PURE;

    STDMETHOD(SetUnitMode)(ID2D1CommandSink * This, D2D1_UNIT_MODE unitMode) PURE;

    STDMETHOD(Clear)(ID2D1CommandSink * This, _In_opt_ CONST D2D1_COLOR_F * color) PURE;

    STDMETHOD(DrawGlyphRun)
    (ID2D1CommandSink * This, D2D1_POINT_2F baselineOrigin, _In_ CONST DWRITE_GLYPH_RUN * glyphRun,
     _In_opt_ CONST DWRITE_GLYPH_RUN_DESCRIPTION * glyphRunDescription, _In_ ID2D1Brush * foregroundBrush, DWRITE_MEASURING_MODE measuringMode) PURE;

    STDMETHOD(DrawLine)
    (ID2D1CommandSink * This, D2D1_POINT_2F point0, D2D1_POINT_2F point1, _In_ ID2D1Brush * brush, FLOAT strokeWidth, _In_opt_ ID2D1StrokeStyle * strokeStyle)
        PURE;

    STDMETHOD(DrawGeometry)
    (ID2D1CommandSink * This, _In_ ID2D1Geometry * geometry, _In_ ID2D1Brush * brush, FLOAT strokeWidth, _In_opt_ ID2D1StrokeStyle * strokeStyle) PURE;

    STDMETHOD(DrawRectangle)
    (ID2D1CommandSink * This, _In_ CONST D2D1_RECT_F * rect, _In_ ID2D1Brush * brush, FLOAT strokeWidth, _In_opt_ ID2D1StrokeStyle * strokeStyle) PURE;

    STDMETHOD(DrawBitmap)
    (ID2D1CommandSink * This, _In_ ID2D1Bitmap * bitmap, _In_opt_ CONST D2D1_RECT_F * destinationRectangle, FLOAT opacity,
     D2D1_INTERPOLATION_MODE interpolationMode, _In_opt_ CONST D2D1_RECT_F * sourceRectangle, _In_opt_ CONST D2D1_MATRIX_4X4_F * perspectiveTransform) PURE;

    STDMETHOD(DrawImage)
    (ID2D1CommandSink * This, _In_ ID2D1Image * image, _In_opt_ CONST D2D1_POINT_2F * targetOffset, _In_opt_ CONST D2D1_RECT_F * imageRectangle,
     D2D1_INTERPOLATION_MODE interpolationMode, D2D1_COMPOSITE_MODE compositeMode) PURE;

    STDMETHOD(DrawGdiMetafile)(ID2D1CommandSink * This, _In_ ID2D1GdiMetafile * gdiMetafile, _In_opt_ CONST D2D1_POINT_2F * targetOffset) PURE;

    STDMETHOD(FillMesh)(ID2D1CommandSink * This, _In_ ID2D1Mesh * mesh, _In_ ID2D1Brush * brush) PURE;

    STDMETHOD(FillOpacityMask)
    (ID2D1CommandSink * This, _In_ ID2D1Bitmap * opacityMask, _In_ ID2D1Brush * brush, _In_opt_ CONST D2D1_RECT_F * destinationRectangle,
     _In_opt_ CONST D2D1_RECT_F * sourceRectangle) PURE;

    STDMETHOD(FillGeometry)(ID2D1CommandSink * This, _In_ ID2D1Geometry * geometry, _In_ ID2D1Brush * brush, _In_opt_ ID2D1Brush * opacityBrush) PURE;

    STDMETHOD(FillRectangle)(ID2D1CommandSink * This, _In_ CONST D2D1_RECT_F * rect, _In_ ID2D1Brush * brush) PURE;

    STDMETHOD(PushAxisAlignedClip)(ID2D1CommandSink * This, _In_ CONST D2D1_RECT_F * clipRect, D2D1_ANTIALIAS_MODE antialiasMode) PURE;

    STDMETHOD(PushLayer)(ID2D1CommandSink * This, _In_ CONST D2D1_LAYER_PARAMETERS1 * layerParameters1, _In_opt_ ID2D1Layer * layer) PURE;

    STDMETHOD(PopAxisAlignedClip)(ID2D1CommandSink * This) PURE;

    STDMETHOD(PopLayer)(ID2D1CommandSink * This) PURE;
} ID2D1CommandSinkVtbl;

interface ID2D1CommandSink { CONST struct ID2D1CommandSinkVtbl * lpVtbl; };

            #define ID2D1CommandSink_QueryInterface(This, riid, ppv) ((This)->lpVtbl->Base.QueryInterface((IUnknown *) This, riid, ppv))

            #define ID2D1CommandSink_AddRef(This) ((This)->lpVtbl->Base.AddRef((IUnknown *) This))

            #define ID2D1CommandSink_Release(This) ((This)->lpVtbl->Base.Release((IUnknown *) This))
            ...
            #define ID2D1CommandSink_SetAntialiasMode(This, antialiasMode) ((This)->lpVtbl->SetAntialiasMode(This, antialiasMode))

            #define ID2D1CommandSink_SetTags(This, tag1, tag2) ((This)->lpVtbl->SetTags(This, tag1, tag2))

            #define ID2D1CommandSink_SetTextAntialiasMode(This, textAntialiasMode) ((This)->lpVtbl->SetTextAntialiasMode(This, textAntialiasMode))

            #define ID2D1CommandSink_SetTextRenderingParams(This, textRenderingParams) ((This)->lpVtbl->SetTextRenderingParams(This, textRenderingParams))

            #define ID2D1CommandSink_SetTransform(This, transform) ((This)->lpVtbl->SetTransform(This, transform))

            #define ID2D1CommandSink_SetPrimitiveBlend(This, primitiveBlend) ((This)->lpVtbl->SetPrimitiveBlend(This, primitiveBlend))

            #define ID2D1CommandSink_SetUnitMode(This, unitMode) ((This)->lpVtbl->SetUnitMode(This, unitMode))
            ...
            #define ID2D1CommandSink_DrawGdiMetafile(This, gdiMetafile, targetOffset) ((This)->lpVtbl->DrawGdiMetafile(This, gdiMetafile, targetOffset))
            ...
            #define ID2D1CommandSink_FillGeometry(This, geometry, brush, opacityBrush) ((This)->lpVtbl->FillGeometry(This, geometry, brush, opacityBrush))

            #define ID2D1CommandSink_FillRectangle(This, rect, brush) ((This)->lpVtbl->FillRectangle(This, rect, brush))

            #define ID2D1CommandSink_PushAxisAlignedClip(This, clipRect, antialiasMode) ((This)->lpVtbl->PushAxisAlignedClip(This, clipRect, antialiasMode))

            #define ID2D1CommandSink_PushLayer(This, layerParameters1, layer) ((This)->lpVtbl->PushLayer(This, layerParameters1, layer))
...
typedef struct ID2D1CommandListVtbl {
    ...
    STDMETHOD(Stream)(ID2D1CommandList * This, _In_ ID2D1CommandSink * sink) PURE;

    STDMETHOD(Close)(ID2D1CommandList * This) PURE;
} ID2D1CommandListVtbl;

interface ID2D1CommandList { CONST struct ID2D1CommandListVtbl * lpVtbl; };

            #define ID2D1CommandList_QueryInterface(This, riid, ppv) ((This)->lpVtbl->Base.Base.Base.QueryInterface((IUnknown *) This, riid, ppv))

            #define ID2D1CommandList_AddRef(This) ((This)->lpVtbl->Base.Base.Base.AddRef((IUnknown *) This))

            #define ID2D1CommandList_Release(This) ((This)->lpVtbl->Base.Base.Base.Release((IUnknown *) This))

            #define ID2D1CommandList_GetFactory(This, factory) ((This)->lpVtbl->Base.Base.GetFactory((ID2D1Resource *) This, factory))
...
typedef struct ID2D1PrintControlVtbl {
    ...
    STDMETHOD(AddPage)
    (ID2D1PrintControl * This, _In_ ID2D1CommandList * commandList, D2D_SIZE_F pageSize, _In_opt_ IStream * pagePrintTicketStream, _Out_opt_ D2D1_TAG * tag1,
     _Out_opt_ D2D1_TAG * tag2) PURE;

    STDMETHOD(Close)(ID2D1PrintControl * This) PURE;
} ID2D1PrintControlVtbl;

interface ID2D1PrintControl { CONST struct ID2D1PrintControlVtbl * lpVtbl; };

            #define ID2D1PrintControl_QueryInterface(This, riid, ppv) ((This)->lpVtbl->Base.QueryInterface((IUnknown *) This, riid, ppv))

            #define ID2D1PrintControl_AddRef(This) ((This)->lpVtbl->Base.AddRef((IUnknown *) This))

            #define ID2D1PrintControl_Release(This) ((This)->lpVtbl->Base.Release((IUnknown *) This))
...
typedef struct ID2D1ImageBrushVtbl {
    ...
    STDMETHOD_(void, SetImage)(ID2D1ImageBrush * This, _In_opt_ ID2D1Image * image) PURE;

    STDMETHOD_(void, SetExtendModeX)(ID2D1ImageBrush * This, D2D1_EXTEND_MODE extendModeX) PURE;

    STDMETHOD_(void, SetExtendModeY)(ID2D1ImageBrush * This, D2D1_EXTEND_MODE extendModeY) PURE;

    STDMETHOD_(void, SetInterpolationMode)(ID2D1ImageBrush * This, D2D1_INTERPOLATION_MODE interpolationMode) PURE;

    STDMETHOD_(void, SetSourceRectangle)(ID2D1ImageBrush * This, _In_ CONST D2D1_RECT_F * sourceRectangle) PURE;

    STDMETHOD_(void, GetImage)(ID2D1ImageBrush * This, _Outptr_ ID2D1Image ** image) PURE;

    STDMETHOD_(D2D1_EXTEND_MODE, GetExtendModeX)(ID2D1ImageBrush * This) PURE;

    STDMETHOD_(D2D1_EXTEND_MODE, GetExtendModeY)(ID2D1ImageBrush * This) PURE;

    STDMETHOD_(D2D1_INTERPOLATION_MODE, GetInterpolationMode)(ID2D1ImageBrush * This) PURE;

    STDMETHOD_(void, GetSourceRectangle)(ID2D1ImageBrush * This, _Out_ D2D1_RECT_F * sourceRectangle) PURE;
} ID2D1ImageBrushVtbl;

interface ID2D1ImageBrush { CONST struct ID2D1ImageBrushVtbl * lpVtbl; };

            #define ID2D1ImageBrush_QueryInterface(This, riid, ppv) ((This)->lpVtbl->Base.Base.Base.QueryInterface((IUnknown *) This, riid, ppv))

            #define ID2D1ImageBrush_AddRef(This) ((This)->lpVtbl->Base.Base.Base.AddRef((IUnknown *) This))

            #define ID2D1ImageBrush_Release(This) ((This)->lpVtbl->Base.Base.Base.Release((IUnknown *) This))

            #define ID2D1ImageBrush_GetFactory(This, factory) ((This)->lpVtbl->Base.Base.GetFactory((ID2D1Resource *) This, factory))

            #define ID2D1ImageBrush_SetOpacity(This, opacity) ((This)->lpVtbl->Base.SetOpacity((ID2D1Brush *) This, opacity))

            #define ID2D1ImageBrush_SetTransform(This, transform) ((This)->lpVtbl->Base.SetTransform((ID2D1Brush *) This, transform))

            #define ID2D1ImageBrush_GetOpacity(This) ((This)->lpVtbl->Base.GetOpacity((ID2D1Brush *) This))

            #define ID2D1ImageBrush_GetTransform(This, transform) ((This)->lpVtbl->Base.GetTransform((ID2D1Brush *) This, transform))

            #define ID2D1ImageBrush_SetImage(This, image) ((This)->lpVtbl->SetImage(This, image))

            #define ID2D1ImageBrush_SetExtendModeX(This, extendModeX) ((This)->lpVtbl->SetExtendModeX(This, extendModeX))

            #define ID2D1ImageBrush_SetExtendModeY(This, extendModeY) ((This)->lpVtbl->SetExtendModeY(This, extendModeY))

            #define ID2D1ImageBrush_SetInterpolationMode(This, interpolationMode) ((This)->lpVtbl->SetInterpolationMode(This, interpolationMode))

            #define ID2D1ImageBrush_SetSourceRectangle(This, sourceRectangle) ((This)->lpVtbl->SetSourceRectangle(This, sourceRectangle))
            ...
            #define ID2D1ImageBrush_GetSourceRectangle(This, sourceRectangle) ((This)->lpVtbl->GetSourceRectangle(This, sourceRectangle))
...
typedef struct ID2D1BitmapBrush1Vtbl {
    ...
    STDMETHOD_(void, SetInterpolationMode1)(ID2D1BitmapBrush1 * This, D2D1_INTERPOLATION_MODE interpolationMode) PURE;

    STDMETHOD_(D2D1_INTERPOLATION_MODE, GetInterpolationMode1)(ID2D1BitmapBrush1 * This) PURE;
} ID2D1BitmapBrush1Vtbl;

interface ID2D1BitmapBrush1 { CONST struct ID2D1BitmapBrush1Vtbl * lpVtbl; };

            #define ID2D1BitmapBrush1_QueryInterface(This, riid, ppv) ((This)->lpVtbl->Base.Base.Base.Base.QueryInterface((IUnknown *) This, riid, ppv))

            #define ID2D1BitmapBrush1_AddRef(This) ((This)->lpVtbl->Base.Base.Base.Base.AddRef((IUnknown *) This))

            #define ID2D1BitmapBrush1_Release(This) ((This)->lpVtbl->Base.Base.Base.Base.Release((IUnknown *) This))

            #define ID2D1BitmapBrush1_GetFactory(This, factory) ((This)->lpVtbl->Base.Base.Base.GetFactory((ID2D1Resource *) This, factory))

            #define ID2D1BitmapBrush1_SetOpacity(This, opacity) ((This)->lpVtbl->Base.Base.SetOpacity((ID2D1Brush *) This, opacity))

            #define ID2D1BitmapBrush1_SetTransform(This, transform) ((This)->lpVtbl->Base.Base.SetTransform((ID2D1Brush *) This, transform))

            #define ID2D1BitmapBrush1_GetOpacity(This) ((This)->lpVtbl->Base.Base.GetOpacity((ID2D1Brush *) This))

            #define ID2D1BitmapBrush1_GetTransform(This, transform) ((This)->lpVtbl->Base.Base.GetTransform((ID2D1Brush *) This, transform))

            #define ID2D1BitmapBrush1_SetExtendModeX(This, extendModeX) ((This)->lpVtbl->Base.SetExtendModeX((ID2D1BitmapBrush *) This, extendModeX))

            #define ID2D1BitmapBrush1_SetExtendModeY(This, extendModeY) ((This)->lpVtbl->Base.SetExtendModeY((ID2D1BitmapBrush *) This, extendModeY))
            ...
            #define ID2D1BitmapBrush1_SetBitmap(This, bitmap) ((This)->lpVtbl->Base.SetBitmap((ID2D1BitmapBrush *) This, bitmap))

            #define ID2D1BitmapBrush1_GetExtendModeX(This) ((This)->lpVtbl->Base.GetExtendModeX((ID2D1BitmapBrush *) This))

            #define ID2D1BitmapBrush1_GetExtendModeY(This) ((This)->lpVtbl->Base.GetExtendModeY((ID2D1BitmapBrush *) This))

            #define ID2D1BitmapBrush1_GetInterpolationMode(This) ((This)->lpVtbl->Base.GetInterpolationMode((ID2D1BitmapBrush *) This))

            #define ID2D1BitmapBrush1_GetBitmap(This, bitmap) ((This)->lpVtbl->Base.GetBitmap((ID2D1BitmapBrush *) This, bitmap))

            #define ID2D1BitmapBrush1_SetInterpolationMode1(This, interpolationMode) ((This)->lpVtbl->SetInterpolationMode1(This, interpolationMode))
...
typedef struct ID2D1StrokeStyle1Vtbl {
    ...
    STDMETHOD_(D2D1_STROKE_TRANSFORM_TYPE, GetStrokeTransformType)(ID2D1StrokeStyle1 * This) PURE;
} ID2D1StrokeStyle1Vtbl;

interface ID2D1StrokeStyle1 { CONST struct ID2D1StrokeStyle1Vtbl * lpVtbl; };

            #define ID2D1StrokeStyle1_QueryInterface(This, riid, ppv) ((This)->lpVtbl->Base.Base.Base.QueryInterface((IUnknown *) This, riid, ppv))

            #define ID2D1StrokeStyle1_AddRef(This) ((This)->lpVtbl->Base.Base.Base.AddRef((IUnknown *) This))

            #define ID2D1StrokeStyle1_Release(This) ((This)->lpVtbl->Base.Base.Base.Release((IUnknown *) This))

            #define ID2D1StrokeStyle1_GetFactory(This, factory) ((This)->lpVtbl->Base.Base.GetFactory((ID2D1Resource *) This, factory))

            #define ID2D1StrokeStyle1_GetStartCap(This) ((This)->lpVtbl->Base.GetStartCap((ID2D1StrokeStyle *) This))

            #define ID2D1StrokeStyle1_GetEndCap(This) ((This)->lpVtbl->Base.GetEndCap((ID2D1StrokeStyle *) This))

            #define ID2D1StrokeStyle1_GetDashCap(This) ((This)->lpVtbl->Base.GetDashCap((ID2D1StrokeStyle *) This))

            #define ID2D1StrokeStyle1_GetMiterLimit(This) ((This)->lpVtbl->Base.GetMiterLimit((ID2D1StrokeStyle *) This))

            #define ID2D1StrokeStyle1_GetLineJoin(This) ((This)->lpVtbl->Base.GetLineJoin((ID2D1StrokeStyle *) This))

            #define ID2D1StrokeStyle1_GetDashOffset(This) ((This)->lpVtbl->Base.GetDashOffset((ID2D1StrokeStyle *) This))

            #define ID2D1StrokeStyle1_GetDashStyle(This) ((This)->lpVtbl->Base.GetDashStyle((ID2D1StrokeStyle *) This))

            #define ID2D1StrokeStyle1_GetDashesCount(This) ((This)->lpVtbl->Base.GetDashesCount((ID2D1StrokeStyle *) This))

            #define ID2D1StrokeStyle1_GetDashes(This, dashes, dashesCount) ((This)->lpVtbl->Base.GetDashes((ID2D1StrokeStyle *) This, dashes, dashesCount))
...
typedef struct ID2D1PathGeometry1Vtbl {
    ...
    STDMETHOD(ComputePointAndSegmentAtLength)
    (ID2D1PathGeometry1 * This, FLOAT length, UINT32 startSegment, _In_opt_ CONST D2D1_MATRIX_3X2_F * worldTransform, FLOAT flatteningTolerance,
     _Out_ D2D1_POINT_DESCRIPTION * pointDescription) PURE;
} ID2D1PathGeometry1Vtbl;

interface ID2D1PathGeometry1 { CONST struct ID2D1PathGeometry1Vtbl * lpVtbl; };

            #define ID2D1PathGeometry1_QueryInterface(This, riid, ppv) ((This)->lpVtbl->Base.Base.Base.Base.QueryInterface((IUnknown *) This, riid, ppv))

            #define ID2D1PathGeometry1_AddRef(This) ((This)->lpVtbl->Base.Base.Base.Base.AddRef((IUnknown *) This))

            #define ID2D1PathGeometry1_Release(This) ((This)->lpVtbl->Base.Base.Base.Base.Release((IUnknown *) This))

            #define ID2D1PathGeometry1_GetFactory(This, factory) ((This)->lpVtbl->Base.Base.Base.GetFactory((ID2D1Resource *) This, factory))
            ...
            #define ID2D1PathGeometry1_StrokeContainsPoint(This, point, strokeWidth, strokeStyle, worldTransform, flatteningTolerance, contains)             \
                ((This)->lpVtbl->Base.Base.StrokeContainsPoint((ID2D1Geometry *) This, point, strokeWidth, strokeStyle, worldTransform, flatteningTolerance, \
                                                               contains))
            ...
            #define ID2D1PathGeometry1_CombineWithGeometry(This, inputGeometry, combineMode, inputGeometryTransform, flatteningTolerance, geometrySink) \
                ((This)->lpVtbl->Base.Base.CombineWithGeometry((ID2D1Geometry *) This, inputGeometry, combineMode, inputGeometryTransform,              \
            ...
            #define ID2D1PathGeometry1_Open(This, geometrySink) ((This)->lpVtbl->Base.Open((ID2D1PathGeometry *) This, geometrySink))

            #define ID2D1PathGeometry1_Stream(This, geometrySink) ((This)->lpVtbl->Base.Stream((ID2D1PathGeometry *) This, geometrySink))

            #define ID2D1PathGeometry1_GetSegmentCount(This, count) ((This)->lpVtbl->Base.GetSegmentCount((ID2D1PathGeometry *) This, count))

            #define ID2D1PathGeometry1_GetFigureCount(This, count) ((This)->lpVtbl->Base.GetFigureCount((ID2D1PathGeometry *) This, count))
...
typedef struct ID2D1PropertiesVtbl {
    ...
    STDMETHOD_(UINT32, GetPropertyCount)(ID2D1Properties * This) PURE;

    STDMETHOD(GetPropertyName)(ID2D1Properties * This, UINT32 index, _Out_writes_(nameCount) PWSTR name, UINT32 nameCount) PURE;

    STDMETHOD_(UINT32, GetPropertyNameLength)(ID2D1Properties * This, UINT32 index) PURE;

    STDMETHOD_(D2D1_PROPERTY_TYPE, GetType)(ID2D1Properties * This, UINT32 index) PURE;

    STDMETHOD_(UINT32, GetPropertyIndex)(ID2D1Properties * This, _In_ PCWSTR name) PURE;

    STDMETHOD(SetValueByName)(ID2D1Properties * This, _In_ PCWSTR name, D2D1_PROPERTY_TYPE type, _In_reads_(dataSize) CONST BYTE * data, UINT32 dataSize) PURE;

    STDMETHOD(SetValue)(ID2D1Properties * This, UINT32 index, D2D1_PROPERTY_TYPE type, _In_reads_(dataSize) CONST BYTE * data, UINT32 dataSize) PURE;

    STDMETHOD(GetValueByName)(ID2D1Properties * This, _In_ PCWSTR name, D2D1_PROPERTY_TYPE type, _Out_writes_(dataSize) BYTE * data, UINT32 dataSize) PURE;

    STDMETHOD(GetValue)(ID2D1Properties * This, UINT32 index, D2D1_PROPERTY_TYPE type, _Out_writes_(dataSize) BYTE * data, UINT32 dataSize) PURE;

    STDMETHOD_(UINT32, GetValueSize)(ID2D1Properties * This, UINT32 index) PURE;

    STDMETHOD(GetSubProperties)(ID2D1Properties * This, UINT32 index, _Outptr_opt_ ID2D1Properties ** subProperties) PURE;
} ID2D1PropertiesVtbl;

interface ID2D1Properties { CONST struct ID2D1PropertiesVtbl * lpVtbl; };

            #define ID2D1Properties_QueryInterface(This, riid, ppv) ((This)->lpVtbl->Base.QueryInterface((IUnknown *) This, riid, ppv))

            #define ID2D1Properties_AddRef(This) ((This)->lpVtbl->Base.AddRef((IUnknown *) This))

            #define ID2D1Properties_Release(This) ((This)->lpVtbl->Base.Release((IUnknown *) This))

            #define ID2D1Properties_GetPropertyCount(This) ((This)->lpVtbl->GetPropertyCount(This))

            #define ID2D1Properties_GetPropertyName(This, index, name, nameCount) ((This)->lpVtbl->GetPropertyName(This, index, name, nameCount))
            ...
            #define ID2D1Properties_SetValueByName(This, name, type, data, dataSize) ((This)->lpVtbl->SetValueByName(This, name, type, data, dataSize))

            #define ID2D1Properties_SetValue(This, index, type, data, dataSize) ((This)->lpVtbl->SetValue(This, index, type, data, dataSize))

            #define ID2D1Properties_GetValueByName(This, name, type, data, dataSize) ((This)->lpVtbl->GetValueByName(This, name, type, data, dataSize))

            #define ID2D1Properties_GetValue(This, index, type, data, dataSize) ((This)->lpVtbl->GetValue(This, index, type, data, dataSize))

            #define ID2D1Properties_GetValueSize(This, index) ((This)->lpVtbl->GetValueSize(This, index))

            #define ID2D1Properties_GetSubProperties(This, index, subProperties) ((This)->lpVtbl->GetSubProperties(This, index, subProperties))
...
typedef struct ID2D1EffectVtbl {
    ...
    STDMETHOD_(void, SetInput)(ID2D1Effect * This, UINT32 index, _In_opt_ ID2D1Image * input, BOOL invalidate) PURE;

    STDMETHOD(SetInputCount)(ID2D1Effect * This, UINT32 inputCount) PURE;

    STDMETHOD_(void, GetInput)(ID2D1Effect * This, UINT32 index, _Outptr_opt_ ID2D1Image ** input) PURE;

    STDMETHOD_(UINT32, GetInputCount)(ID2D1Effect * This) PURE;

    STDMETHOD_(void, GetOutput)(ID2D1Effect * This, _Outptr_ ID2D1Image ** outputImage) PURE;
} ID2D1EffectVtbl;

interface ID2D1Effect { CONST struct ID2D1EffectVtbl * lpVtbl; };

            #define ID2D1Effect_QueryInterface(This, riid, ppv) ((This)->lpVtbl->Base.Base.QueryInterface((IUnknown *) This, riid, ppv))

            #define ID2D1Effect_AddRef(This) ((This)->lpVtbl->Base.Base.AddRef((IUnknown *) This))

            #define ID2D1Effect_Release(This) ((This)->lpVtbl->Base.Base.Release((IUnknown *) This))

            #define ID2D1Effect_GetPropertyCount(This) ((This)->lpVtbl->Base.GetPropertyCount((ID2D1Properties *) This))
            ...
            #define ID2D1Effect_GetPropertyNameLength(This, index) ((This)->lpVtbl->Base.GetPropertyNameLength((ID2D1Properties *) This, index))

            #define ID2D1Effect_GetType(This, index) ((This)->lpVtbl->Base.GetType((ID2D1Properties *) This, index))

            #define ID2D1Effect_GetPropertyIndex(This, name) ((This)->lpVtbl->Base.GetPropertyIndex((ID2D1Properties *) This, name))
            ...
            #define ID2D1Effect_GetValueSize(This, index) ((This)->lpVtbl->Base.GetValueSize((ID2D1Properties *) This, index))
            ...
            #define ID2D1Effect_SetInputCount(This, inputCount) ((This)->lpVtbl->SetInputCount(This, inputCount))
            ...
            #define ID2D1Effect_GetOutput(This, outputImage) ((This)->lpVtbl->GetOutput(This, outputImage))
...
typedef struct ID2D1Bitmap1Vtbl {
    ...
    STDMETHOD_(void, GetColorContext)(ID2D1Bitmap1 * This, _Outptr_result_maybenull_ ID2D1ColorContext ** colorContext) PURE;

    STDMETHOD_(D2D1_BITMAP_OPTIONS, GetOptions)(ID2D1Bitmap1 * This) PURE;

    STDMETHOD(GetSurface)(ID2D1Bitmap1 * This, _Outptr_result_maybenull_ IDXGISurface ** dxgiSurface) PURE;

    STDMETHOD(Map)(ID2D1Bitmap1 * This, D2D1_MAP_OPTIONS options, _Out_ D2D1_MAPPED_RECT * mappedRect) PURE;

    STDMETHOD(Unmap)(ID2D1Bitmap1 * This) PURE;
} ID2D1Bitmap1Vtbl;

interface ID2D1Bitmap1 { CONST struct ID2D1Bitmap1Vtbl * lpVtbl; };

            #define ID2D1Bitmap1_QueryInterface(This, riid, ppv) ((This)->lpVtbl->Base.Base.Base.Base.QueryInterface((IUnknown *) This, riid, ppv))

            #define ID2D1Bitmap1_AddRef(This) ((This)->lpVtbl->Base.Base.Base.Base.AddRef((IUnknown *) This))

            #define ID2D1Bitmap1_Release(This) ((This)->lpVtbl->Base.Base.Base.Base.Release((IUnknown *) This))

            #define ID2D1Bitmap1_GetFactory(This, factory) ((This)->lpVtbl->Base.Base.Base.GetFactory((ID2D1Resource *) This, factory))

            #define ID2D1Bitmap1_GetSize(This) ((This)->lpVtbl->Base.GetSize((ID2D1Bitmap *) This))

            #define ID2D1Bitmap1_GetPixelSize(This) ((This)->lpVtbl->Base.GetPixelSize((ID2D1Bitmap *) This))

            #define ID2D1Bitmap1_GetPixelFormat(This) ((This)->lpVtbl->Base.GetPixelFormat((ID2D1Bitmap *) This))

            #define ID2D1Bitmap1_GetDpi(This, dpiX, dpiY) ((This)->lpVtbl->Base.GetDpi((ID2D1Bitmap *) This, dpiX, dpiY))
            ...
            #define ID2D1Bitmap1_GetColorContext(This, colorContext) ((This)->lpVtbl->GetColorContext(This, colorContext))

            #define ID2D1Bitmap1_GetOptions(This) ((This)->lpVtbl->GetOptions(This))

            #define ID2D1Bitmap1_GetSurface(This, dxgiSurface) ((This)->lpVtbl->GetSurface(This, dxgiSurface))

            #define ID2D1Bitmap1_Map(This, options, mappedRect) ((This)->lpVtbl->Map(This, options, mappedRect))
...
typedef struct ID2D1ColorContextVtbl {
    ...
    STDMETHOD_(D2D1_COLOR_SPACE, GetColorSpace)(ID2D1ColorContext * This) PURE;

    STDMETHOD_(UINT32, GetProfileSize)(ID2D1ColorContext * This) PURE;

    STDMETHOD(GetProfile)(ID2D1ColorContext * This, _Out_writes_(profileSize) BYTE * profile, UINT32 profileSize) PURE;
} ID2D1ColorContextVtbl;

interface ID2D1ColorContext { CONST struct ID2D1ColorContextVtbl * lpVtbl; };

            #define ID2D1ColorContext_QueryInterface(This, riid, ppv) ((This)->lpVtbl->Base.Base.QueryInterface((IUnknown *) This, riid, ppv))

            #define ID2D1ColorContext_AddRef(This) ((This)->lpVtbl->Base.Base.AddRef((IUnknown *) This))

            #define ID2D1ColorContext_Release(This) ((This)->lpVtbl->Base.Base.Release((IUnknown *) This))

            #define ID2D1ColorContext_GetFactory(This, factory) ((This)->lpVtbl->Base.GetFactory((ID2D1Resource *) This, factory))
            ...
            #define ID2D1ColorContext_GetProfile(This, profile, profileSize) ((This)->lpVtbl->GetProfile(This, profile, profileSize))
...
typedef struct ID2D1GradientStopCollection1Vtbl {
    ...
    (ID2D1GradientStopCollection1 *                                                                                      This,
     _Out_writes_to_(gradientStopsCount, _Inexpressible_("Retrieved through GetGradientStopCount")) D2D1_GRADIENT_STOP * gradientStops,
     UINT32                                                                                                              gradientStopsCount) PURE;

    STDMETHOD_(D2D1_COLOR_SPACE, GetPreInterpolationSpace)(ID2D1GradientStopCollection1 * This) PURE;

    STDMETHOD_(D2D1_COLOR_SPACE, GetPostInterpolationSpace)(ID2D1GradientStopCollection1 * This) PURE;

    STDMETHOD_(D2D1_BUFFER_PRECISION, GetBufferPrecision)(ID2D1GradientStopCollection1 * This) PURE;

    STDMETHOD_(D2D1_COLOR_INTERPOLATION_MODE, GetColorInterpolationMode)(ID2D1GradientStopCollection1 * This) PURE;
} ID2D1GradientStopCollection1Vtbl;

interface ID2D1GradientStopCollection1 { CONST struct ID2D1GradientStopCollection1Vtbl * lpVtbl; };

            #define ID2D1GradientStopCollection1_QueryInterface(This, riid, ppv) ((This)->lpVtbl->Base.Base.Base.QueryInterface((IUnknown *) This, riid, ppv))

            #define ID2D1GradientStopCollection1_AddRef(This) ((This)->lpVtbl->Base.Base.Base.AddRef((IUnknown *) This))

            #define ID2D1GradientStopCollection1_Release(This) ((This)->lpVtbl->Base.Base.Base.Release((IUnknown *) This))

            #define ID2D1GradientStopCollection1_GetFactory(This, factory) ((This)->lpVtbl->Base.Base.GetFactory((ID2D1Resource *) This, factory))

            #define ID2D1GradientStopCollection1_GetGradientStopCount(This) ((This)->lpVtbl->Base.GetGradientStopCount((ID2D1GradientStopCollection *) This))
            ...
            #define ID2D1GradientStopCollection1_GetExtendMode(This) ((This)->lpVtbl->Base.GetExtendMode((ID2D1GradientStopCollection *) This))
...
typedef struct ID2D1DrawingStateBlock1Vtbl {
    ...
    STDMETHOD_(void, GetDescription)(ID2D1DrawingStateBlock1 * This, _Out_ D2D1_DRAWING_STATE_DESCRIPTION1 * stateDescription) PURE;

    STDMETHOD_(void, SetDescription)(ID2D1DrawingStateBlock1 * This, _In_ CONST D2D1_DRAWING_STATE_DESCRIPTION1 * stateDescription) PURE;
} ID2D1DrawingStateBlock1Vtbl;

interface ID2D1DrawingStateBlock1 { CONST struct ID2D1DrawingStateBlock1Vtbl * lpVtbl; };

            #define ID2D1DrawingStateBlock1_QueryInterface(This, riid, ppv) ((This)->lpVtbl->Base.Base.Base.QueryInterface((IUnknown *) This, riid, ppv))

            #define ID2D1DrawingStateBlock1_AddRef(This) ((This)->lpVtbl->Base.Base.Base.AddRef((IUnknown *) This))

            #define ID2D1DrawingStateBlock1_Release(This) ((This)->lpVtbl->Base.Base.Base.Release((IUnknown *) This))

            #define ID2D1DrawingStateBlock1_GetFactory(This, factory) ((This)->lpVtbl->Base.Base.GetFactory((ID2D1Resource *) This, factory))
            ...
            #define ID2D1DrawingStateBlock1_GetDescription(This, stateDescription) ((This)->lpVtbl->GetDescription(This, stateDescription))

            #define ID2D1DrawingStateBlock1_SetDescription(This, stateDescription) ((This)->lpVtbl->SetDescription(This, stateDescription))
...
typedef struct ID2D1DeviceContextVtbl {
    ...
    STDMETHOD(CreateBitmap)
    (ID2D1DeviceContext * This, D2D1_SIZE_U size, _In_opt_ CONST void * sourceData, UINT32 pitch, _In_ CONST D2D1_BITMAP_PROPERTIES1 * bitmapProperties,
     _Outptr_ ID2D1Bitmap1 ** bitmap) PURE;

    STDMETHOD(CreateBitmapFromWicBitmap)
    (ID2D1DeviceContext * This, _In_ IWICBitmapSource * wicBitmapSource, _In_opt_ CONST D2D1_BITMAP_PROPERTIES1 * bitmapProperties,
     _Outptr_ ID2D1Bitmap1 ** bitmap) PURE;

    STDMETHOD(CreateColorContext)
    (ID2D1DeviceContext * This, D2D1_COLOR_SPACE space, _In_reads_opt_(profileSize) CONST BYTE * profile, UINT32 profileSize,
     _Outptr_ ID2D1ColorContext ** colorContext) PURE;

    STDMETHOD(CreateColorContextFromFilename)(ID2D1DeviceContext * This, _In_ PCWSTR filename, _Outptr_ ID2D1ColorContext ** colorContext) PURE;

    STDMETHOD(CreateColorContextFromWicColorContext)
    (ID2D1DeviceContext * This, _In_ IWICColorContext * wicColorContext, _Outptr_ ID2D1ColorContext ** colorContext) PURE;

    STDMETHOD(CreateBitmapFromDxgiSurface)
    (ID2D1DeviceContext * This, _In_ IDXGISurface * surface, _In_opt_ CONST D2D1_BITMAP_PROPERTIES1 * bitmapProperties, _Outptr_ ID2D1Bitmap1 ** bitmap) PURE;

    STDMETHOD(CreateEffect)(ID2D1DeviceContext * This, _In_ REFCLSID effectId, _Outptr_ ID2D1Effect ** effect) PURE;

    STDMETHOD(CreateGradientStopCollection)
    (ID2D1DeviceContext * This, _In_reads_(straightAlphaGradientStopsCount) CONST D2D1_GRADIENT_STOP * straightAlphaGradientStops,
     _In_range_(>=, 1) UINT32 straightAlphaGradientStopsCount, D2D1_COLOR_SPACE preInterpolationSpace, D2D1_COLOR_SPACE postInterpolationSpace,
     D2D1_BUFFER_PRECISION bufferPrecision, D2D1_EXTEND_MODE extendMode, D2D1_COLOR_INTERPOLATION_MODE colorInterpolationMode,
     _Outptr_ ID2D1GradientStopCollection1 ** gradientStopCollection1) PURE;

    STDMETHOD(CreateImageBrush)
    (ID2D1DeviceContext * This, _In_opt_ ID2D1Image * image, _In_ CONST D2D1_IMAGE_BRUSH_PROPERTIES * imageBrushProperties,
     _In_opt_ CONST D2D1_BRUSH_PROPERTIES * brushProperties, _Outptr_ ID2D1ImageBrush ** imageBrush) PURE;

    STDMETHOD(CreateBitmapBrush)
    (ID2D1DeviceContext * This, _In_opt_ ID2D1Bitmap * bitmap, _In_opt_ CONST D2D1_BITMAP_BRUSH_PROPERTIES1 * bitmapBrushProperties,
     _In_opt_ CONST D2D1_BRUSH_PROPERTIES * brushProperties, _Outptr_ ID2D1BitmapBrush1 ** bitmapBrush) PURE;

    STDMETHOD(CreateCommandList)(ID2D1DeviceContext * This, _Outptr_ ID2D1CommandList ** commandList) PURE;

    STDMETHOD_(BOOL, IsDxgiFormatSupported)(ID2D1DeviceContext * This, DXGI_FORMAT format) PURE;

    STDMETHOD_(BOOL, IsBufferPrecisionSupported)(ID2D1DeviceContext * This, D2D1_BUFFER_PRECISION bufferPrecision) PURE;

    STDMETHOD(GetImageLocalBounds)(ID2D1DeviceContext * This, _In_ ID2D1Image * image, _Out_ D2D1_RECT_F * localBounds) PURE;

    STDMETHOD(GetImageWorldBounds)(ID2D1DeviceContext * This, _In_ ID2D1Image * image, _Out_ D2D1_RECT_F * worldBounds) PURE;

    STDMETHOD(GetGlyphRunWorldBounds)
    (ID2D1DeviceContext * This, D2D1_POINT_2F baselineOrigin, _In_ CONST DWRITE_GLYPH_RUN * glyphRun, DWRITE_MEASURING_MODE measuringMode,
     _Out_ D2D1_RECT_F * bounds) PURE;

    STDMETHOD_(void, GetDevice)(ID2D1DeviceContext * This, _Outptr_ ID2D1Device ** device) PURE;

    STDMETHOD_(void, SetTarget)(ID2D1DeviceContext * This, _In_opt_ ID2D1Image * image) PURE;

    STDMETHOD_(void, GetTarget)(ID2D1DeviceContext * This, _Outptr_result_maybenull_ ID2D1Image ** image) PURE;

    STDMETHOD_(void, SetRenderingControls)(ID2D1DeviceContext * This, _In_ CONST D2D1_RENDERING_CONTROLS * renderingControls) PURE;

    STDMETHOD_(void, GetRenderingControls)(ID2D1DeviceContext * This, _Out_ D2D1_RENDERING_CONTROLS * renderingControls) PURE;

    STDMETHOD_(void, SetPrimitiveBlend)(ID2D1DeviceContext * This, D2D1_PRIMITIVE_BLEND primitiveBlend) PURE;

    STDMETHOD_(D2D1_PRIMITIVE_BLEND, GetPrimitiveBlend)(ID2D1DeviceContext * This) PURE;

    STDMETHOD_(void, SetUnitMode)(ID2D1DeviceContext * This, D2D1_UNIT_MODE unitMode) PURE;

    STDMETHOD_(D2D1_UNIT_MODE, GetUnitMode)(ID2D1DeviceContext * This) PURE;

    STDMETHOD_(void, DrawGlyphRun)
    (ID2D1DeviceContext * This, D2D1_POINT_2F baselineOrigin, _In_ CONST DWRITE_GLYPH_RUN * glyphRun,
     _In_opt_ CONST DWRITE_GLYPH_RUN_DESCRIPTION * glyphRunDescription, _In_ ID2D1Brush * foregroundBrush, DWRITE_MEASURING_MODE measuringMode) PURE;

    STDMETHOD_(void, DrawImage)
    (ID2D1DeviceContext * This, _In_ ID2D1Image * image, _In_opt_ CONST D2D1_POINT_2F * targetOffset, _In_opt_ CONST D2D1_RECT_F * imageRectangle,
     D2D1_INTERPOLATION_MODE interpolationMode, D2D1_COMPOSITE_MODE compositeMode) PURE;

    STDMETHOD_(void, DrawGdiMetafile)(ID2D1DeviceContext * This, _In_ ID2D1GdiMetafile * gdiMetafile, _In_opt_ CONST D2D1_POINT_2F * targetOffset) PURE;

    STDMETHOD_(void, DrawBitmap)
    (ID2D1DeviceContext * This, _In_ ID2D1Bitmap * bitmap, _In_opt_ CONST D2D1_RECT_F * destinationRectangle, FLOAT opacity,
     D2D1_INTERPOLATION_MODE interpolationMode, _In_opt_ CONST D2D1_RECT_F * sourceRectangle, _In_opt_ CONST D2D1_MATRIX_4X4_F * perspectiveTransform) PURE;

    STDMETHOD_(void, PushLayer)(ID2D1DeviceContext * This, _In_ CONST D2D1_LAYER_PARAMETERS1 * layerParameters, _In_opt_ ID2D1Layer * layer) PURE;

    STDMETHOD(InvalidateEffectInputRectangle)(ID2D1DeviceContext * This, _In_ ID2D1Effect * effect, UINT32 input, _In_ CONST D2D1_RECT_F * inputRectangle) PURE;

    STDMETHOD(GetEffectInvalidRectangleCount)(ID2D1DeviceContext * This, _In_ ID2D1Effect * effect, _Out_ UINT32 * rectangleCount) PURE;

    STDMETHOD(GetEffectInvalidRectangles)
    (ID2D1DeviceContext * This, _In_ ID2D1Effect * effect, _Out_writes_(rectanglesCount) D2D1_RECT_F * rectangles, UINT32 rectanglesCount) PURE;

    STDMETHOD(GetEffectRequiredInputRectangles)
    (ID2D1DeviceContext * This, _In_ ID2D1Effect * renderEffect, _In_opt_ CONST D2D1_RECT_F * renderImageRectangle,
     _In_reads_(inputCount) CONST D2D1_EFFECT_INPUT_DESCRIPTION * inputDescriptions, _Out_writes_(inputCount) D2D1_RECT_F * requiredInputRects,
     UINT32 inputCount) PURE;

    STDMETHOD_(void, FillOpacityMask)
    (ID2D1DeviceContext * This, _In_ ID2D1Bitmap * opacityMask, _In_ ID2D1Brush * brush, _In_opt_ CONST D2D1_RECT_F * destinationRectangle,
     _In_opt_ CONST D2D1_RECT_F * sourceRectangle) PURE;
} ID2D1DeviceContextVtbl;

interface ID2D1DeviceContext { CONST struct ID2D1DeviceContextVtbl * lpVtbl; };

            #define ID2D1DeviceContext_QueryInterface(This, riid, ppv) ((This)->lpVtbl->Base.Base.Base.QueryInterface((IUnknown *) This, riid, ppv))

            #define ID2D1DeviceContext_AddRef(This) ((This)->lpVtbl->Base.Base.Base.AddRef((IUnknown *) This))

            #define ID2D1DeviceContext_Release(This) ((This)->lpVtbl->Base.Base.Base.Release((IUnknown *) This))

            #define ID2D1DeviceContext_GetFactory(This, factory) ((This)->lpVtbl->Base.Base.GetFactory((ID2D1Resource *) This, factory))
            ...
            #define ID2D1DeviceContext_CreateLinearGradientBrush(This, linearGradientBrushProperties, brushProperties, gradientStopCollection, \
                                                                 linearGradientBrush)                                                          \
                ((This)->lpVtbl->Base.CreateLinearGradientBrush((ID2D1RenderTarget *) This, linearGradientBrushProperties, brushProperties,    \
                                                                gradientStopCollection, linearGradientBrush))

            #define ID2D1DeviceContext_CreateRadialGradientBrush(This, radialGradientBrushProperties, brushProperties, gradientStopCollection, \
                                                                 radialGradientBrush)                                                          \
                ((This)->lpVtbl->Base.CreateRadialGradientBrush((ID2D1RenderTarget *) This, radialGradientBrushProperties, brushProperties,    \
            ...
            #define ID2D1DeviceContext_CreateCompatibleRenderTarget(This, desiredSize, desiredPixelSize, desiredFormat, options, bitmapRenderTarget)  \
                ((This)->lpVtbl->Base.CreateCompatibleRenderTarget((ID2D1RenderTarget *) This, desiredSize, desiredPixelSize, desiredFormat, options, \
                                                                   bitmapRenderTarget))

            #define ID2D1DeviceContext_CreateLayer(This, size, layer) ((This)->lpVtbl->Base.CreateLayer((ID2D1RenderTarget *) This, size, layer))

            #define ID2D1DeviceContext_CreateMesh(This, mesh) ((This)->lpVtbl->Base.CreateMesh((ID2D1RenderTarget *) This, mesh))
            ...
            #define ID2D1DeviceContext_FillRectangle(This, rect, brush) ((This)->lpVtbl->Base.FillRectangle((ID2D1RenderTarget *) This, rect, brush))
            ...
            #define ID2D1DeviceContext_FillEllipse(This, ellipse, brush) ((This)->lpVtbl->Base.FillEllipse((ID2D1RenderTarget *) This, ellipse, brush))
            ...
            #define ID2D1DeviceContext_FillMesh(This, mesh, brush) ((This)->lpVtbl->Base.FillMesh((ID2D1RenderTarget *) This, mesh, brush))
            ...
            #define ID2D1DeviceContext_DrawText(This, string, stringLength, textFormat, layoutRect, defaultForegroundBrush, options, measuringMode)       \
                ((This)->lpVtbl->Base.DrawText((ID2D1RenderTarget *) This, string, stringLength, textFormat, layoutRect, defaultForegroundBrush, options, \
                                               measuringMode))
            ...
            #define ID2D1DeviceContext_SetTransform(This, transform) ((This)->lpVtbl->Base.SetTransform((ID2D1RenderTarget *) This, transform))

            #define ID2D1DeviceContext_GetTransform(This, transform) ((This)->lpVtbl->Base.GetTransform((ID2D1RenderTarget *) This, transform))

            #define ID2D1DeviceContext_SetAntialiasMode(This, antialiasMode) ((This)->lpVtbl->Base.SetAntialiasMode((ID2D1RenderTarget *) This, antialiasMode))

            #define ID2D1DeviceContext_GetAntialiasMode(This) ((This)->lpVtbl->Base.GetAntialiasMode((ID2D1RenderTarget *) This))
            ...
            #define ID2D1DeviceContext_GetTextAntialiasMode(This) ((This)->lpVtbl->Base.GetTextAntialiasMode((ID2D1RenderTarget *) This))
            ...
            #define ID2D1DeviceContext_SetTags(This, tag1, tag2) ((This)->lpVtbl->Base.SetTags((ID2D1RenderTarget *) This, tag1, tag2))

            #define ID2D1DeviceContext_GetTags(This, tag1, tag2) ((This)->lpVtbl->Base.GetTags((ID2D1RenderTarget *) This, tag1, tag2))

            #define ID2D1DeviceContext_PopLayer(This) ((This)->lpVtbl->Base.PopLayer((ID2D1RenderTarget *) This))

            #define ID2D1DeviceContext_Flush(This, tag1, tag2) ((This)->lpVtbl->Base.Flush((ID2D1RenderTarget *) This, tag1, tag2))
            ...
            #define ID2D1DeviceContext_PopAxisAlignedClip(This) ((This)->lpVtbl->Base.PopAxisAlignedClip((ID2D1RenderTarget *) This))

            #define ID2D1DeviceContext_Clear(This, clearColor) ((This)->lpVtbl->Base.Clear((ID2D1RenderTarget *) This, clearColor))

            #define ID2D1DeviceContext_BeginDraw(This) ((This)->lpVtbl->Base.BeginDraw((ID2D1RenderTarget *) This))

            #define ID2D1DeviceContext_EndDraw(This, tag1, tag2) ((This)->lpVtbl->Base.EndDraw((ID2D1RenderTarget *) This, tag1, tag2))

            #define ID2D1DeviceContext_GetPixelFormat(This) ((This)->lpVtbl->Base.GetPixelFormat((ID2D1RenderTarget *) This))

            #define ID2D1DeviceContext_SetDpi(This, dpiX, dpiY) ((This)->lpVtbl->Base.SetDpi((ID2D1RenderTarget *) This, dpiX, dpiY))

            #define ID2D1DeviceContext_GetDpi(This, dpiX, dpiY) ((This)->lpVtbl->Base.GetDpi((ID2D1RenderTarget *) This, dpiX, dpiY))

            #define ID2D1DeviceContext_GetSize(This) ((This)->lpVtbl->Base.GetSize((ID2D1RenderTarget *) This))

            #define ID2D1DeviceContext_GetPixelSize(This) ((This)->lpVtbl->Base.GetPixelSize((ID2D1RenderTarget *) This))

            #define ID2D1DeviceContext_GetMaximumBitmapSize(This) ((This)->lpVtbl->Base.GetMaximumBitmapSize((ID2D1RenderTarget *) This))
            ...
            #define ID2D1DeviceContext_CreateEffect(This, effectId, effect) ((This)->lpVtbl->CreateEffect(This, effectId, effect))

            #define ID2D1DeviceContext_CreateGradientStopCollection(This, straightAlphaGradientStops, straightAlphaGradientStopsCount, preInterpolationSpace, \
                                                                    postInterpolationSpace, bufferPrecision, extendMode, colorInterpolationMode,              \
                                                                    gradientStopCollection1)                                                                  \
                ((This)->lpVtbl->CreateGradientStopCollection(This, straightAlphaGradientStops, straightAlphaGradientStopsCount, preInterpolationSpace,       \
                                                              postInterpolationSpace, bufferPrecision, extendMode, colorInterpolationMode,                    \
                                                              gradientStopCollection1))
            ...
            #define ID2D1DeviceContext_CreateCommandList(This, commandList) ((This)->lpVtbl->CreateCommandList(This, commandList))

            #define ID2D1DeviceContext_IsDxgiFormatSupported(This, format) ((This)->lpVtbl->IsDxgiFormatSupported(This, format))

            #define ID2D1DeviceContext_IsBufferPrecisionSupported(This, bufferPrecision) ((This)->lpVtbl->IsBufferPrecisionSupported(This, bufferPrecision))

            #define ID2D1DeviceContext_GetImageLocalBounds(This, image, localBounds) ((This)->lpVtbl->GetImageLocalBounds(This, image, localBounds))

            #define ID2D1DeviceContext_GetImageWorldBounds(This, image, worldBounds) ((This)->lpVtbl->GetImageWorldBounds(This, image, worldBounds))
            ...
            #define ID2D1DeviceContext_SetTarget(This, image) ((This)->lpVtbl->SetTarget(This, image))

            #define ID2D1DeviceContext_GetTarget(This, image) ((This)->lpVtbl->GetTarget(This, image))

            #define ID2D1DeviceContext_SetRenderingControls(This, renderingControls) ((This)->lpVtbl->SetRenderingControls(This, renderingControls))

            #define ID2D1DeviceContext_GetRenderingControls(This, renderingControls) ((This)->lpVtbl->GetRenderingControls(This, renderingControls))

            #define ID2D1DeviceContext_SetPrimitiveBlend(This, primitiveBlend) ((This)->lpVtbl->SetPrimitiveBlend(This, primitiveBlend))

            #define ID2D1DeviceContext_GetPrimitiveBlend(This) ((This)->lpVtbl->GetPrimitiveBlend(This))

            #define ID2D1DeviceContext_SetUnitMode(This, unitMode) ((This)->lpVtbl->SetUnitMode(This, unitMode))
            ...
            #define ID2D1DeviceContext_DrawGdiMetafile(This, gdiMetafile, targetOffset) ((This)->lpVtbl->DrawGdiMetafile(This, gdiMetafile, targetOffset))
            ...
            #define ID2D1DeviceContext_PushLayer(This, layerParameters, layer) ((This)->lpVtbl->PushLayer(This, layerParameters, layer))
            ...
            #define ID2D1DeviceContext_GetEffectRequiredInputRectangles(This, renderEffect, renderImageRectangle, inputDescriptions, requiredInputRects, \
                                                                        inputCount)                                                                      \
...
typedef struct ID2D1DeviceVtbl {
    ...
    STDMETHOD(CreateDeviceContext)(ID2D1Device * This, D2D1_DEVICE_CONTEXT_OPTIONS options, _Outptr_ ID2D1DeviceContext ** deviceContext) PURE;

    STDMETHOD(CreatePrintControl)
    (ID2D1Device * This, _In_ IWICImagingFactory * wicFactory, _In_ IPrintDocumentPackageTarget * documentTarget,
     _In_opt_ CONST D2D1_PRINT_CONTROL_PROPERTIES * printControlProperties, _Outptr_ ID2D1PrintControl ** printControl) PURE;

    STDMETHOD_(void, SetMaximumTextureMemory)(ID2D1Device * This, UINT64 maximumInBytes) PURE;

    STDMETHOD_(UINT64, GetMaximumTextureMemory)(ID2D1Device * This) PURE;

    STDMETHOD_(void, ClearResources)(ID2D1Device * This, UINT32 millisecondsSinceUse) PURE;
} ID2D1DeviceVtbl;

interface ID2D1Device { CONST struct ID2D1DeviceVtbl * lpVtbl; };

            #define ID2D1Device_QueryInterface(This, riid, ppv) ((This)->lpVtbl->Base.Base.QueryInterface((IUnknown *) This, riid, ppv))

            #define ID2D1Device_AddRef(This) ((This)->lpVtbl->Base.Base.AddRef((IUnknown *) This))

            #define ID2D1Device_Release(This) ((This)->lpVtbl->Base.Base.Release((IUnknown *) This))

            #define ID2D1Device_GetFactory(This, factory) ((This)->lpVtbl->Base.GetFactory((ID2D1Resource *) This, factory))

            #define ID2D1Device_CreateDeviceContext(This, options, deviceContext) ((This)->lpVtbl->CreateDeviceContext(This, options, deviceContext))
            ...
            #define ID2D1Device_SetMaximumTextureMemory(This, maximumInBytes) ((This)->lpVtbl->SetMaximumTextureMemory(This, maximumInBytes))

            #define ID2D1Device_GetMaximumTextureMemory(This) ((This)->lpVtbl->GetMaximumTextureMemory(This))

            #define ID2D1Device_ClearResources(This, millisecondsSinceUse) ((This)->lpVtbl->ClearResources(This, millisecondsSinceUse))
...
typedef struct ID2D1Factory1Vtbl {
    ...
    STDMETHOD(CreateDevice)(ID2D1Factory1 * This, _In_ IDXGIDevice * dxgiDevice, _Outptr_ ID2D1Device ** d2dDevice) PURE;

    STDMETHOD(CreateStrokeStyle)
    (ID2D1Factory1 * This, _In_ CONST D2D1_STROKE_STYLE_PROPERTIES1 * strokeStyleProperties, _In_reads_opt_(dashesCount) CONST FLOAT * dashes,
     UINT32 dashesCount, _Outptr_ ID2D1StrokeStyle1 ** strokeStyle) PURE;

    STDMETHOD(CreatePathGeometry)(ID2D1Factory1 * This, _Outptr_ ID2D1PathGeometry1 ** pathGeometry) PURE;

    STDMETHOD(CreateDrawingStateBlock)
    (ID2D1Factory1 * This, _In_opt_ CONST D2D1_DRAWING_STATE_DESCRIPTION1 * drawingStateDescription, _In_opt_ IDWriteRenderingParams * textRenderingParams,
     _Outptr_ ID2D1DrawingStateBlock1 ** drawingStateBlock) PURE;

    STDMETHOD(CreateGdiMetafile)(ID2D1Factory1 * This, _In_ IStream * metafileStream, _Outptr_ ID2D1GdiMetafile ** metafile) PURE;

    STDMETHOD(RegisterEffectFromStream)
    (ID2D1Factory1 * This, _In_ REFCLSID classId, _In_ IStream * propertyXml, _In_reads_opt_(bindingsCount) CONST D2D1_PROPERTY_BINDING * bindings,
     UINT32 bindingsCount, _In_ CONST PD2D1_EFFECT_FACTORY effectFactory) PURE;

    STDMETHOD(RegisterEffectFromString)
    (ID2D1Factory1 * This, _In_ REFCLSID classId, _In_ PCWSTR propertyXml, _In_reads_opt_(bindingsCount) CONST D2D1_PROPERTY_BINDING * bindings,
     UINT32 bindingsCount, _In_ CONST PD2D1_EFFECT_FACTORY effectFactory) PURE;

    STDMETHOD(UnregisterEffect)(ID2D1Factory1 * This, _In_ REFCLSID classId) PURE;

    STDMETHOD(GetRegisteredEffects)
    (ID2D1Factory1 * This, _Out_writes_to_opt_(effectsCount, *effectsReturned) CLSID * effects, UINT32 effectsCount, _Out_opt_ UINT32 * effectsReturned,
     _Out_opt_ UINT32 * effectsRegistered) PURE;

    STDMETHOD(GetEffectProperties)(ID2D1Factory1 * This, _In_ REFCLSID effectId, _Outptr_ ID2D1Properties ** properties) PURE;
} ID2D1Factory1Vtbl;

interface ID2D1Factory1 { CONST struct ID2D1Factory1Vtbl * lpVtbl; };

            #define ID2D1Factory1_QueryInterface(This, riid, ppv) ((This)->lpVtbl->Base.Base.QueryInterface((IUnknown *) This, riid, ppv))
            ...
            #define ID2D1Factory1_ReloadSystemMetrics(This) ((This)->lpVtbl->Base.ReloadSystemMetrics((ID2D1Factory *) This))

            #define ID2D1Factory1_GetDesktopDpi(This, dpiX, dpiY) ((This)->lpVtbl->Base.GetDesktopDpi((ID2D1Factory *) This, dpiX, dpiY))
            ...
            #define ID2D1Factory1_CreateDevice(This, dxgiDevice, d2dDevice) ((This)->lpVtbl->CreateDevice(This, dxgiDevice, d2dDevice))
            ...
            #define ID2D1Factory1_CreatePathGeometry(This, pathGeometry) ((This)->lpVtbl->CreatePathGeometry(This, pathGeometry))
            ...
            #define ID2D1Factory1_CreateGdiMetafile(This, metafileStream, metafile) ((This)->lpVtbl->CreateGdiMetafile(This, metafileStream, metafile))
            ...
            #define ID2D1Factory1_UnregisterEffect(This, classId) ((This)->lpVtbl->UnregisterEffect(This, classId))
            ...
            #define ID2D1Factory1_GetEffectProperties(This, effectId, properties) ((This)->lpVtbl->GetEffectProperties(This, effectId, properties))
...
interface ID2D1Multithread { CONST struct ID2D1MultithreadVtbl * lpVtbl; };

            #define ID2D1Multithread_QueryInterface(This, riid, ppv) ((This)->lpVtbl->Base.QueryInterface((IUnknown *) This, riid, ppv))
...
HRESULT WINAPI D2D1CreateDeviceContext(_In_ IDXGISurface * dxgiSurface, _In_opt_ CONST D2D1_CREATION_PROPERTIES * creationProperties,
...
inline HRESULT D2D1CreateDevice(_In_ IDXGIDevice * dxgiDevice, _In_ CONST D2D1_CREATION_PROPERTIES & creationProperties, _Outptr_ ID2D1Device ** d2dDevice) {

    return D2D1CreateDevice(dxgiDevice, &creationProperties, d2dDevice);
}

inline HRESULT D2D1CreateDeviceContext(_In_ IDXGISurface * dxgiSurface, _In_ CONST D2D1_CREATION_PROPERTIES & creationProperties,
                                       _Outptr_ ID2D1DeviceContext ** d2dDeviceContext) {
    return D2D1CreateDeviceContext(dxgiSurface, &creationProperties, d2dDeviceContext);
}
