...
typedef enum DXGI_DEBUG_RLO_FLAGS { DXGI_DEBUG_RLO_SUMMARY = 0x1, DXGI_DEBUG_RLO_DETAIL = 0x2, DXGI_DEBUG_RLO_ALL = 0x3 } DXGI_DEBUG_RLO_FLAGS;
...
public:
    virtual HRESULT STDMETHODCALLTYPE ReportLiveObjects(GUID apiid, DXGI_DEBUG_RLO_FLAGS flags) = 0;
};
...
extern RPC_IF_HANDLE __MIDL_itf_dxgidebug_0000_0002_v0_0_c_ifspec;
extern RPC_IF_HANDLE __MIDL_itf_dxgidebug_0000_0002_v0_0_s_ifspec;
