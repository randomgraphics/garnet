...
public:
    ...
    SpacialComponent * getLastChild() const {
        GN_UNIMPL();
        return NULL;
    }
...
private:
    ...
    void validateTransform() const {
        if (mTransformDirty) const_cast<SpacialComponent *>(this)->calcTransform();
    }

    void calcBoundingBox();
    void invalidateBoundingBox();
    void validateBoundingBox() const {
        if (mBBoxDirty) const_cast<SpacialComponent *>(this)->calcBoundingBox();
    }
};
} // namespace engine
} // namespace GN
