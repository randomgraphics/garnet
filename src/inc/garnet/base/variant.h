...
public:
    ...
    float getdf(float defval) const {
        float r;
        if (getf(r))
            return r;
        else
    ...
    Vector4f getdv(const Vector4f & defval) const {
        Vector4f r;
        if (getv(r))
            return r;
        else
    ...
    Matrix44f getdm(const Matrix44f & defval) const {
        Matrix44f r;
        if (getm(r))
            return r;
        else
