...
///
typedef void (*AssertFailuerUserRoutine)(void * userContext, const char * msg, const char * file, int line, bool * ignoreTheFailureForEver);
...
///
GN_API void setAssertFailerUserRoutine(AssertFailuerUserRoutine newRoutine, void * newUserContext, AssertFailuerUserRoutine * oldRoutine = NULL,
