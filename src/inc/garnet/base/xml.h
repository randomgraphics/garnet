...
protected:
    ...
    ///
    XmlNode(XmlDocument & d, XmlNodeType t): doc(d), type(t), parent(0), prevs(0), nexts(0), firstc(0), lastc(0) {
...
protected:
    ...
    /// protected ctor to prevent user from creatiing this class.
    ///
    XmlElement(XmlDocument & d): XmlNode(d, XML_ELEMENT), firsta(0), lasta(0) {}
};
