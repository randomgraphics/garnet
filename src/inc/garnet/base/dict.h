...
public:
    ...
    public:
        ...
        Iterator & operator=(const Iterator & rhs) {
            mKeyValuePair.mTypelessIter = rhs.mKeyValuePair.mTypelessIter;
            return *this;
        }

        const Iterator & operator++() const {
            mKeyValuePair.mTypelessIter.moveToNext();
            return *this;
        }
    ...
    ConstIterator begin() const {
        ConstIterator i(mTypelessDict.begin());
        return i;
    }
    Iterator begin() {
        Iterator i(mTypelessDict.begin());
        return i;
    }
    void          clear() { return mTypelessDict.clear(); }
    bool          empty() const { return mTypelessDict.empty(); }
    ConstIterator end() const {
        ConstIterator i(mTypelessDict.end());
        return i;
    }
    Iterator end() {
        Iterator i(mTypelessDict.end());
        return i;
    }
    ...
    Dictionary & operator=(const Dictionary & rhs) {
        mTypelessDict.copyFrom(rhs.mTypelessDict);
        return *this;
    }
...
private:
    ...
    struct TypeHelper {
        ...
        static void assign(void * a, const void * b) { (*(T *) a) = (*(const T *) b); }
