...
struct StandardUniform {
    ...
    static bool sIsValidIndex(int i) { return 0 <= i && i < Index::NUM_STANDARD_UNIFORMS; }

    /// get uniform descriptor from index
    static const Desc * sIndex2Desc(int i) {
        static const Desc * DESCRIPTORS[] = {
            &Desc::MATRIX_PVW,      &Desc::MATRIX_PVW_INV,   &Desc::MATRIX_PVW_IT,  &Desc::MATRIX_PV,      &Desc::MATRIX_PV_INV,    &Desc::MATRIX_PV_IT,
            &Desc::MATRIX_VW,       &Desc::MATRIX_VW_INV,    &Desc::MATRIX_VW_IT,   &Desc::MATRIX_PROJ,    &Desc::MATRIX_PROJ_INV,  &Desc::MATRIX_PROJ_IT,
