...
public:
    ...
    FatVertexBuffer(): mCount(0), mLayout(0) {
    ...
    bool GenerateVertexStream(const MeshVertexFormat & mvf, size_t stream, size_t stride, void * buffer, size_t bufferSize) const;
...
private:
    ...
    void moveFrom(FatVertexBuffer & other) {
        ...
        for (size_t i = 0; i < NUM_SEMANTICS; ++i) {
            ...
            other.mFormats[i] = ColorFormat::UNKNOWN;
        }
        mCount        = other.mCount;
        other.mCount  = 0;
