...
HRESULT InitD3D(HWND hWnd) {
    ...
    IDirect3D9 * d3d9;
    if (SUCCEEDED(g_pd3dDevice->GetDirect3D(&d3d9))) { d3d9->Release(); }
...
int main() {
    ...
    WNDCLASSEXW wc = {sizeof(WNDCLASSEX), CS_CLASSDC, MsgProc, 0L, 0L, GetModuleHandle(NULL), NULL, NULL, NULL, NULL, L"D3D Tutorial", NULL};
    RegisterClassExW(&wc);

    // Create the application's window
    HWND hWnd = CreateWindowW(L"D3D Tutorial", L"D3D Tutorial 02: Vertices", WS_OVERLAPPEDWINDOW, 100, 100, 300, 300, NULL, NULL, wc.hInstance, NULL);
